            ...
            e.exports = a.Ember.Component.extend(m, {
                ...
                _handleSummonerLeaguesData: function(e) {
                    ...
                    if (!this.get("isViewingLocalSummoner") && this.leagueTierNames.isApexForQueue(e[0])) {
                        const t = e[0];
                        this._cacheApexQueueInfo(t, t.queueType, t.tier), e && e[0].queueType && this.set("highestRankedQueueType", e[0].queueType)
                    }
                ...
                defaultLeagueObserver: a.Ember.observer("isLoading", "leagues.summonerLeagues", "isViewingLocalSummoner", (function() {
                    ...
                    this.get("isViewingLocalSummoner") && n && a.LeaguesConsts.TIERS.includes(n.tier) ? this._selectLeagueType("apex", t) : n && this._selectLeague(n)
                })),
            ...
            n(82), e.exports = a.Ember.Component.extend({
                ...
                isPlayerUnranked: a.Ember.computed("leagues", (function() {
                    const e = this.get("leagues"),
                        t = a.Lodash.filter(e.get("summonerLeagues"), (e => e && a.LeaguesConsts.TIERS.includes(e.tier)));
                    return !t || 0 === t.length
                })),
                challengerQueues: a.Ember.computed("challengerLaddersEnabled", "selectedLeague.queueType", (function() {
                    const e = this,
                ...
                (function(e, t, n, s, u) {
                    ...
                    t.addEventListener(i.EVENT_OUT_SCREEN_HIDDEN, (() => {
                        ...
                        n.summonerId && d.summonerId !== n.summonerId && (e.setHideSubsection(!0), d.summonerId = null, function(e) {
                            const t = l + e;
                            return (0, a.dataBinding)(o, (0, a.getProvider)().getSocket()).get(t).then((e => {
