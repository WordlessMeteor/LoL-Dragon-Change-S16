    ...
    var e = [, e => {
            ...
            e.exports = a.Ember.Component.extend(m, {
                ...
                _fillInApexDivisions: function(e) {
                    const t = [],
                        n = e.queueType === s.QUEUES.JADE_RANKED_SOLO_5x5 ? s.RANKED.JADE_APEX_TIERS : a.LeaguesConsts.APEX_TIERS.slice(),
                ...
                _selectLeagueType: function(e, t, n = !1) {
                    switch (this.get("leagueTypeSelected") !== e && this.set("leagueTypeSelected", e), e) {
                        ...
                        default: {
                            const e = t === s.QUEUES.JADE_RANKED_SOLO_5x5 ? s.RANKED.TIER_NAME_LEGEND : "CHALLENGER";
                ...
                _requestAndSelectApexLeague: function(e = "RANKED_SOLO_5x5", t = "CHALLENGER", n) {
                    const a = e === s.QUEUES.JADE_RANKED_SOLO_5x5 ? s.RANKED.TIER_NAME_LEGEND : t;
                    return this._requestApexData(e, a, n).then((t => {
            ...
            n(50), e.exports = a.Ember.Component.extend({
                ...
                text: a.Ember.computed("leagueDivisionInfo.tier", "leagueDivisionInfo.division", (function() {
                    const e = this.get("queueType") === s.QUEUES.JADE_RANKED_SOLO_5x5,
                        t = this.get("leagueDivisionInfo.tier");
                    return a.LeaguesConsts.APEX_TIERS.includes(t) || e && s.RANKED.JADE_APEX_TIERS.includes(t) ? a.LeagueTierNames.getTierName(t) : a.LeagueTierNames.getDivisionName(this.get("leagueDivisionInfo.division"))
                })),
