    ...
    var e = [, e => {
            ...
            e.exports = s.Ember.Component.extend(m, {
                ...
                init: function() {
                    ...
                    })), this.set("ratedLadderByQueueType", s.Ember.Object.create({})), this.set("selectedState", s.Ember.Object.create()), e.observe("/v1/friends", this, this._handleFriendsData), s.db.observe("/lol-seasons/v1/season/product/LOL", this, this._handleCurrentLoLSeason), s.db.observe("/lol-seasons/v1/season/name/JADE", this, this._handleCurrentJadeSeason), s.TelemetryService.startTelemetryTimerEvent("profile_ranked")
                },
                ...
                willDestroyElement: function() {
                    ...
                    e.unobserve(this), t.unobserve(this), s.db.unobserve(this), s.TelemetryService.stopTelemetryTimerEvent("profile_ranked", "timeSpent", "profile")
                },
                ...
                _fillInApexDivisions: function(e) {
                    const t = [],
                        n = e.queueType === a.QUEUES.JADE_RANKED_SOLO_5x5 ? a.RANKED.JADE_APEX_TIERS : s.LeaguesConsts.APEX_TIERS.slice(),
                ...
                activeDisplayedSeason: s.Ember.computed("isShowingLol", "isViewingClassic", "activeLoLSeason", "activeJadeSeason", (function() {
                ...
                isShowingLol: s.Ember.computed("isViewingTft", "isViewingCherry", "isViewingRankedPremade", "isViewingClassic", (function() {
                    return !(this.get("isViewingTft") || this.get("isViewingCherry") || this.get("isViewingRankedPremade") || this.get("isViewingClassic"))
                })),
                isShowingSplitEndCountdown: s.Ember.computed("isViewingLocalSummoner", "activeDisplayedSeason", (function() {
                    const e = this.get("activeDisplayedSeason");
                    return this.get("isViewingLocalSummoner") && e
                })),
                splitTimeRemainingText: s.Ember.computed("activeDisplayedSeason.seasonEnd", (function() {
                ...
                isViewingClassic: s.Ember.computed("selectedState.league", (function() {
                    return this.get("selectedState.league.queueType") === a.QUEUES.JADE_RANKED_SOLO_5x5
                })),
                ...
                _selectLeagueType: function(e, t, n = !1) {
                    switch (this.get("leagueTypeSelected") !== e && this.set("leagueTypeSelected", e), e) {
                        ...
                        default: {
                            const e = t === a.QUEUES.JADE_RANKED_SOLO_5x5 ? a.RANKED.TIER_NAME_LEGEND : "CHALLENGER";
                            this._requestAndSelectApexLeague(t, e, n);
                            break
                        }
                    }
                },
                ...
                _requestAndSelectApexLeague: function(e = "RANKED_SOLO_5x5", t = "CHALLENGER", n) {
                    const s = e === a.QUEUES.JADE_RANKED_SOLO_5x5 ? a.RANKED.TIER_NAME_LEGEND : t;
                    return this._requestApexData(e, s, n).then((t => {
            ...
            n(41), e.exports = s.Ember.Component.extend({
                ...
                rankedPointsLoc: s.Ember.computed("queueType", "summonersJourneyPointsString", "leaguePointsString", (function() {
                    return this.get("queueType") === a.QUEUES.JADE_RANKED_SOLO_5x5 ? this.get("summonersJourneyPointsString") : this.get("leaguePointsString")
                })),
                summonersJourneyPointsString: s.Ember.computed("leaguePoints", "tier", (function() {
                    const e = this.get("tier"),
                        t = a.RANKED.JADE_APEX_TIERS.includes(e) ? this.get("leaguePoints") : Math.min(100, this.get("leaguePoints"));
            ...
            n(50), e.exports = s.Ember.Component.extend({
                ...
                containsPlayer: s.Ember.computed("leagueDivisionInfo.standings", (function() {
                    return !s.Lodash.isEmpty(s.Lodash.find(this.get("leagueDivisionInfo.standings"), {
                        relationship: i.StandingRelationship.SELF
                    }))
                })),
                activeIndex: null,
                selectedDivision: null,
                text: s.Ember.computed("leagueDivisionInfo.tier", "leagueDivisionInfo.division", (function() {
                    const e = this.get("queueType") === a.QUEUES.JADE_RANKED_SOLO_5x5,
                        t = this.get("leagueDivisionInfo.tier");
                    return s.LeaguesConsts.APEX_TIERS.includes(t) || e && a.RANKED.JADE_APEX_TIERS.includes(t) ? s.LeagueTierNames.getTierName(t) : s.LeagueTierNames.getDivisionName(this.get("leagueDivisionInfo.division"))
                })),
