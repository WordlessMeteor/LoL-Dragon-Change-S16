(() => {
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                for (const n of e) {
                    const e = r(n);
                    0, s.QUEUES.ALL_RATED_QUEUE_TYPES.includes(e.queueType) || t.push(e)
                }
                return t
            };
            var a = n(1),
            ...
            (e = n.nmd(e)).exports = function() {
                ...
                function gn(e) {
                    var t, n = e._a;
                    return n && -2 === M(e).overflow && (t = n[Re] < 0 || n[Re] > 11 ? Re : n[We] < 1 || n[We] > st(n[je], n[Re]) ? We : n[Fe] < 0 || n[Fe] > 24 || 24 === n[Fe] && (0 !== n[Ue] || 0 !== n[Be] || 0 !== n[Ve]) ? Fe : n[Ue] < 0 || n[Ue] > 59 ? Ue : n[Be] < 0 || n[Be] > 59 ? Be : n[Ve] < 0 || n[Ve] > 999 ? Ve : -1, M(e)._overflowDayOfYear && (t < je || t > We) && (t = We), M(e)._overflowWeeks && -1 === t && (t = ze), M(e)._overflowWeekday && -1 === t && (t = Ge), M(e).overflow = t), e
                }
                ...
                function bn(e) {
                    ...
                    if (!e._d) {
                        ...
                        24 === e._a[Fe] && 0 === e._a[Ue] && 0 === e._a[Be] && 0 === e._a[Ve] && (e._nextDay = !0, e._a[Fe] = 0), e._d = (e._useUTC ? kt : gt).apply(null, r), s = e._useUTC ? e._d.getUTCDay() : e._d.getDay(), null != e._tzm && e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), e._nextDay && (e._a[Fe] = 24), e._w && void 0 !== e._w.d && e._w.d !== s && (M(e).weekdayMismatch = !0)
                    }
                }
                ...
                for (oe("S", 0, 0, (function() {
                    ...
                    })), Q("millisecond", "ms"), ee("millisecond", 16), xe("S", ge, ue), xe("SS", ge, ce), xe("SSS", ge, pe), Is = "SSSS"; Is.length <= 9; Is += "S") xe(Is, be);
            ...
            e.exports = a.Ember.Component.extend({
                ...
                isScrolling: !1,
                init() {
                    this._super(...arguments), this.set("pageIndex", 0), this.set("numPages", Math.ceil(this.get("tiers").length / 3)), this.set("isScrolling", !1), this.set("defaultRewardsConfig", n(230)), window.requestAnimationFrame((() => {
        ...
        s.addEventListener(i, (function(e) {
            (0, e.registrationHandler)((function(e) {
                return t.default.init(e, {
                    ...
                    let n = await e.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-clash/trans.json").overlay("/fe/lol-profiles/trans.json").overlay("/fe/lol-shared-components/trans.json").overlay("/fe/lol-shared-components/trans-challenges.json").overlay("/fe/lol-shared-components/trans-player-behavior.json");
                    const a = t.default.emberl10n(t.default.Ember, n);
