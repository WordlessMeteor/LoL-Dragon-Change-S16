(() => {
    var e = [, e => {
            ...
            const n = "UNRANKED",
                ...
                i = "LEGEND",
                r = s[s.length - 1],
                o = [r, "MASTER", "GRANDMASTER", "CHALLENGER"],
                l = ["IV", "III", "II", "I"],
                d = ["GRAY", "GREEN", "BLUE", "PURPLE", "ORANGE"];
            ...
            var l = a.Ember.Component.extend(i.default, {
                ...
                handleHonorProfile: function(e) {
                    if (e) {
                        ...
                        t >= 1 && t <= 5 && (this.set("honorProfile", e), this.set("shouldShowHonor", !0))
                    }
                },
            ...
            (e = n.nmd(e)).exports = function() {
                ...
                })), oe(0, ["YYYY", 4], 0, "year"), oe(0, ["YYYYY", 5], 0, "year"), oe(0, ["YYYYYY", 6, !0], 0, "year"), Q("year", "y"), ee("year", 1), xe("Y", Te), xe("YY", Me, ce), xe("YYYY", ke, pe), xe("YYYYY", ve, fe), xe("YYYYYY", ve, fe), Ne(["YYYYY", "YYYYYY"], je), Ne("YYYY", (function(e, t) {
                ...
                function ft(e) {
                    return this._monthsParseExact ? (c(this, "_monthsRegex") || gt.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (c(this, "_monthsShortRegex") || (this._monthsShortRegex = pt), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex)
                }
                var Mt = Ee;
                ...
                oe("w", ["ww", 2], "wo", "week"), oe("W", ["WW", 2], "Wo", "isoWeek"), Q("week", "w"), Q("isoWeek", "W"), ee("week", 5), ee("isoWeek", 5), xe("w", Me), xe("ww", Me, ce), xe("W", Me), xe("WW", Me, ce), Ae(["w", "ww", "W", "WW"], (function(e, t, n, s) {
                    t[s.substr(0, 1)] = S(e)
                }));
                var Dt = {
                    dow: 0,
                ...
                var Ct = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_");
                    ...
                    if (null !== t) {
                        ...
                        if (t.abbr = e, null != mn[e]) O("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info."), s = mn[e]._config;
                            ...
                            if (null != mn[t.parentLocale]) s = mn[t.parentLocale]._config;
                                ...
                                s = n._config
                            } return mn[e] = new A(N(s, t)), _n[e] && _n[e].forEach((function(e) {
                            fn(e.name, e.config)
                        })), pn(e), mn[e]
                    }
                ...
                function Mn(e, t) {
                    if (null != t) {
                        var n, s, a = dn;
                        null != (s = hn(e)) && (a = s._config), (n = new A(t = N(a, t))).parentLocale = mn[e], mn[e] = n, pn(e)
                ...
                function Pn(e, t, n, s, a, i) {
                    var r = [In(e), lt.indexOf(t), parseInt(n, 10), parseInt(s, 10), parseInt(a, 10)];
                ...
                function An(e, t, n) {
                    return !e || Ct.indexOf(e) === new Date(t[0], t[1], t[2]).getDay() || (M(n).weekdayMismatch = !0, n._isValid = !1, !1)
                }
                var Cn = {
                    UT: 0,
                    GMT: 0,
                    ...
                    if (e._f !== a.ISO_8601)
                        if (e._f !== a.RFC_2822) {
                            ...
                            var t, n, s, i, r, o = "" + e._i,
                                l = o.length,
                                d = 0;
                            for (s = _e(e._f, e._locale).match(se) || [], t = 0; t < s.length; t++) i = s[t], (n = (o.match(He(i, e)) || [])[0]) && ((r = o.substr(0, o.indexOf(n))).length > 0 && M(e).unusedInput.push(r), o = o.slice(o.indexOf(n) + n.length), d += n.length), re[i] ? (n ? M(e).empty = !1 : M(e).unusedTokens.push(i), Ce(i, n, e)) : e._strict && !n && M(e).unusedTokens.push(i);
                ...
                })), va("gggg", "weekYear"), va("ggggg", "weekYear"), va("GGGG", "isoWeekYear"), va("GGGGG", "isoWeekYear"), Q("weekYear", "gg"), Q("isoWeekYear", "GG"), ee("weekYear", 1), ee("isoWeekYear", 1), xe("G", Te), xe("g", Te), xe("GG", Me, ce), xe("gg", Me, ce), xe("GGGG", ke, pe), xe("gggg", ke, pe), xe("GGGGG", ve, fe), xe("ggggg", ve, fe), Ae(["gggg", "ggggg", "GGGG", "GGGGG"], (function(e, t, n, s) {
                    t[s.substr(0, 2)] = S(e)
                ...
                oe("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), Q("dayOfYear", "DDD"), ee("dayOfYear", 4), xe("DDD", Le), xe("DDDD", he), Ne(["DDD", "DDDD"], (function(e, t, n) {
                    n._dayOfYear = S(e)
                ...
                for (oe("S", 0, 0, (function() {
                    ...
                    })), Q("millisecond", "ms"), ee("millisecond", 16), xe("S", Le, ue), xe("SS", Le, ce), xe("SSS", Le, he), Pa = "SSSS"; Pa.length <= 9; Pa += "S") xe(Pa, be);

                function Na(e, t) {
                    t[Ve] = S(1e3 * ("0." + e))
                }
                for (Pa = "S"; Pa.length <= 9; Pa += "S") Ne(Pa, Na);
                var Aa = Xe("Milliseconds", !1);
                ...
                Ra.add = Ps, Ra.calendar = As, Ra.clone = Cs, Ra.diff = Vs, Ra.endOf = _a, Ra.format = Ks, Ra.from = Qs, Ra.fromNow = $s, Ra.to = Xs, Ra.toNow = Zs, Ra.get = tt, Ra.invalidAt = La, Ra.isAfter = js, Ra.isBefore = Rs, Ra.isBetween = Ws, Ra.isSame = Fs, Ra.isSameOrAfter = Us, Ra.isSameOrBefore = Bs, Ra.isValid = ya, Ra.lang = ta, Ra.locale = ea, Ra.localeData = na, Ra.max = $n, Ra.min = Qn, Ra.parsingFlags = ga, Ra.set = nt, Ra.startOf = ma, Ra.subtract = Is, Ra.toArray = pa, Ra.toObject = fa, Ra.toDate = ha, Ra.toISOString = Js, Ra.inspect = qs, Ra.toJSON = Ma, Ra.toString = Gs, Ra.unix = ca, Ra.valueOf = ua, Ra.creationData = ka, Ra.year = Qe, Ra.isLeapYear = $e, Ra.weekYear = ba, Ra.isoWeekYear = Ta, Ra.quarter = Ra.quarters = wa, Ra.month = ct, Ra.daysInMonth = ht, Ra.week = Ra.weeks = xt, Ra.isoWeek = Ra.isoWeeks = Ht, Ra.weeksInYear = Sa, Ra.isoWeeksInYear = Ya, Ra.date = xa, Ra.day = Ra.days = Bt, Ra.weekday = Vt, Ra.isoWeekday = zt, Ra.dayOfYear = Ha, Ra.hour = Ra.hours = ln, Ra.minute = Ra.minutes = Oa, Ra.second = Ra.seconds = Ia, Ra.millisecond = Ra.milliseconds = Aa, Ra.utcOffset = hs, Ra.utc = fs, Ra.local = Ms, Ra.parseZone = ys, Ra.hasAlignedHourOffset = gs, Ra.isDST = Ls, Ra.isLocal = vs, Ra.isUtcOffset = bs, Ra.isUtc = Ts, Ra.isUTC = Ts, Ra.zoneAbbr = Ca, Ra.zoneName = ja, Ra.dates = w("dates accessor is deprecated. Use date instead.", xa), Ra.months = w("months accessor is deprecated. Use month instead", ct), Ra.years = w("years accessor is deprecated. Use year instead", Qe), Ra.zone = w("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", ps), Ra.isDSTShifted = w("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", ks);
                var Ba = A.prototype;
                ...
                Ba.calendar = j, Ba.longDateFormat = W, Ba.invalidDate = U, Ba.ordinal = z, Ba.preparse = Ua, Ba.postformat = Ua, Ba.relativeTime = J, Ba.pastFuture = q, Ba.set = I, Ba.months = ot, Ba.monthsShort = dt, Ba.monthsParse = _t, Ba.monthsRegex = yt, Ba.monthsShortRegex = ft, Ba.week = St, Ba.firstDayOfYear = wt, Ba.firstDayOfWeek = Et, Ba.weekdays = At, Ba.weekdaysMin = Wt, Ba.weekdaysShort = jt, Ba.weekdaysParse = Ut, Ba.weekdaysRegex = Jt, Ba.weekdaysShortRegex = Kt, Ba.weekdaysMinRegex = $t, Ba.isPM = sn, Ba.meridiem = rn, pn("en", {
                ...
                function Ri() {
                    if (!this.isValid()) return this.localeData().invalidDate();
                    var e, t, n = Ci(this._milliseconds) / 1e3,
                        s = Ci(this._days),
                        a = Ci(this._months);
                ...
                var Wi = rs.prototype;
                return Wi.isValid = as, Wi.abs = Za, Wi.add = ti, Wi.subtract = ni, Wi.as = oi, Wi.asMilliseconds = mi, Wi.asSeconds = _i, Wi.asMinutes = ui, Wi.asHours = ci, Wi.asDays = hi, Wi.asWeeks = pi, Wi.asMonths = fi, Wi.asQuarters = Mi, Wi.asYears = yi, Wi.valueOf = li, Wi._bubble = ai, Wi.clone = gi, Wi.get = Li, Wi.milliseconds = vi, Wi.seconds = bi, Wi.minutes = Ti, Wi.hours = Yi, Wi.days = Si, Wi.weeks = wi, Wi.months = Di, Wi.years = Ei, Wi.humanize = Ai, Wi.toISOString = Ri, Wi.toString = Ri, Wi.toJSON = Ri, Wi.locale = ea, Wi.localeData = na, Wi.toIsoString = w("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", Ri), Wi.lang = ta, oe("X", 0, 0, "unix"), oe("x", 0, 0, "valueOf"), xe("x", Te), xe("X", De), Ne("X", (function(e, t, n) {
                    n._d = new Date(1e3 * parseFloat(e, 10))
                })), Ne("x", (function(e, t, n) {
                    n._d = new Date(S(e))
                })), a.version = "2.24.0", i(Kn), a.fn = Ra, a.min = Zn, a.max = es, a.now = ts, a.utc = p, a.unix = Wa, a.months = Ja, a.isDate = _, a.locale = pn, a.invalid = g, a.duration = Ds, a.isMoment = T, a.weekdays = Ka, a.parseZone = Fa, a.localeData = yn, a.isDuration = os, a.monthsShort = qa, a.weekdaysMin = $a, a.defineLocale = fn, a.updateLocale = Mn, a.locales = gn, a.weekdaysShort = Qa, a.normalizeUnits = $, a.relativeTimeRounding = Ii, a.relativeTimeThreshold = Ni, a.calendarFormat = Ns, a.prototype = Ra, a.HTML5_FMT = {
            ...
            n(265), e.exports = function() {
                ...
                const {
                    ...
                    rootElement: u,
                    overviewSection: c
                } = (0, r.createOverviewSubnavigation)("searched", e, n), h = new o.default;
                return d.addEventListener("screenHidden", (() => {
                    h.destroyWrapper("rcp-fe-lol-profiles-overview"), h.destroyWrapper("rcp-fe-lol-profiles-backdrop"), h.destroyWrapper("rcp-fe-lol-profiles-search-trail"), s = !1
                })), d.addEventListener("showSubsection", ((e, t) => {
                    if (s && l === t.puuid) return;
                    l = t.puuid, _.summonerId = t.summonerId;
                    const n = h.createWrapper("rcp-fe-lol-profiles-overview", Object.assign({}, _), u),
                        a = h.createWrapper("rcp-fe-lol-profiles-backdrop", Object.assign({}, _));
                    m.insertBefore(a.domNode, m.firstChild);
                    const i = h.createWrapper("rcp-fe-lol-profiles-search-trail", Object.assign({}, _));
