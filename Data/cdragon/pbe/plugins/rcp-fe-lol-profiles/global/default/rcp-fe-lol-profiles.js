(() => {
    var e = [, e => {
            ...
            const s = "c3e84157-4b03-4887-b342-0fb8c9f78ac3",
                i = `/lol-progression/v1/groups/${s}/configuration`,
            ...
            var d = a.Ember.Service.extend({
                init() {
                    this._super(...arguments), a.db.observe(i, this, this.handleProgressionTrackConfig), a.db.observe(r, this, this.handleProgressionInstanceData)
                },
                willDestroy() {
                    this._super(...arguments), a.db.unobserve(i, this), a.db.unobserve(r, this)
                },
                ...
                eligibleForMasteries: a.Ember.computed.gte("currentLevel", l.MASTERY),
                eligibleForSummonersJourney: a.Ember.computed.gte("currentLevel", l.SUMMONERS_JOURNEY)
            });
            t.default = d
        }, (e, t, n) => {
            "use strict";
            ...
            n(236), e.exports = s.Ember.Component.extend(i.default, {
            ...
            n(245), e.exports = s.Ember.Component.extend(i.default, {
