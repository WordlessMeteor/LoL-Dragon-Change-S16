(() => {
    var e = [, e => {
            ...
            (e = n.nmd(e)).exports = function() {
                ...
                for (Ns = "S"; Ns.length <= 9; Ns += "S") Ie(Ns, Is);
