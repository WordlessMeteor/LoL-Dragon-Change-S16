(() => {
    var e = [, e => {
            ...
            t.default = class {
                getPromethiumModules() {
                    return {
                        ...
                        PromethiumBuddiesModalComponent: u.default,
                        PromethiumBuddiesModalBuddyComponent: c.default,
                        ...
                        PromethiumRewardQuantityDisplayHelper: v.default
                    }
                }
                getPromethiumVideos() {
            ...
            l(12);
            const u = "/lol-tft-pass/v1/event-pass",
                c = "/fe/lol-uikit/sfx-uikit-dropdown-select.ogg";
            var m = n.Ember.Component.extend(s.default, {
                ...
                init() {
                    this._super(...arguments), n.db.observe(u, this, (e => {
                        if (!e) return;
                ...
                willDestroy() {
                    this._super(...arguments), n.db.removeObserver(u, this)
                },
                didInsertElement() {
                ...
                actions: {
                    ...
                    toggleSound() {
                        ...
                        this.playSfxUi(c), e ? this._stopBackgroundAudio() : this._playBackgroundAudio(), this.set("soundEnabled", !e)
                    },
                    toggleUserInterface() {
                        this.playSfxUi(c);
                    ...
                    showInfoModal() {
                        this.playSfxUi(c), (0, i.trackEventHubShowInfoModalButtonClick)(), this.set("showInfoModal", !0)
                    },
                    hideInfoModal() {
            ...
            l(27);
            var u = n.Ember.Component.extend(o.default, {
            ...
            var m = n.Ember.Component.extend(o.default, {
                ...
                willDestroy() {
                    n.db.removeObserver(u, this), n.db.removeObserver(c, this)
                },
                actions: {
                    closeAutoToolTip() {
