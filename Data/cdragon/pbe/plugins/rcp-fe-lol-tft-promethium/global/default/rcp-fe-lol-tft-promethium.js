(() => {
    var e = [, e => {
            ...
            t.default = class {
                getPromethiumModules() {
                    return {
                        ...
                        PromethiumMountainNodeComponent: a.default,
                        PromethiumLevelDetailsComponent: s.default,
            ...
            var m = n.Ember.Component.extend(a.default, {
                ...
                _playBackgroundAudio() {
                    ...
                    switch (e[t || 0].status) {
                        case o.LEVEL_STATES.Cleared:
                            l = this.playMusicAmbience(s.default.PM_HUB_SFX_ULTIMATE_COMPLETED);
                            break;
                        case o.LEVEL_STATES.Unlocked:
                            l = this.playMusicAmbience(s.default.PM_HUB_SFX_ULTIMATE_UNLOCKED);
                            break;
                        case o.LEVEL_STATES.Locked:
                            l = this.playMusicAmbience(s.default.PM_HUB_SFX_ULTIMATE_LOCKED)
                    }
                    const n = this.playMusic(s.default.PM_HUB_MUSIC_BASE);
                    this.setProperties({
                        audioAmbience: l,
                        audioMusic: n
                    })
                ...
                _setSelectedLevel() {
                    ...
                    const a = this.get("promethiumManager"),
                        s = this._isLevelEquippable(o);
                    a.setIsPlayDisabled(!s)
                }
            });
            t.default = m
        }, e => {
            ...
            function r(e, t, l, o = !1) {
                ! function(e, t, l = !1) {
                    s.phase = e.NAME, l && (e.uuid = i(), e.time_start = Date.now()), s.phase_uuid = e.uuid, s.event_id = t, s.timestamp = Date.now()
                }(e, t, o), n.Telemetry.sendCustomData(a, {
                    ...s,
                    ...l
                })
            }!async function() {
                ...
                if (!s.locale || !s.region) {
                    const e = await n.db.get("/riotclient/region-locale");
                    s.locale = e?.locale || "", s.region = e?.region || ""
                }
                if (!s.env && s.region) {
                    const e = await n.db.get(`/data-store/v1/system-settings/region_data/${s.region}/rso_platform_id`);
                    s.env = e, s.region = e
                }
            }()
        }, (e, t, l) => {
            ...
            var h = n.Ember.Component.extend(a.default, {
                ...
                _playLevelUpSfx() {
                    ...
                    switch (this.get("highestUnlockedLevel")) {
                        case 1:
                            e = s.default.PM_HUB_LEVEL_UNLOCK_2;
                            break;
                        case 2:
                            e = s.default.PM_HUB_LEVEL_UNLOCK_3;
                            break;
                        case 3:
                            e = s.default.PM_HUB_LEVEL_UNLOCK_4;
                            break;
                        case 4:
                            e = s.default.PM_HUB_LEVEL_UNLOCK_5;
                            break;
                        case 5:
                            e = s.default.PM_HUB_LEVEL_ALL_COMPLETE;
                            break;
                        default:
                            return
                    }
            ...
            l(18);
            var r = n.Ember.Component.extend(a.default, {
                ...
                _activeSound(e, t) {
                    switch (this.get("node.state")) {
                        case o.NODE_STATES.Selected:
                            e && this.playSfxUi(s.default.SFX_PM_LEVEL_NODE_SELECTED_HOVER), t && this.playSfxUi(s.default.SFX_PM_LEVEL_NODE_SELECTED_CLICK);
                            break;
                        case o.NODE_STATES.Unlocked:
                            e && this.playSfxUi(s.default.SFX_PM_LEVEL_NODE_UNLOCKED_HOVER), t && this.playSfxUi(s.default.SFX_PM_LEVEL_NODE_UNLOCKED_CLICK);
                            break;
                        case o.NODE_STATES.Locked:
                            t && this.playSfxUi(s.default.SFX_PM_LEVEL_NODE_LOCKED_CLICK)
                    }
                }
            });
            t.default = r
            ...
            var r = n.Ember.Component.extend(o.default, {
                ...
                click() {
                    ...
                    e && (this.get("toggleEventPass") ? (0, s.trackEventHubJourneyTrackButtonClick)() : (0, s.trackEventHubEventBundleButtonClick)(), e()), this.playSfxUi(a.default.BUTTON_CIRCLEGOLD_CLICK)
                },
                mouseEnter() {
                    this.playSfxUi(a.default.BUTTON_GENERIC_HOVER)
                }
            });
            t.default = r
        }, (e, t, l) => {
            ...
            var c = n.Ember.Component.extend(o.default, {
                ...
                showRecentlyUnlockedNotification: n.Ember.computed("promethiumManager.buddies", (function() {
                    ...
                    return !(!e || 0 === e.length) && e.some((e => e.equipState === s.EQUIP_STATES.UnseenUnlocked))
                })),
                actions: {
                    openModal() {
                        this.playSfxUi(a.default.SFX_PANEL_CHANGE_BUTTON_CLICK), this.set("showModal", !0);
                        this.get("promethiumManager").clearMissions(), (0, i.trackEventHubChangeGuideButtonClick)()
                    },
                    changeButtonHoverSound() {
                        this.playSfxUi(a.default.SFX_PANEL_CHANGE_BUTTON_HOVER)
                    },
                    closeModal() {
                        const e = this.get("promethiumManager");
            ...
            var m = n.Ember.Component.extend(o.default, {
                ...
                equipButtonClass: n.Ember.computed("activeBuddy", (function() {
                    ...
                    if (e) {
                        ...
                        if (t === s.EQUIP_STATES.Locked && !e.isPremium) return "disabled"
                    }
                    return ""
                })),
                ...
                showUnlockHelperText: n.Ember.computed("activeBuddy", (function() {
                    return this.get("activeBuddy.equipState") === s.EQUIP_STATES.Locked
                })),
                ...
                actions: {
                    ...
                    activateSound(e) {
                        switch (e) {
                            case "toolTipHover":
                                this.playSfxUi(a.default.SFX_MODAL_TOOLTIP_HOVER);
                                break;
                            case "toolTipClick":
                                this.playSfxUi(a.default.SFX_MODAL_TOOLTIP_CLICK);
                                break;
                            case "buddyHover":
                                this.playSfxUi(a.default.SFX_MODAL_BUDDY_HOVER);
                                break;
                            case "buddyClick":
                                this.playSfxUi(a.default.SFX_MODAL_BUDDY_CLICK);
                                break;
                            case "closeModal":
                                this.playSfxUi(a.default.SFX_MODAL_CLOSE_CLICK);
                                break;
                            case "equipModalEnabledHover":
                                this.playSfxUi(a.default.SFX_MODAL_EQUIP_ENABLED_HOVER);
                                break;
                            case "equipModalDisabledClick":
                                this.playSfxUi(a.default.SFX_MODAL_EQUIP_DISABLED_CLICK);
                                break;
                            case "buyBundleHover":
                                this.playSfxUi(a.default.SFX_MODAL_BUY_BUTTON_HOVER);
                                break;
                            case "buyBundleClick":
                                this.playSfxUi(a.default.SFX_MODAL_BUY_BUTTON_CLICK)
                        }
                    },
                    equipButtonHover() {
                        const e = this.get("activeBuddy");
                    ...
                    selectBuddy(e) {
                        const t = this.get("promethiumManager");
                        e && t && (e.equipState === s.EQUIP_STATES.UnseenUnlocked && t.setSeenRecentBuddy(e.id), this.send("activateSound", "buddyClick"), this.set("currentBuddy", e))
                    },
                    goToShop() {
                ...
                _isEquipped() {
                    return this.get("activeBuddy.equipState") === s.EQUIP_STATES.Equipped
                },
                _isButtonEnabled: e => !!e && ![s.EQUIP_STATES.Equipped, s.EQUIP_STATES.Locked].includes(e),
                _showBuyButton: e => !!e && (e.isPremium && e.equipState === s.EQUIP_STATES.Locked),
                _recordToolTipView() {
                    n.db.patch(c, {
                        data: {
                            [r]: !0
                ...
                _playEquipLine(e) {
                    this.playSfxUi(a.default.SFX_MODAL_EQUIP_ENABLED_CLICK);
                    const t = this.get("currentVoice");
                    if (t && t.stop(), s.CHARACTER_VOICE_CODES.includes(`${e}`)) {
            ...
            var s = n.Ember.Component.extend({
                ...
                willDestroy() {
                    n.db.removeObserver(a, this)
                },
                _checkModalViewStatus() {
                    n.db.addObserver(a, this, (e => {
            ...
            var r = o.Ember.Component.extend(a.default, {
                ...
                showModal: !1,
                click() {
                    this.set("showModal", !0), this.playSfxUi(s.SFX_UIKIT_CLICK_SMALL), (0, i.trackLobbyChangeGuideButtonClick)()
                },
                actions: {
                    closeModal() {
    ...
    function l(n) {
        ...
        return e[n](a, a.exports, l), a.exports
    }
    l.r = e => {
        ...
        const a = window.getPluginAnnounceEventName(n);
