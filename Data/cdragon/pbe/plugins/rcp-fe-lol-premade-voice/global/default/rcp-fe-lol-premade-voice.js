(() => {
    var e = [function(e, t, n) {
            ...
            const T = "chatParticipantsKey",
                ...
                M = "VOICE_COMPLIANCE_AGREEMENT_NOT_ACCEPTED",
                V = "parties_comm_panel_team_voice_status_unavailable",
                N = {
                    ...
                    [M]: "parties_comm_panel_team_voice_status_accept_agreement"
                },
                L = {
                    [P]: {
            ...
            class j extends r.default {
                ...
                constructor() {
                    super(), this._participants = [], this._participantMap = new Map, this._teamParticipants = [], this._teamParticipantMap = new Map, this._partyMemberPuuids = new Set, this._multiUserChatId = null, this._gameflowPhase = "", this._isGameClientRunning = !1, this._lastVolumeUpdate = 0, this._lockOutMemberJoinSound = !1, this._isDraggingMicSlider = !1, this._clashRoster = null, this._headerType = k.HEADER_LOBBY, this._connectionState = x.VOICE_DISCONNECTED_STATE, this._teamConnectionState = x.VOICE_DISCONNECTED_STATE, this._updatingTeamToggle = !1, this._teamVoicePluginEnabled = !1, this._teamVoiceAvailability = !1, this._teamVoiceAvailabilityReason = null, this._teamVoiceRestricted = !1, this._teamVoiceConnectionFailed = !1, this._isVoiceChatRestricted = !1, this._puuidsToNameOverrides = {};
                ...
                clashRostersUpdated(e) {
                    const t = (e || []).find((e => e.tournamentState !== E.CLASH_ROSTER_STATE.IDLE));
                ...
                _updateTeamToggleState() {
                    ...
                    const e = this._teamConnectionState === x.VOICE_CONNECTED_STATE,
                        t = this._teamConnectionState === x.VOICE_CONNECTING_STATE,
                        n = this._teamVoiceAvailabilityReason === M,
                        r = !e && !n && (t || !this._teamVoiceAvailability);
                    this._setToggleDisabled(this._selectors.teamToggle, r)
                }
                _refreshTeamConnectionState() {
                    this._teamParticipants && this._teamParticipants.length > 0 ? this._updateTeamConnectionState(x.VOICE_CONNECTED_STATE) : this._updateTeamConnectionState(x.VOICE_DISCONNECTED_STATE)
                }
                _isVoiceEligible() {
                ...
                _connectionClick() {
                    return this._lockConnectionButton(), this._connectionState === x.VOICE_DISCONNECTED_STATE && this._isVoiceEligible() ? (this._updateConnectionState(x.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, d.default.connect().then((() => {
                        this._joinVoiceSessionSuccess(), this._unlockConnectionButton()
                    })).catch((e => {
                        this._joinVoiceSessionFailed(e), this._unlockConnectionButton()
                    }))) : this._connectionState === x.VOICE_CONNECTED_STATE ? d.default.disconnect().then((() => {
                ...
                _connectionMouseEnter() {
                    if (this._connectionState === x.VOICE_DISCONNECTED_STATE && this._isVoiceEligible()) {
                ...
                _connectionBarClick() {
                    if (!this._teamVoicePluginEnabled) return this._connectionState === x.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(x.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, d.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e)
                    }))) : this._connectionState === x.VOICE_CONNECTED_STATE ? d.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this)) : void 0
                }
                _connectionToggleClick() {
                    return this._connectionState === x.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(x.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, d.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e)
                    }))) : this._connectionState === x.VOICE_CONNECTED_STATE ? d.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this)) : void 0
                }
                _partyToggleClick() {
                    ...
                    return e && e.classList.contains("restricted") ? void 0 : this._connectionState === x.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(x.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, d.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e)
                    }))) : this._connectionState === x.VOICE_CONNECTED_STATE ? d.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this)) : void 0
                }
                _teamToggleClick() {
                    if (!this._teamVoicePluginEnabled || this._updatingTeamToggle) return;
                    if (this._teamVoiceAvailabilityReason === M) return void m.default.showAgreementModal();
                    const e = this.shadowRoot.querySelector(this._selectors.teamToggle);
                    if (e && e.classList.contains("restricted")) return;
                    return e && e.classList.contains("mute-restricted") && this._teamConnectionState !== x.VOICE_CONNECTED_STATE ? void 0 : this._teamConnectionState === x.VOICE_DISCONNECTED_STATE ? (this._teamVoiceConnectionFailed = !1, this._updateTeamConnectionState(x.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, h.default.connect().then(this._joinTeamVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinTeamVoiceSessionFailed(e)
                    }))) : this._teamConnectionState === x.VOICE_CONNECTED_STATE ? h.default.disconnect().then(this._leaveTeamVoiceSessionSuccess.bind(this)) : void 0
                }
                _leaveVoiceSessionSuccess() {
                    this._updateConnectionState(x.VOICE_DISCONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()
                }
                _joinVoiceSessionSuccess() {
                    this._updateConnectionState(x.VOICE_CONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility(), clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                ...
                _joinVoiceSessionFailed(e) {
                    if (e && e.data) {
                        ...
                        i.logger.warning(`Failed to join voice channel: ${t}`), this._updateConnectionState(x.VOICE_DISCONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()
                    }
                }
                _leaveTeamVoiceSessionSuccess() {
                    this._teamVoiceConnectionFailed = !1, this._updateTeamConnectionState(x.VOICE_DISCONNECTED_STATE)
                }
                _joinTeamVoiceSessionSuccess() {
                    this._teamVoiceConnectionFailed = !1, this._updateTeamConnectionState(x.VOICE_CONNECTED_STATE), clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                ...
                _joinTeamVoiceSessionFailed(e) {
                    if (e && e.data) {
                        this._lockOutMemberJoinSound = !1;
                        const t = e.data.message;
                        i.logger.warning(`Failed to join team voice channel: ${t}`), this._teamVoiceConnectionFailed = !0, this._updateTeamConnectionState(x.VOICE_DISCONNECTED_STATE)
                    }
                }
                ...
                _initDataBinding() {
                    this.lobbyDataListener = this.lobbyUpdated.bind(this), _.default.observe("lobby", this.lobbyDataListener), _.default.lobby().then(this.lobbyDataListener), this.clashChatListener = this.clashRostersUpdated.bind(this), f.default.observe("rosters", this.clashChatListener), f.default.clashRosters().then(this.clashChatListener), this.gameflowSessionListener = this.gameflowSessionUpdated.bind(this), A.default.observe("session", this.gameflowSessionListener), A.default.session().then(this.gameflowSessionListener), this.postgameStatsListener = this.postgameStatsUpdated.bind(this), v.default.observe("stats", this.postgameStatsListener), v.default.stats().then(this.postgameStatsListener), this.availabilityDataListener = this.availabilityUpdated.bind(this), d.default.observe("availability", this.availabilityDataListener), d.default.availability().then(this.availabilityDataListener), this.participantsDataListener = this.participantsUpdated.bind(this), d.default.observe("participants", this.participantsDataListener), d.default.participants().then(this.participantsDataListener), this.settingsDataListener = this.settingsUpdated.bind(this), d.default.observe("settings", this.settingsDataListener), d.default.settings().then(this.settingsDataListener), this.sessionDataListener = this.sessionUpdated.bind(this), g.default.observe("session", this.sessionDataListener), g.default.session().then(this.sessionDataListener), this.currentPlayerChatInfoListener = this.currentPlayerChatInfoUpdated.bind(this), b.default.observe("me", this.currentPlayerChatInfoListener), b.default.me().then(this.currentPlayerChatInfoListener), this.conversationsListener = this.conversationsUpdated.bind(this), b.default.observe("conversations", this.conversationsListener), b.default.conversations().then(this.conversationsListener), this.teamVoicePluginEnabledListener = this.teamVoicePluginEnabledUpdate.bind(this), u.default.observe("teamVoicePluginEnabled", this.teamVoicePluginEnabledListener), u.default.teamVoicePluginEnabled().then(this.teamVoicePluginEnabledListener), this.teamVoiceAvailabilityListener = this.teamVoiceAvailabilityUpdated.bind(this), h.default.observe("availability", this.teamVoiceAvailabilityListener), h.default.availability().then(this.teamVoiceAvailabilityListener), this.teamVoiceSessionListener = this.teamVoiceSessionUpdated.bind(this), h.default.observe("session", this.teamVoiceSessionListener), h.default.session().then(this.teamVoiceSessionListener), this.parentalControlsStatusListener = this.parentalControlsStatusUpdated.bind(this), y.default.observe("status", this.parentalControlsStatusListener), y.default.status().then(this.parentalControlsStatusListener)
                }
                ...
                _updateParentalControlsRestriction() {
                    this._isVoiceChatRestricted ? (this.addInnerHtml(i.tra.get("parties_comm_panel_parental_controls_restricted"), this._selectors.restrictedMessage), this.removeClass("hide", this._selectors.restrictedSection), this.addClass("hide", this._selectors.voicePanelWrapper)) : (this.addClass("hide", this._selectors.restrictedSection), this.removeClass("hide", this._selectors.voicePanelWrapper))
                }
                ...
                _settingsClicked() {
                    this._isGameClientRunning || (0, C.default)()
                }
                ...
                _updateToggleState(e, t) {
                    ...
                    n && (n.classList.remove(x.VOICE_CONNECTED_STATE, x.VOICE_DISCONNECTED_STATE, x.VOICE_CONNECTING_STATE, "disabled", "restricted", "disabled-disconnected"), n.classList.add(t))
                }
            ...
            class l extends i.default {
                ...
                ready() {
                    return this._readyPromise || (this._readyPromise = new Promise((e => {
                        const t = n => {
                            n && (this._settingsBinding.unobserve(o, t), e())
                        };
                        this._settingsBinding.observe(o, t)
                    }))), this._readyPromise
                }
            ...
            H.push([e.id, '.lol-premade-voice-panel .lol-premade-voice-panel-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header {\n  font-family: var(--font-display);\n}\n.lol-premade-voice-panel,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable,\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message,\n.lol-premade-voice-panel .lol-premade-voice-panel-availability .lol-premade-voice-panel-message {\n  font-family: var(--font-body);\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header {\n  font-family: var(--font-display);\n}\n.lol-premade-voice-panel,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable,\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message,\n.lol-premade-voice-panel .lol-premade-voice-panel-availability .lol-premade-voice-panel-message {\n  font-family: var(--font-body);\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable,\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message {\n  -webkit-user-select: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable,\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message {\n  font-kerning: normal;\n  -webkit-font-feature-settings: "kern" 1;\n  -webkit-font-smoothing: antialiased;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text,\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header {\n  text-transform: uppercase;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(ko-kr),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(ko-kr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(ko-kr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(ko-kr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(ko-kr),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(tr-tr),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(tr-tr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(tr-tr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(tr-tr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(tr-tr),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(el-gr),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(el-gr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(el-gr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(el-gr),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(el-gr),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(th-th),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(th-th),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(th-th),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(th-th),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(th-th),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(zh-tw),\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(zh-tw),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(zh-tw),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(zh-tw),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(zh-tw) {\n  text-transform: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName {\n  color: #f0e6d2;\n  font-size: 18px;\n  font-weight: 700;\n  line-height: 22px;\n  letter-spacing: 0.05em;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text {\n  color: #f0e6d2;\n  font-size: 14px;\n  font-weight: 700;\n  line-height: 18px;\n  letter-spacing: 0.075em;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count,\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header {\n  color: #f0e6d2;\n  font-size: 12px;\n  font-weight: 700;\n  line-height: 16px;\n  letter-spacing: 0.075em;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(ja-jp),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(ja-jp) {\n  font-size: 13px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header:lang(ar-ae),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count:lang(ar-ae),\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash,\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message {\n  color: #a09b8c;\n  font-size: 14px;\n  font-weight: normal;\n  line-height: 20px;\n  letter-spacing: 0.025em;\n  -webkit-font-smoothing: subpixel-antialiased;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash:lang(ar-ae),\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable {\n  color: #a09b8c;\n  font-size: 12px;\n  font-weight: normal;\n  line-height: 16px;\n  letter-spacing: 0.025em;\n  -webkit-font-smoothing: subpixel-antialiased;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable:lang(ja-jp) {\n  font-size: 13px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash {\n  color: #f0e6d2;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content lol-uikit-slider {\n  width: 155px;\n  height: 15px;\n  --slider-base-before-top: 7px;\n  --slider-btn-cursor: pointer;\n  --slider-btn-width: 15px;\n  --slider-btn-height: 15px;\n  --slider-btn-hover-background-position: 0 -15px;\n  --slider-btn-active-background-position: 0 -30px;\n  --slider-fill-top: 6px;\n}\n:host {\n  width: 288px;\n  overflow: hidden;\n}\n.lol-premade-voice-panel {\n  display: flex;\n  flex-direction: column;\n  background: #010a13;\n  border: thin solid #1e2328;\n  cursor: default;\n  opacity: 0;\n  transform: translateY(350px);\n  transform-origin: center bottom;\n  transition: transform 500ms cubic-bezier(0.02, 0.85, 0.08, 0.99), opacity 300ms ease;\n  position: relative;\n  height: 317px;\n}\n.lol-premade-voice-panel:lang(ar-ae) {\n  direction: rtl;\n}\n.lol-premade-voice-panel.show {\n  opacity: 1;\n  transform: translateY(0);\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-wrapper {\n  display: contents;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-wrapper.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header {\n  display: flex;\n  flex-direction: row;\n  flex-wrap: wrap;\n  width: 100%;\n  height: 47px;\n  border-bottom: thin solid #463714;\n  align-items: center;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  flex-grow: 1;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text {\n  display: flex;\n  flex-direction: column;\n  font-size: 14px;\n  color: #f0e6d2;\n  margin: 0 0 0 8px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-header-text:lang(ar-ae) {\n  margin: 0 8px 0 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-connection-status {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-connection-toggle {\n  margin: 0 8px 0 auto;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-connection-toggle:lang(ar-ae) {\n  margin: 0 auto 0 8px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-minimize-button {\n  display: block;\n  width: 16px;\n  height: 16px;\n  cursor: pointer;\n  margin: 0 8px 0 auto;\n  background-image: url(' + Y + ");\n  background-size: contain;\n  background-repeat: no-repeat;\n  background-position: center;\n  opacity: 0.7;\n  flex-shrink: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-minimize-button:lang(ar-ae) {\n  margin: 0 auto 0 8px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-default .lol-premade-voice-panel-minimize-button:hover {\n  opacity: 1;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash {\n  display: none;\n  color: #f0e6d2;\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  height: 47px;\n  padding-left: 8px;\n  box-sizing: border-box;\n  flex-shrink: 0;\n  overflow: hidden;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-logo {\n  display: inline;\n  height: 32px;\n  width: 32px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-shortName {\n  color: #c8aa6e;\n  flex-direction: row;\n  margin-left: 7px;\n  margin-right: 7px;\n  display: inline;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-header .lol-premade-voice-panel-header-clash .lol-premade-voice-panel-header-clash-title .lol-premade-voice-panel-header-clash-name {\n  text-overflow: ellipsis;\n  max-width: 150px;\n  flex-direction: row;\n  display: inline;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-content {\n  display: flex;\n  height: 216px;\n  padding: 0px 11px;\n  box-sizing: border-box;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants {\n  flex-direction: column;\n  visibility: visible;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header {\n  color: #f0e6d2;\n  margin: 8px 0;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  gap: 6px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header .lol-premade-voice-panel-party-toggle {\n  margin: 0 0 0 auto;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header .lol-premade-voice-panel-party-toggle:lang(ar-ae) {\n  margin: 0 auto 0 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-party-header .lol-premade-voice-panel-party-toggle.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-section-divider {\n  width: 100%;\n  height: 1px;\n  background: #3c3c41;\n  align-self: center;\n  flex-shrink: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-section-divider.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  gap: 8px;\n  padding: 6px 11px;\n  margin: 0 -11px 6px -11px;\n  color: #a09b8c;\n  background: linear-gradient(180deg, #1e2328 0%, rgba(30,35,40,0) 157.69%);\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator {\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  gap: 3px;\n  flex-shrink: 0;\n  box-sizing: border-box;\n  width: 38px;\n  height: 24px;\n  background-image: url(" + q + ");\n  background-size: 100% 100%;\n  background-repeat: no-repeat;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-icon {\n  width: 12px;\n  height: 12px;\n  background-color: currentColor;\n  -webkit-mask-image: url(" + Q + ");\n  -webkit-mask-repeat: no-repeat;\n  -webkit-mask-size: contain;\n  -webkit-mask-position: center;\n  mask-image: url(" + Q + ");\n  mask-repeat: no-repeat;\n  mask-size: contain;\n  mask-position: center;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-indicator-count {\n  color: #a09b8c;\n  font-size: 12px;\n  line-height: 16px;\n  letter-spacing: 0.08em;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-names {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  gap: 4px;\n  flex: 1;\n  min-width: 0;\n  font-size: 12px;\n  color: #a09b8c;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-party-row .lol-premade-voice-panel-team-party-names lol-uikit-player-name {\n  flex-shrink: 1;\n  min-width: 0;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header {\n  color: #f0e6d2;\n  margin: 8px 0;\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  gap: 6px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-header-text {\n  margin-right: 5px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable {\n  font-style: italic;\n  color: #5b5a56;\n  margin-left: auto;\n  font-size: 12px;\n  white-space: nowrap;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-ptt-indicator.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-toggle {\n  margin: 0 0 0 auto;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-toggle:lang(ar-ae) {\n  margin: 0 auto 0 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-toggle.hide {\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable:not(.hide) ~ .lol-premade-voice-panel-team-toggle {\n  margin-left: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants .lol-premade-voice-panel-team-header .lol-premade-voice-panel-team-unavailable:not(.hide) ~ .lol-premade-voice-panel-team-toggle:lang(ar-ae) {\n  margin-right: 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants lol-parties-comm-participant {\n  height: 54px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-participants.hide {\n  display: none;\n  visibility: hidden;\n  margin: 0px;\n  height: 0px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted {\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  margin: auto;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-poro {\n  width: 64px;\n  height: 64px;\n  background: url(" + G + ") no-repeat center;\n  background-size: contain;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted .lol-premade-voice-panel-restricted-message {\n  letter-spacing: 0.01em;\n  color: #a09b8c;\n  text-align: center;\n  margin-top: 12px;\n  width: 220px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-restricted.hide {\n  display: none;\n  margin: 0px;\n  height: 0px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-availability {\n  flex-direction: column;\n  align-items: center;\n  color: #3c3c41;\n  justify-content: center;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-availability .lol-premade-voice-panel-poro {\n  background-image: url(" + W + ");\n  background-size: cover;\n  width: 128px;\n  height: 128px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-availability .lol-premade-voice-panel-message {\n  width: 180px;\n  text-align: center;\n  font-size: 14px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-availability.hide {\n  display: none;\n  margin: 0px;\n  height: 0px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar {\n  display: flex;\n  justify-content: space-between;\n  height: 32px;\n  width: 100%;\n  align-items: center;\n  background: linear-gradient(to top, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 100%);\n  border-bottom: thin solid #1e2328;\n  cursor: default;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar:hover {\n  background: rgba(255,255,255,0.1);\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.connected {\n  color: #3cb44b;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.connected.button-hover {\n  color: #f0e6d2;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.connected .lol-premade-voice-panel-connection-icon {\n  background-image: url(" + J + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.connected .lol-premade-voice-panel-connection-icon:hover {\n  background-image: url(" + K + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.connected .lol-premade-voice-panel-connection-icon:active {\n  background-image: url(" + Z + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.disconnected {\n  color: #a09b8c;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.disconnected.button-hover {\n  color: #f0e6d2;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.disconnected .lol-premade-voice-panel-connection-icon {\n  background-image: url(" + X + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.disconnected .lol-premade-voice-panel-connection-icon:hover {\n  background-image: url(" + ee + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.disconnected .lol-premade-voice-panel-connection-icon:active {\n  background-image: url(" + te + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar.connecting {\n  color: #cdbe91;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar .lol-premade-voice-panel-connection-state {\n  font-size: 14px;\n  flex-grow: 1;\n  margin: 0 0 0 7px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar .lol-premade-voice-panel-connection-state:lang(ar-ae) {\n  margin: 0 7px 0 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar .lol-premade-voice-panel-connection-icon {\n  background-size: cover;\n  width: 18px;\n  height: 18px;\n  cursor: pointer;\n  margin: 0 7px 0 0;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar .lol-premade-voice-panel-connection-icon:lang(ar-ae) {\n  margin: 0 0 0 7px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-connection-bar .lol-premade-voice-panel-connection-icon.locked {\n  pointer-events: none;\n  opacity: 0.3;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player {\n  display: flex;\n  flex-direction: row;\n  height: 54px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player:hover {\n  background: linear-gradient(to right, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0) 100%);\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-player-highlight {\n  display: flex;\n  width: 7px;\n  background-color: #785a28;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-buttons {\n  display: flex;\n  position: absolute;\n  bottom: 11px;\n  right: 11px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-buttons:lang(ar-ae) {\n  right: auto;\n  left: 11px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic {\n  background-image: url(" + ne + ");\n  background-size: cover;\n  width: 18px;\n  height: 18px;\n  cursor: pointer;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic:hover {\n  background-image: url(" + re + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic:active {\n  background-image: url(" + ie + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic.muted {\n  background-image: url(" + ae + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic.muted:hover {\n  background-image: url(" + oe + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic.muted:active {\n  background-image: url(" + le + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-mic.disabled {\n  background-image: url(" + se + ");\n  cursor: default;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-deafen {\n  background-image: url(" + ce + ");\n  background-size: cover;\n  width: 18px;\n  height: 18px;\n  margin: 0 5px 0 5px;\n  cursor: pointer;\n  display: none;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-deafen:hover {\n  background-image: url(" + pe + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-deafen:active {\n  background-image: url(" + de + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-deafen.deafened {\n  background-image: url(" + he + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-deafen.deafened:hover {\n  background-image: url(" + me + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-deafen.deafened:active {\n  background-image: url(" + ue + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-divider {\n  width: 1px;\n  height: 15.438px;\n  background: #3c3c41;\n  align-self: center;\n  margin: 0 3px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-settings {\n  background-image: url(" + Ae + ");\n  background-size: cover;\n  width: 18px;\n  height: 18px;\n  cursor: pointer;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-settings:hover {\n  background-image: url(" + ge + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-settings:active {\n  background-image: url(" + _e + ");\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-settings.disabled,\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-settings .disabled:hover,\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player .lol-premade-voice-panel-current-player-settings .disabled:active {\n  background-image: url(" + ve + ");\n  cursor: default;\n}\n.lol-premade-voice-panel .voice-panel-avatar-wrapper {\n  align-self: center;\n  margin: 0 8px 0 4px;\n}\n.lol-premade-voice-panel .voice-panel-avatar-wrapper:lang(ar-ae) {\n  margin: 0 4px 0 8px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content {\n  display: flex;\n  flex: 1;\n  flex-direction: column;\n  min-width: 0;\n  font-size: 14px;\n  color: #cdbe91;\n  margin: 11px 58px 11px 3px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content:lang(ar-ae) {\n  margin: 11px 3px 11px 58px;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content .lol-premade-voice-panel-current-player-volume {\n  width: 100%;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content .lol-premade-voice-panel-current-player-row {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content .lol-premade-voice-panel-current-player-row .lol-premade-voice-panel-current-player-name {\n  max-width: 130px;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  overflow: hidden;\n}\n.lol-premade-voice-panel .lol-premade-voice-panel-current-player-content.disabled {\n  color: #3c3c41;\n}\n.lol-premade-voice-panel .voice-toggle {\n  position: relative;\n  width: 44px;\n  height: 22px;\n  cursor: pointer;\n  flex-shrink: 0;\n  background-image: url(" + be + ");\n  background-size: 100% 100%;\n  background-repeat: no-repeat;\n}\n.lol-premade-voice-panel .voice-toggle .voice-toggle-icon {\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 14px;\n  height: 14px;\n  background-size: contain;\n  background-repeat: no-repeat;\n  background-position: center;\n}\n.lol-premade-voice-panel .voice-toggle .voice-toggle-thumb {\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n  width: 18px;\n  height: 18px;\n  background-size: contain;\n  background-repeat: no-repeat;\n  background-position: center;\n  transition: left 200ms ease;\n}\n.lol-premade-voice-panel .voice-toggle.disconnected .voice-toggle-icon {\n  display: none;\n}\n.lol-premade-voice-panel .voice-toggle.disconnected .voice-toggle-thumb {\n  left: 2px;\n  background-image: url(" + fe + ");\n}\n.lol-premade-voice-panel .voice-toggle.connected .voice-toggle-icon {\n  display: block;\n  left: 3px;\n  background-image: url(" + ye + ");\n}\n.lol-premade-voice-panel .voice-toggle.connected .voice-toggle-thumb {\n  left: 24px;\n  background-image: url(" + xe + ");\n}\n.lol-premade-voice-panel .voice-toggle.connecting .voice-toggle-icon {\n  display: block;\n  left: 3px;\n  width: 14px;\n  height: 14px;\n  background-image: url(" + Ee + ");\n  animation: voice-toggle-spin 1s linear infinite;\n}\n.lol-premade-voice-panel .voice-toggle.connecting .voice-toggle-thumb {\n  left: 24px;\n  background-image: url(" + xe + ");\n}\n.lol-premade-voice-panel .voice-toggle.restricted {\n  cursor: not-allowed;\n}\n.lol-premade-voice-panel .voice-toggle.restricted .voice-toggle-icon {\n  display: block;\n  right: 3px;\n  left: auto;\n  background-image: url(" + Ce + ");\n}\n.lol-premade-voice-panel .voice-toggle.restricted .voice-toggle-thumb {\n  left: 2px;\n  background-image: url(" + ke + ");\n}\n.lol-premade-voice-panel .voice-toggle.mute-restricted {\n  cursor: pointer;\n}\n.lol-premade-voice-panel .voice-toggle.mute-restricted .voice-toggle-icon {\n  display: block;\n  left: 5px;\n  right: auto;\n  background-image: url(" + Be + ");\n}\n.lol-premade-voice-panel .voice-toggle.mute-restricted .voice-toggle-thumb {\n  left: 24px;\n  background-image: url(" + $e + ");\n}\n.lol-premade-voice-panel .voice-toggle.disabled {\n  opacity: 0.5;\n  cursor: not-allowed;\n  pointer-events: none;\n}\n.lol-premade-voice-panel .voice-toggle.disabled-disconnected {\n  cursor: not-allowed;\n  pointer-events: none;\n}\n.lol-premade-voice-panel .voice-toggle.disabled-disconnected .voice-toggle-icon {\n  display: block;\n  right: 3px;\n  left: auto;\n  background-image: url(" + we + ");\n}\n.lol-premade-voice-panel .voice-toggle.disabled-disconnected .voice-toggle-thumb {\n  left: 2px;\n  background-image: url(" + fe + ");\n}\n@-moz-keyframes voice-toggle-spin {\n  0% {\n    transform: translateY(-50%) rotate(0deg);\n  }\n  100% {\n    transform: translateY(-50%) rotate(360deg);\n  }\n}\n@-webkit-keyframes voice-toggle-spin {\n  0% {\n    transform: translateY(-50%) rotate(0deg);\n  }\n  100% {\n    transform: translateY(-50%) rotate(360deg);\n  }\n}\n@-o-keyframes voice-toggle-spin {\n  0% {\n    transform: translateY(-50%) rotate(0deg);\n  }\n  100% {\n    transform: translateY(-50%) rotate(360deg);\n  }\n}\n@keyframes voice-toggle-spin {\n  0% {\n    transform: translateY(-50%) rotate(0deg);\n  }\n  100% {\n    transform: translateY(-50%) rotate(360deg);\n  }\n}\n", "", {
                ...
                names: [],
                mappings: "AAAA;;;;;;EACE,gCAAa;ACMf;ADHA;;;;;EACE,6BAAa;ACSf;ADdA;;;;;;EACE,gCAAa;ACqBf;ADlBA;;;;;EACE,6BAAa;ACwBf;ACnBA;;;;;;;;EACE,yBAAqB;AD4BvB;AChBA;;;;;;;;EAEE,oBAAc;EACd,uCAA+B;EAC/B,mCAAwB;ADwB1B;AChBA;;;;;EACE,yBAAgB;ADsBlB;ACrBE;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;EAME,oBAAgB;AD+CpB;ACmEA;EAIE,cAAO;EACP,eAAW;EACX,gBAAa;EACb,iBAAa;EACb,sBAAgB;ADpElB;ACqEE;EACE,iBAAgB;ADnEpB;AC2FA;EAIE,cAAO;EACP,eAAW;EACX,gBAAa;EACb,iBAAa;EACb,uBAAgB;AD5FlB;AC6FE;EACE,iBAAgB;AD3FpB;AC6GA;;;EAIE,cAAO;EACP,eAAW;EAIX,gBAAa;EACb,iBAAa;EACb,uBAAgB;AD/GlB;AC0GE;;;EACE,eAAW;ADtGf;AC2GE;;;EACE,iBAAgB;ADvGpB;ACyJA;;EAGE,cAAO;EACP,eAAW;EACX,mBAAa;EACb,iBAAa;EACb,uBAAgB;EAIhB,4CAAwB;AD3J1B;ACwJE;;EACE,iBAAgB;ADrJpB;AC0JA;EAGE,cAAO;EACP,eAAW;EAIX,mBAAa;EACb,iBAAa;EACb,uBAAgB;EAIhB,4CAAwB;ADhK1B;ACuJE;EACE,eAAW;ADrJf;AC0JE;EACE,iBAAgB;ADxJpB;ACgdA;EACE,cAAO;AD9cT;AE7FE;EACE,YAAO;EACP,YAAQ;EAER,6BAA0B;EAC1B,4BAAqB;EACrB,wBAAoB;EACpB,yBAAqB;EACrB,+CAAwC;EACxC,gDAAyC;EACzC,sBAAmB;AF8FvB;AAlKA;EACE,YAAO;EACP,gBAAU;AAoKZ;AAjKA;EAEE,aAAS;EACT,sBAAgB;EAChB,mBAAY;EACZ,0BAAQ;EACR,eAAQ;EACR,UAAS;EACT,4BAAW;EACX,+BAAkB;EAClB,oFAAyD;EACzD,kBAAU;EACV,aAAQ;AAkKV;AAjKE;EACE,cAAW;AAmKf;AAhKE;EACE,UAAS;EACT,wBAAW;AAkKf;AA/JE;EACE,iBAAS;AAiKb;AA/JI;EACE,aAAS;AAiKf;AA7JE;EAEE,aAAS;EACT,mBAAgB;EAChB,eAAW;EACX,WAAO;EACP,YAAQ;EACR,iCAAe;EACf,mBAAa;AA8JjB;AA5JI;EACE,aAAS;EACT,mBAAgB;EAChB,mBAAa;EACb,YAAW;AA8JjB;AA5JM;EAEE,aAAS;EACT,sBAAgB;EAChB,eAAW;EACX,cAAO;EACP,iBAAQ;AA6JhB;AA5JQ;EACE,iBAAQ;AA8JlB;AA1JM;EACE,aAAS;AA4JjB;AAzJM;EACE,oBAAQ;AA2JhB;AA1JQ;EACE,oBAAQ;AA4JlB;AAxJM;EACE,cAAS;EACT,WAAO;EACP,YAAQ;EACR,eAAQ;EACR,oBAAQ;EACR,yDAAuE;EACvE,wBAAiB;EACjB,4BAAmB;EACnB,2BAAqB;EACrB,YAAS;EACT,cAAa;AA0JrB;AAzJQ;EACE,oBAAQ;AA2JlB;AAxJQ;EACE,UAAS;AA0JnB;AArJI;EACE,aAAS;EAGT,cAAO;EACP,aAAS;EACT,mBAAa;EACb,yBAAiB;EACjB,YAAQ;EACR,iBAAc;EACd,sBAAY;EACZ,cAAa;EACb,gBAAU;AAqJhB;AAnJM;EACE,eAAS;EACT,YAAQ;EACR,WAAO;AAqJf;AAjJQ;EAEE,cAAO;EACP,mBAAgB;EAChB,gBAAa;EACb,iBAAc;EACd,eAAS;AAkJnB;AA/IQ;EACE,uBAAe;EACf,gBAAW;EACX,mBAAgB;EAChB,eAAS;AAiJnB;AA3IE;EACE,aAAS;EACT,aAAQ;EACR,iBAAS;EACT,sBAAY;AA6IhB;AA1IE;EACE,sBAAgB;EAChB,mBAAY;AA4IhB;AA1II;EAEE,cAAO;EACP,aAAQ;EACR,aAAS;EACT,mBAAgB;EAChB,mBAAa;EACb,QAAK;AA2IX;AAzIM;EACE,aAAS;AA2IjB;AAxIM;EACE,kBAAQ;AA0IhB;AAzIQ;EACE,kBAAQ;AA2IlB;AAxIQ;EACE,aAAS;AA0InB;AArII;EACE,WAAO;EACP,WAAQ;EACR,mBAAY;EACZ,kBAAY;EACZ,cAAa;AAuInB;AArIM;EACE,aAAS;AAuIjB;AAnII;EACE,aAAS;EACT,mBAAgB;EAChB,mBAAa;EACb,QAAK;EACL,iBAAS;EACT,yBAAQ;EACR,cAAO;EACP,yEAAY;AAqIlB;AAnIM;EACE,aAAS;AAqIjB;AAlIM;EACE,oBAAS;EACT,mBAAa;EACb,uBAAiB;EACjB,QAAK;EACL,cAAa;EACb,sBAAY;EACZ,WAAO;EACP,YAAQ;EACR,yDAAkE;EAClE,0BAAiB;EACjB,4BAAmB;AAoI3B;AAjIM;EACE,WAAO;EACP,YAAQ;EACR,8BAAkB;EAClB,2DAA+D;EAC/D,8BAAqB;EACrB,0BAAmB;EACnB,6BAAuB;EACvB,mDAAuD;EACvD,sBAAa;EACb,kBAAW;EACX,qBAAe;AAmIvB;AAhIM;EAEE,cAAO;EACP,eAAW;EACX,iBAAa;EACb,sBAAgB;AAiIxB;AA9HM;EACE,aAAS;EACT,mBAAgB;EAChB,mBAAa;EACb,QAAK;EACL,OAAM;EACN,YAAW;EACX,eAAW;EACX,cAAO;EACP,mBAAa;EACb,gBAAU;EACV,uBAAe;AAgIvB;AA9HQ;EACE,cAAa;EACb,YAAW;EACX,gBAAU;EACV,uBAAe;AAgIzB;AA3HI;EAEE,cAAO;EACP,aAAQ;EACR,aAAS;EACT,mBAAgB;EAChB,mBAAa;EACb,QAAK;AA4HX;AA1HM;EACE,aAAS;AA4HjB;AAzHM;EACE,iBAAc;AA2HtB;AAxHM;EAEE,kBAAY;EACZ,cAAO;EACP,iBAAa;EACb,eAAW;EACX,mBAAa;AAyHrB;AAtHQ;EACE,aAAS;AAwHnB;AApHM;EACE,aAAS;AAsHjB;AAnHM;EACE,kBAAQ;AAqHhB;AApHQ;EACE,kBAAQ;AAsHlB;AAnHQ;EACE,aAAS;AAqHnB;AAjHM;EACE,cAAa;AAmHrB;AAlHQ;EACE,eAAc;AAoHxB;AA/GI;EACE,YAAQ;AAiHd;AA9GI;EACE,aAAS;EACT,kBAAY;EACZ,WAAQ;EACR,WAAQ;AAgHd;AA5GE;EACE,sBAAgB;EAChB,mBAAa;EACb,uBAAiB;EACjB,YAAQ;AA8GZ;AA5GI;EACE,WAAO;EACP,YAAQ;EACR,oEAAyD;EACzD,wBAAiB;AA8GvB;AA3GI;EAEE,sBAAgB;EAChB,cAAO;EACP,kBAAY;EACZ,gBAAY;EACZ,YAAO;AA4Gb;AAzGI;EACE,aAAS;EACT,WAAQ;EACR,WAAQ;AA2Gd;AAvGE;EACE,sBAAgB;EAChB,mBAAa;EACb,cAAO;EACP,uBAAiB;AAyGrB;AAvGI;EACE,yDAA6D;EAC7D,sBAAiB;EACjB,YAAO;EACP,aAAQ;AAyGd;AAtGI;EAEE,YAAO;EACP,kBAAY;EACZ,eAAW;AAuGjB;AApGI;EACE,aAAS;EACT,WAAQ;EACR,WAAQ;AAsGd;AAlGE;EACE,aAAS;EACT,8BAAiB;EACjB,YAAQ;EACR,WAAO;EACP,mBAAa;EACb,uFAAY;EACZ,iCAAe;EACf,eAAQ;AAoGZ;AAlGI;EACE,iCAAY;AAoGlB;AAjGI;EACE,cAAO;AAmGb;AAlGM;EACE,cAAO;AAoGf;AAlGM;EACE,yDAAqE;AAoG7E;AAlGM;EACE,yDAAmE;AAoG3E;AAlGM;EACE,yDAAmE;AAoG3E;AAhGI;EACE,cAAO;AAkGb;AAhGM;EACE,cAAO;AAkGf;AAhGM;EACE,yDAAoE;AAkG5E;AAhGM;EACE,yDAAkE;AAkG1E;AAhGM;EACE,0DAAkE;AAkG1E;AA9FI;EACE,cAAO;AAgGb;AA7FI;EACE,eAAW;EACX,YAAW;EACX,iBAAQ;AA+Fd;AA9FM;EACE,iBAAQ;AAgGhB;AA5FI;EACE,sBAAiB;EACjB,WAAO;EACP,YAAQ;EACR,eAAQ;EACR,iBAAQ;AA8Fd;AA7FM;EACE,iBAAQ;AA+FhB;AA5FM;EACE,oBAAgB;EAChB,YAAS;AA8FjB;AAxFE;EACE,aAAS;EACT,mBAAgB;EAChB,YAAQ;AA0FZ;AAxFI;EACE,yFAAY;AA0FlB;AAvFI;EACE,aAAS;EACT,UAAO;EACP,yBAAkB;AAyFxB;AAtFI;EACE,aAAS;EACT,kBAAU;EACV,YAAQ;EACR,WAAO;AAwFb;AAvFM;EACE,WAAO;EACP,UAAM;AAyFd;AArFI;EACE,0DAA8D;EAC9D,sBAAiB;EACjB,WAAO;EACP,YAAQ;EACR,eAAQ;AAuFd;AArFM;EACE,0DAA4D;AAuFpE;AApFM;EACE,0DAA4D;AAsFpE;AAnFM;EACE,0DAAoE;AAqF5E;AAnFQ;EACE,0DAAkE;AAqF5E;AAlFQ;EACE,0DAAkE;AAoF5E;AAhFM;EACE,0DAA+D;EAC/D,eAAQ;AAkFhB;AA9EI;EACE,0DAAiE;EACjE,sBAAiB;EACjB,WAAO;EACP,YAAQ;EACR,mBAAQ;EACR,eAAQ;EACR,aAAS;AAgFf;AA9EM;EACE,0DAA+D;AAgFvE;AA7EM;EACE,0DAA+D;AA+EvE;AA5EM;EACE,0DAAmE;AA8E3E;AA5EQ;EACE,0DAAiE;AA8E3E;AA3EQ;EACE,0DAAiE;AA6E3E;AAxEI;EACE,UAAO;EACP,gBAAQ;EACR,mBAAY;EACZ,kBAAY;EACZ,aAAQ;AA0Ed;AAvEI;EACE,0DAAmE;EACnE,sBAAiB;EACjB,WAAO;EACP,YAAQ;EACR,eAAQ;AAyEd;AAvEM;EACE,0DAAiE;AAyEzE;AAtEM;EACE,0DAAiE;AAwEzE;AAtEM;;;EACE,0DAAoE;EACpE,eAAQ;AA0EhB;AArEE;EACE,kBAAY;EACZ,mBAAQ;AAuEZ;AAtEI;EACE,mBAAQ;AAwEd;AApEE;EACE,aAAS;EACT,OAAM;EACN,sBAAgB;EAChB,YAAW;EACX,eAAW;EACX,cAAO;EACP,0BAAQ;AAsEZ;AArEI;EACE,0BAAQ;AAuEd;AApEI;EACE,WAAO;AAsEb;AAnEI;EACE,aAAS;EACT,mBAAgB;EAChB,8BAAiB;AAqEvB;AAnEM;EACE,gBAAW;EACX,mBAAa;EACb,uBAAe;EACf,gBAAU;AAqElB;AAjEI;EACE,cAAO;AAmEb;AA7DE;EACE,kBAAU;EACV,WAAO;EACP,YAAQ;EACR,eAAQ;EACR,cAAa;EACb,0DAAyE;EACzE,0BAAiB;EACjB,4BAAmB;AA+DvB;AA7DI;EACE,kBAAU;EACV,QAAK;EACL,2BAAW;EACX,WAAO;EACP,YAAQ;EACR,wBAAiB;EACjB,4BAAmB;EACnB,2BAAqB;AA+D3B;AA5DI;EACE,kBAAU;EACV,QAAK;EACL,2BAAW;EACX,WAAO;EACP,YAAQ;EACR,wBAAiB;EACjB,4BAAmB;EACnB,2BAAqB;EACrB,2BAAY;AA8DlB;AA1DM;EACE,aAAS;AA4DjB;AA1DM;EACE,SAAM;EACN,0DAA4E;AA4DpF;AAvDM;EACE,cAAS;EACT,SAAM;EACN,0DAAyE;AAyDjF;AAvDM;EACE,UAAM;EACN,0DAAiF;AAyDzF;AApDM;EACE,cAAS;EACT,SAAM;EACN,WAAO;EACP,YAAQ;EACR,0DAAuE;EACvE,+CAAW;AAsDnB;AApDM;EACE,UAAM;EACN,0DAAiF;AAsDzF;AAlDI;EACE,mBAAQ;AAoDd;AAnDM;EACE,cAAS;EACT,UAAO;EACP,UAAM;EACN,0DAAwE;AAqDhF;AAnDM;EACE,SAAM;EACN,0DAAkF;AAqD1F;AAjDI;EACE,eAAQ;AAmDd;AAlDM;EACE,cAAS;EACT,SAAM;EACN,WAAO;EACP,0DAA+D;AAoDvE;AAlDM;EACE,UAAM;EACN,0DAAoE;AAoD5E;AAhDI;EACE,YAAS;EACT,mBAAQ;EACR,oBAAgB;AAkDtB;AA/CI;EACE,mBAAQ;EACR,oBAAgB;AAiDtB;AAhDM;EACE,cAAS;EACT,UAAO;EACP,UAAM;EACN,0DAA8E;AAkDtF;AAhDM;EACE,SAAM;EACN,0DAA4E;AAkDpF;AA5CA;EACE;IACE,wCAAW;EA8Cb;EA5CA;IACE,0CAAW;EA8Cb;AACF;AApDA;EACE;IACE,wCAAW;EAsDb;EApDA;IACE,0CAAW;EAsDb;AACF;AA5DA;EACE;IACE,wCAAW;EA8Db;EA5DA;IACE,0CAAW;EA8Db;AACF;AApEA;EACE;IACE,wCAAW;EAsEb;EApEA;IACE,0CAAW;EAsEb;AACF",
            ...
            class k extends i.default {
                ...
                _updateCombinedAvailability(e) {
                    ...
                    e || (this._voiceDisabled = !1, this._handleVoiceDisabled(), this._disabledAfterLogin = t && t.disabledAfterLogin), e || !this._isInGame || this._buttonDisabled ? !this._isInGame && this._buttonDisabled && (this._buttonDisabled = !1, this.removeClass("button-disabled", this._elements.voiceButton), this._voicePanelElement && this._voicePanelElement.dispatchEvent(new Event("voiceButtonEnabled")), this._detachDisabledTooltip()) : (this._buttonDisabled = !0, this.addClass("button-disabled", this._elements.voiceButton), this._checkIfTooltipNeeded(), this._hidePanel())
                }
                lobbyUpdated(e) {
                ...
                _initDataBinding() {
                    this.lobbyDataListener = this.lobbyUpdated.bind(this), _.default.observe("lobby", this.lobbyDataListener), _.default.lobby().then(this.lobbyDataListener), this.availabilityDataListener = this.availabilityUpdated.bind(this), m.default.observe("availability", this.availabilityDataListener), m.default.availability().then(this.availabilityDataListener), this.teamVoiceAvailabilityListener = this.teamVoiceAvailabilityUpdated.bind(this), u.default.observe("availability", this.teamVoiceAvailabilityListener), u.default.availability().then(this.teamVoiceAvailabilityListener), this._voiceFirstExperienceListener = this._voiceFirstExperienceUpdated.bind(this), m.default.observe("firstExperience", this._voiceFirstExperienceListener), m.default.firstExperience().then(this._voiceFirstExperienceListener), this.gameflowSessionListener = this.gameflowSessionUpdated.bind(this), g.default.observe("session", this.gameflowSessionListener), g.default.session().then(this.gameflowSessionListener), this.settingsDataListener = this.settingsUpdated.bind(this), m.default.observe("settings", this.settingsDataListener), m.default.settings().then(this.settingsDataListener), this.participantsDataListener = this.participantsUpdated.bind(this), m.default.observe("participants", this.participantsDataListener), m.default.participants().then(this.participantsDataListener), this.teamVoiceSessionListener = this.teamVoiceSessionUpdated.bind(this), u.default.observe("session", this.teamVoiceSessionListener), u.default.session().then(this.teamVoiceSessionListener), this.teamVoicePluginEnabledListener = this.teamVoiceEnabledUpdated.bind(this), A.default.observe("teamVoicePluginEnabled", this.teamVoicePluginEnabledListener), A.default.teamVoicePluginEnabled().then(this.teamVoicePluginEnabledListener)
                }
                gameflowSessionUpdated(e) {
                    if (!e || !e.phase) return;
                ...
                _checkIfTooltipNeeded() {
                    this._buttonDisabled && (this._disabledAfterLogin ? this._tooltipType !== b.VOICE_BUTTON_TOOLTIP_TYPES.DISABLED && this._attachDisabledTooltip(b.VOICE_BUTTON_TOOLTIP_TYPES.DISABLED) : this._isInCustomGame ? this._tooltipType !== b.VOICE_BUTTON_TOOLTIP_TYPES.CUSTOM_GAME && this._attachDisabledTooltip(b.VOICE_BUTTON_TOOLTIP_TYPES.CUSTOM_GAME) : this._tooltipType !== b.VOICE_BUTTON_TOOLTIP_TYPES.NO_PARTY && this._attachDisabledTooltip(b.VOICE_BUTTON_TOOLTIP_TYPES.NO_PARTY))
                }
                _attachDisabledTooltip(e) {
                    ...
                    let n;
                    switch (e) {
                        case b.VOICE_BUTTON_TOOLTIP_TYPES.CUSTOM_GAME:
                            n = r.tra.get("parties_comm_button_error_in_custom_game");
                            break;
                        case b.VOICE_BUTTON_TOOLTIP_TYPES.NO_PARTY:
                            n = r.tra.get("parties_comm_button_error_not_in_party");
                            break;
                        case b.VOICE_BUTTON_TOOLTIP_TYPES.DISABLED:
                ...
                _checkIfFirstExperience() {
                    this._isSocial && this._showFirstExperience && this._isInPremade && !this._showedFirstExperience && this.parentNode && (this._showPanel(!1), this._attachFirstExperienceTooltip(), m.default.firstExperienceCompleted(), this._showedFirstExperience = !0)
                }
                ...
                teamVoiceEnabledUpdated(e) {
                    this._teamVoicePluginEnabled = e, this._checkIfTeamVoiceEATNeeded()
                }
                _checkIfTeamVoiceEATNeeded() {
                    !this._teamVoiceEATShown && this._teamVoicePluginEnabled && this._isInLobby && this.parentNode && null === this._teamVoiceEATSeen && (this._teamVoiceEATSeen = !1, v.default.navigationPreferences().then((e => {
                        const t = !e || !e.data || !1 !== e.data[C];
                        this._teamVoiceEATSeen = !t, t && this._showTeamVoiceEAT()
                    })).catch((e => {
                        r.logger.error(`voice-button -- error reading team voice EAT preference: ${e}`)
                    })))
                }
                _showTeamVoiceEAT() {
                    ...
                    requestAnimationFrame((() => {
                        const t = this.getBoundingClientRect(),
                            ...
                            a = Math.round(t.top - n.height - 11);
                        e.style.left = `${i}px`, e.style.top = `${a}px`, e.style.visibility = "visible"
                    })), this._teamVoiceEATSeen = !0
                }
                _dismissTeamVoiceEAT() {
                    this._teamVoiceEATNotification && (this._teamVoiceEATNotification.parentNode && this._teamVoiceEATNotification.parentNode.removeChild(this._teamVoiceEATNotification), this._teamVoiceEATNotification = null), v.default.patchNavigationPreferences({
                        [C]: !1
                    })
                }
                participantsUpdated(e) {
                    const t = e && e.length > 0 ? f.VOICE_CONNECTED_STATE : f.VOICE_DISCONNECTED_STATE,
                        n = e ? e.length : 0;
                    this._connectionState === f.VOICE_DISCONNECTED_STATE && t === f.VOICE_CONNECTED_STATE ? (this._playJoinSound(), this._lockOutMemberJoinSound = !0, clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                    }), 500)) : this._connectionState === f.VOICE_CONNECTED_STATE && t === f.VOICE_DISCONNECTED_STATE || this._connectionState === f.VOICE_CONNECTED_STATE && n < this._previousParticipantCount ? this._playLeaveSound() : this._connectionState === f.VOICE_CONNECTED_STATE && n > this._previousParticipantCount && !this._lockOutMemberJoinSound && this._playDelayedJoinSound();
                ...
                teamVoiceSessionUpdated(e) {
                    const t = e && e.participants && e.participants.length > 0,
                        n = t ? f.VOICE_CONNECTED_STATE : f.VOICE_DISCONNECTED_STATE;
                    this._teamVoiceRestricted = !(!e || !e.isRestricted), this._teamVoicePluginEnabled && (!this._previousTeamSessionActive && t ? this._playTeamToggleOnSound() : this._previousTeamSessionActive && !t && this._playTeamToggleOffSound());
                ...
                _handleKeyDown(e) {
                    this._teamVoicePluginEnabled && (!this._pttTeamKey || this._teamConnectionState !== f.VOICE_CONNECTED_STATE || this._teamVoiceRestricted || e.key !== this._pttTeamKey || e.repeat || (this._teamPttReleaseSound.stop(), this._teamPttClickSound.play()), this._pttKey && this._connectionState === f.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && !e.repeat && (this._partyPttReleaseSound.stop(), this._partyPttClickSound.play()))
                }
                _handleKeyUp(e) {
                    this._teamVoicePluginEnabled && (this._pttTeamKey && this._teamConnectionState === f.VOICE_CONNECTED_STATE && !this._teamVoiceRestricted && e.key === this._pttTeamKey && (this._teamPttClickSound.stop(), this._teamPttReleaseSound.play()), this._pttKey && this._connectionState === f.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && (this._partyPttClickSound.stop(), this._partyPttReleaseSound.play()))
                }
                _playJoinSound() {
            ...
            k.tagName = "lol-parties-comm-button";
            var B = k;
            t.default = B
        }, (e, t, n) => {
            "use strict";
            ...
            g.tagName = "lol-parties-comm-participant";
            var _ = g;
            t.default = _
        }, e => {
            "use strict";
            ...
            i.push([e.id, ".team-voice-tooltip-header {\n  font-family: var(--font-display);\n}\n.team-voice-tooltip-body {\n  font-family: var(--font-body);\n}\n.team-voice-tooltip-header {\n  font-family: var(--font-display);\n}\n.team-voice-tooltip-body {\n  font-family: var(--font-body);\n}\n:host {\n  display: block;\n}\n.team-voice-tooltip {\n  display: flex;\n  flex-direction: column;\n  width: 180px;\n  padding: 9px;\n  text-align: center;\n  color: #a09b8c;\n  white-space: normal;\n  word-wrap: break-word;\n}\n.team-voice-tooltip-header {\n  color: #c8aa6e;\n  font-weight: bold;\n  font-size: 12px;\n  margin-bottom: 4px;\n}\n.team-voice-tooltip-body {\n  font-size: 12px;\n  line-height: 1.3;\n}\n", "", {
                ...
                names: [],
                mappings: "AAAA;EACE,gCAAa;ACCf;ADEA;EACE,6BAAa;ACAf;ADLA;EACE,gCAAa;ACOf;ADJA;EACE,6BAAa;ACMf;AAPA;EACE,cAAS;AASX;AANA;EACE,aAAS;EACT,sBAAgB;EAChB,YAAO;EACP,YAAS;EACT,kBAAY;EACZ,cAAO;EACP,mBAAa;EACb,qBAAW;AAQb;AALA;EAEE,cAAO;EACP,iBAAa;EACb,eAAW;EACX,kBAAe;AAMjB;AAHA;EAEE,eAAW;EACX,gBAAa;AAIf",
                sourcesContent: ["$fonts_lol_display {\r\n  font-family: var(--font-display);\r\n}\r\n\r\n$fonts_lol_body {\r\n  font-family: var(--font-body);\r\n}\r\n\r\n/**\r\n * Deprecated, keeping just to not break thiings abruptly.\r\n */\r\n\r\n$fonts_beaufort {\r\n  @extend $fonts_lol_display;\r\n}\r\n\r\n$fonts_spiegel {\r\n  @extend $fonts_lol_body;\r\n}\r\n\r\n$fonts_frizquadrata {\r\n  font-family: var(--font-frizquadrata);\r\n  \r\n  &:lang(vi-VN) {\r\n    font-family: var(--font-display);\r\n  }\r\n}\r\n\r\n", "@require 'riotclient-lol-asset-csslib/styles/fonts';\r\n@require 'riotclient-lol-asset-csslib/styles/typekit';\r\n@require 'riotclient-lol-asset-csslib/styles/color-palette';\r\n\r\n:host {\r\n  display: block;\r\n}\r\n\r\n.team-voice-tooltip {\r\n  display: flex;\r\n  flex-direction: column;\r\n  width: 180px;\r\n  padding: 9px;\r\n  text-align: center;\r\n  color: $color_palette_grey1;\r\n  white-space: normal;\r\n  word-wrap: break-word;\r\n}\r\n\r\n.team-voice-tooltip-header {\r\n  @extend $fonts_lol_display;\r\n  color: $color_palette_gold3;\r\n  font-weight: bold;\r\n  font-size: 12px;\r\n  margin-bottom: 4px;\r\n}\r\n\r\n.team-voice-tooltip-body {\r\n  @extend $fonts_lol_body;\r\n  font-size: 12px;\r\n  line-height: 1.3;\r\n}\r\n"],
                sourceRoot: ""
            }]), e.exports = i
        }, (e, t, n) => {
            ...
            class a extends i.default {
                ...
                attributeChangedCallback(e, t, n) {
                    super.attributeChangedCallback(), "header" === e ? this.addInnerHtml(n || "", this._selectors.title) : "body" === e && this.addInnerHtml(n || "", this._selectors.body)
                }
                connectedCallback() {
                    super.connectedCallback(), this.addInnerHtml(this.getAttribute("header") || "", this._selectors.title), this.addInnerHtml(this.getAttribute("body") || "", this._selectors.body), this.attachListener("click", this._onCloseClick, this._selectors.close)
                }
                disconnectedCallback() {
            ...
            a.tagName = "lol-parties-team-voice-eat";
            var o = a;
            t.default = o
        }, e => {
            "use strict";
            ...
            i.push([e.id, '.team-voice-eat-text-title {\n  font-family: var(--font-display);\n}\n.team-voice-eat-text-msg {\n  font-family: var(--font-body);\n}\n.team-voice-eat-text-title,\n.team-voice-eat-text-msg {\n  -webkit-user-select: none;\n}\n.team-voice-eat-text-title,\n.team-voice-eat-text-msg {\n  font-kerning: normal;\n  -webkit-font-feature-settings: "kern" 1;\n  -webkit-font-smoothing: antialiased;\n}\n.team-voice-eat-text-title {\n  text-transform: uppercase;\n}\n.team-voice-eat-text-title:lang(ko-kr),\n.team-voice-eat-text-title:lang(ja-jp),\n.team-voice-eat-text-title:lang(tr-tr),\n.team-voice-eat-text-title:lang(el-gr),\n.team-voice-eat-text-title:lang(th-th),\n.team-voice-eat-text-title:lang(zh-tw) {\n  text-transform: none;\n}\n.team-voice-eat-text-title {\n  color: #f0e6d2;\n  font-size: 18px;\n  font-weight: 700;\n  line-height: 22px;\n  letter-spacing: 0.05em;\n}\n.team-voice-eat-text-title:lang(ar-ae) {\n  letter-spacing: 0;\n}\n.team-voice-eat-text-msg {\n  color: #a09b8c;\n  font-size: 14px;\n  font-weight: normal;\n  line-height: 20px;\n  letter-spacing: 0.025em;\n  -webkit-font-smoothing: subpixel-antialiased;\n}\n.team-voice-eat-text-msg:lang(ar-ae) {\n  letter-spacing: 0;\n}\n:host {\n  direction: ltr;\n  display: block;\n  width: 375px;\n  min-height: 115px;\n  position: relative;\n}\n.team-voice-eat {\n  position: relative;\n  width: 100%;\n  min-height: 100%;\n}\n.team-voice-eat-dismiss {\n  display: block;\n  height: 12px;\n  width: 12px;\n  position: absolute;\n  top: 8px;\n  right: 8px;\n  background: url("/fe/lol-static-assets/images/close.svg");\n  background-position: center;\n  background-repeat: no-repeat;\n  cursor: pointer;\n  border-radius: 4px;\n  padding: 4px;\n  z-index: 2;\n}\n.team-voice-eat-content {\n  display: flex;\n  flex-direction: row;\n  width: 100%;\n  min-height: 100px;\n  border-radius: 2px;\n  overflow: visible;\n  background: #c89b3c;\n  position: relative;\n}\n.team-voice-eat-caret {\n  position: absolute;\n  right: 15px;\n  bottom: -9px;\n  width: 18px;\n  height: 25px;\n  pointer-events: none;\n}\n.team-voice-eat-icon {\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  width: 81px;\n  height: 100%;\n  flex-shrink: 0;\n}\n.team-voice-eat-icon-image {\n  width: 42px;\n  height: 42px;\n  margin-top: 20px;\n  padding: 8px;\n  box-sizing: border-box;\n  background-color: #3d2e1d;\n  border-radius: 50%;\n  object-fit: contain;\n}\n.team-voice-eat-text {\n  display: flex;\n  flex-direction: column;\n  width: 266px;\n  height: 100%;\n  align-self: flex-end;\n  white-space: normal;\n}\n.team-voice-eat-text-title {\n  font-weight: bold;\n  margin-top: 20px;\n  color: #3d2e1d;\n  text-transform: none;\n}\n.team-voice-eat-text-msg {\n  margin-top: 5px;\n  margin-bottom: 20px;\n  color: #3d2e1d;\n  text-transform: none;\n}\n', "", {
                ...
                names: [],
                mappings: "AAAA;EACE,gCAAa;ACCf;ADEA;EACE,6BAAa;ACAf;ACKA;;EACE,yBAAqB;ADFvB;ACcA;;EAEE,oBAAc;EACd,uCAA+B;EAC/B,mCAAwB;ADZ1B;ACoBA;EACE,yBAAgB;ADlBlB;ACmBE;;;;;;EAME,oBAAgB;ADjBpB;ACmIA;EAIE,cAAO;EACP,eAAW;EACX,gBAAa;EACb,iBAAa;EACb,sBAAgB;ADpIlB;ACqIE;EACE,iBAAgB;ADnIpB;ACsPA;EAGE,cAAO;EACP,eAAW;EACX,mBAAa;EACb,iBAAa;EACb,uBAAgB;EAIhB,4CAAwB;ADzP1B;ACsPE;EACE,iBAAgB;ADpPpB;AA/BA;EACE,cAAW;EACX,cAAS;EACT,YAAO;EACP,iBAAY;EACZ,kBAAU;AAiCZ;AA9BA;EACE,kBAAU;EACV,WAAO;EACP,gBAAY;AAgCd;AA7BA;EACE,cAAS;EACT,YAAQ;EACR,WAAO;EACP,kBAAU;EACV,QAAK;EACL,UAAO;EACP,yDAA8C;EAC9C,2BAAqB;EACrB,4BAAmB;EACnB,eAAQ;EACR,kBAAe;EACf,YAAS;EACT,UAAS;AA+BX;AA5BA;EACE,aAAS;EACT,mBAAgB;EAChB,WAAO;EACP,iBAAY;EACZ,kBAAe;EACf,iBAAU;EACV,mBAAY;EACZ,kBAAU;AA8BZ;AAtBA;EACE,kBAAU;EACV,WAA6B;EAC7B,YAAQ;EACR,WAAO;EACP,YAAQ;EACR,oBAAgB;AAwBlB;AArBA;EACE,aAAS;EACT,uBAAa;EACb,uBAAiB;EACjB,WAAO;EACP,YAAQ;EACR,cAAa;AAuBf;AApBA;EACE,WAAO;EACP,YAAQ;EACR,gBAAY;EACZ,YAAS;EACT,sBAAY;EACZ,yBAAkB;EAClB,kBAAe;EACf,mBAAY;AAsBd;AAnBA;EACE,aAAS;EACT,sBAAgB;EAChB,YAAO;EACP,YAAQ;EACR,oBAAY;EACZ,mBAAa;AAqBf;AAlBA;EAEE,iBAAa;EACb,gBAAY;EACZ,cAAO;EACP,oBAAgB;AAmBlB;AAhBA;EAEE,eAAY;EACZ,mBAAe;EACf,cAAO;EACP,oBAAgB;AAiBlB",
            ...
            e.exports = class {
                constructor() {
                    this._registerComponents(), this._addVoiceSocialButton(), a.default.checkAndShowFtux()
                }
                voiceButton(e) {
                ...
                _addVoiceSocialButton() {
                    i.Social.addSocialButton(this.voiceButton({
                        social: "true",
                ...
                _registerComponents() {
                    i.ComponentFactory.setFactory("lol-parties-comm-panel", (() => this._voicePanel()))
                }
                setPuuidsToNameOverrides(e) {
