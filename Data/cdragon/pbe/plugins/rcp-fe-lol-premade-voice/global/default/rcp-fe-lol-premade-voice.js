    ...
    var e = [function(e, t, n) {
            ...
            class $ extends i.default {
                ...
                _checkIfTooltipNeeded() {
                    this._buttonDisabled && (this._disabledAfterLogin ? this._tooltipType !== x.VOICE_BUTTON_TOOLTIP_TYPES.DISABLED && this._attachDisabledTooltip(x.VOICE_BUTTON_TOOLTIP_TYPES.DISABLED) : this._isInCustomGame ? this._tooltipType !== x.VOICE_BUTTON_TOOLTIP_TYPES.CUSTOM_GAME && this._attachDisabledTooltip(x.VOICE_BUTTON_TOOLTIP_TYPES.CUSTOM_GAME) : this._tooltipType !== x.VOICE_BUTTON_TOOLTIP_TYPES.NO_PARTY && this._attachDisabledTooltip(x.VOICE_BUTTON_TOOLTIP_TYPES.NO_PARTY))
                }
                _attachDisabledTooltip(e) {
                    ...
                    let n;
                    switch (e) {
                        case x.VOICE_BUTTON_TOOLTIP_TYPES.CUSTOM_GAME:
                            n = r.tra.get("parties_comm_button_error_in_custom_game");
                            break;
                        case x.VOICE_BUTTON_TOOLTIP_TYPES.NO_PARTY:
                            n = r.tra.get("parties_comm_button_error_not_in_party");
                            break;
                        case x.VOICE_BUTTON_TOOLTIP_TYPES.DISABLED:
                ...
                _checkIfTeamVoiceEATNeeded() {
                    !this._teamVoiceEATShown && this._teamVoicePluginEnabled && this._isInLobby && this.parentNode && null === this._teamVoiceEATSeen && (this._teamVoiceEATSeen = !1, f.default.evaluate().then((({
                        migrated: e,
                        rows: t
                    }) => {
                        this._teamVoiceEATSeen = !e, e && this._showTeamVoiceEAT(t)
                    })).catch((e => {
                        r.logger.error(`voice-button -- error reading team voice keybind migration: ${e}`)
                    })))
                }
                _teamVoiceEATKeyDisplay(e) {
                    const t = (0, y.keybindTokens)(e);
                ...
                participantsUpdated(e) {
                    const t = e && e.length > 0 ? E.VOICE_CONNECTED_STATE : E.VOICE_DISCONNECTED_STATE,
                        n = e ? e.length : 0;
                    this._connectionState === E.VOICE_DISCONNECTED_STATE && t === E.VOICE_CONNECTED_STATE ? (this._partyChannelConnectSound.play(), this._lockOutMemberJoinSound = !0, clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                    }), 500)) : this._connectionState === E.VOICE_CONNECTED_STATE && t === E.VOICE_DISCONNECTED_STATE ? this._partyChannelDisconnectSound.play() : this._connectionState === E.VOICE_CONNECTED_STATE && n < this._previousParticipantCount ? this._playLeaveSound() : this._connectionState === E.VOICE_CONNECTED_STATE && n > this._previousParticipantCount && !this._lockOutMemberJoinSound && this._playDelayedJoinSound();
                ...
                teamVoiceSessionUpdated(e) {
                    const t = e && e.participants && e.participants.length > 0,
                        n = t ? E.VOICE_CONNECTED_STATE : E.VOICE_DISCONNECTED_STATE;
                ...
                _handleKeyDown(e) {
                    this._teamVoicePluginEnabled && (!this._pttTeamKey || this._teamConnectionState !== E.VOICE_CONNECTED_STATE || this._teamVoiceRestricted || e.key !== this._pttTeamKey || e.repeat || (this._teamPttReleaseSound.stop(), this._teamPttClickSound.play()), this._pttKey && this._connectionState === E.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && !e.repeat && (this._partyPttReleaseSound.stop(), this._partyPttClickSound.play()))
                }
                _handleKeyUp(e) {
                    this._teamVoicePluginEnabled && (this._pttTeamKey && this._teamConnectionState === E.VOICE_CONNECTED_STATE && !this._teamVoiceRestricted && e.key === this._pttTeamKey && (this._teamPttClickSound.stop(), this._teamPttReleaseSound.play()), this._pttKey && this._connectionState === E.VOICE_CONNECTED_STATE && this._pttActive && e.key === this._pttKey && (this._partyPttClickSound.stop(), this._partyPttReleaseSound.play()))
                }
                _playJoinSound() {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.planHasUpdates = t.default = t.buildMigrationPlan = t.buildKeybindRows = t.MIGRATION_VERSION_KEY = void 0;
            var r = function(e, t) {
                    if (!t && e && e.__esModule) return e;
                    if (null === e || "object" != typeof e && "function" != typeof e) return {
                        default: e
            ...
            const m = (e, t) => t.legacy === o.UNBOUND ? (0, o.isUnbound)(e) : (0, o.normalizeKeybinding)((0, o.primaryKeybinding)(e)) === t.legacy,
                ...
                _ = (e, t) => e && e[t.field] || "",
                v = (e, t, n, r) => {
                    const i = g(e, t[n - 1].next),
                        a = t[n];
                    return a ? !!((e, t) => e.every((e => e === t)))(i, a.path) && (!m(A(e, a), a) || !(a.next !== o.UNBOUND && !v(e, t, n + 1, r)) && (r.push(a), !0)) : 0 === i.length
                },
                b = (e, t, n) => {
                    const [r] = n, i = [];
                    return m(_(t, r), r) && v(e, n, 1, i) ? i.concat(r) : []
                },
                f = (e, t) => {
                    const n = {},
                        r = {},
                        i = [...b(e, t, o.PARTY_PTT_CHAIN), ...b(e, t, o.TEAM_PTT_CHAIN)];
                    return i.concat(i.flatMap((t => ((e, t) => {
                        const n = t.follower;
                        return n && m(A(e, n), n) && 0 === g(e, n.next).length ? [n] : []
                    })(e, t)))).forEach((i => {
                        i.field ? r[i.field] = u(_(t, i), i.next) : (n[i.section] = n[i.section] || {}, n[i.section][i.key] = u(A(e, i), i.next))
                    })), {
                        inputUpdates: n,
                        voiceUpdates: r
                    }
            ...
            const x = e => e ? JSON.parse(JSON.stringify(e)) : e,
                ...
                C = (e, t, n) => o.KEYBIND_DEFINITIONS.map((r => {
                    const i = e => r.field ? e.voiceSettings && e.voiceSettings[r.field] || "" : A(e.inputSettings, r),
                        a = ((e, t) => Boolean(E(e, t)))(r, n);
                    return {
                        id: r.id,
                        moved: a,
                        from: a ? (0, o.primaryKeybinding)(i(e)) : null,
                        to: (0, o.primaryKeybinding)(a ? E(r, n) : i(t))
                    }
                }));
            t.buildKeybindRows = C;
            var k = new class {
                constructor() {
                ...
                async _evaluate() {
                    ...
                    if (!y(i)) return e;
                    Object.keys(i.inputUpdates).length > 0 && await this._gameBinding.patch(c, i.inputUpdates), Object.keys(i.voiceUpdates).length > 0 && await a.default.patchAccountVoiceSettings(i.voiceUpdates), await a.default.patchNavigationPreferences({
                        [h]: 1
                    });
