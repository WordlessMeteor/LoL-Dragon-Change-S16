    ...
    var e = [function(e, t, n) {
            ...
            class L extends r.default {
                ...
                teamVoicePluginEnabledUpdate(e) {
                    this._teamVoicePluginEnabled = e, this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility(), this._updateKeyBindIndicators(), this._updatePartyToggleState(), this._updateTeamToggleState(), this._updateVoiceSkinIndicator()
                }
            ...
            class $ extends i.default {
                ...
                _checkIfTeamVoiceEATNeeded() {
                    !this._teamVoiceEATShown && this._teamVoicePluginEnabled && this._isInLobby && this.parentNode && null === this._teamVoiceEATSeen && (this._teamVoiceEATSeen = !1, y.default.evaluate().then((({
                        migrated: e,
                        rows: t
                    }) => {
