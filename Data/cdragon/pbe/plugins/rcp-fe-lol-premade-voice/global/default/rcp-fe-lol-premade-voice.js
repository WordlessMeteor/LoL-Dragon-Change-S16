(() => {
    var e = [function(e, t, n) {
            ...
            class T extends r.default {
                ...
                constructor() {
                    super(), this._participants = [], this._participantMap = new Map, this._teamParticipants = [], this._teamParticipantMap = new Map, this._multiUserChatId = null, this._gameflowPhase = "", this._isGameClientRunning = !1, this._lastVolumeUpdate = 0, this._lockOutMemberJoinSound = !1, this._isDraggingMicSlider = !1, this._clashRoster = null, this._headerType = x.HEADER_LOBBY, this._connectionState = f.VOICE_DISCONNECTED_STATE, this._teamConnectionState = f.VOICE_DISCONNECTED_STATE, this._updatingTeamCheckbox = !1, this._teamVoicePluginEnabled = !1, this._teamVoiceAvailability = !1;
                ...
                _setupHeader() {
                    if (this.hide(this._selectors.headerClash), this.hide(this._selectors.headerDefault), this._headerType === x.HEADER_CLASH && this._clashRoster) this.addImg(this._clashRoster.logoUrl, this._selectors.headerClashLogo), this.addInnerHtml(this._clashRoster.shortName, this._selectors.headerClashShortName), this.addInnerHtml(this._clashRoster.name, this._selectors.headerClashName), this.show(this._selectors.headerClash);
                        ...
                        const e = this._teamVoicePluginEnabled ? "parties_comm_panel_header_text" : "parties_comm_panel_header_text_party_only";
                ...
                teamVoicePluginEnabledUpdate(e) {
                    this._teamVoicePluginEnabled = e, this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()
                }
                ...
                _refreshConnectionState() {
                    ...
                    e ? this._updateConnectionState(f.VOICE_CONNECTED_STATE) : this._updateConnectionState(f.VOICE_DISCONNECTED_STATE), t !== this._connectionState && (this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()), this._checkAvailabilityMessaging()
                }
                settingsUpdated(e) {
                ...
                postgameStatsUpdated(e) {
                    if (e && e.multiUserChatId) {
                        const t = A.default.parseChatId(e.multiUserChatId);
                ...
                _chatParticipantsObserver(e) {
                    if (v.default.removeObservers(w), this._conversations && e) {
                        const t = this._conversations.find((t => t.id.indexOf(e) > -1));
                        t && (v.default.createObserver(w, `/v1/conversations/${encodeURIComponent(t.id)}/participants`), v.default.observe(w, this.chatParticipantsUpdated.bind(this)))
                    }
                }
                _chatParticipant(e) {
                    let t = null;
                ...
                _updateConnectionState(e) {
                    ...
                    if (t !== e) {
                        ...
                        n && (n.checked = e === f.VOICE_CONNECTED_STATE, n.disabled = e === f.VOICE_CONNECTING_STATE);
                        const r = this._getTranslatedString(this._connectionState),
                            i = this._teamVoicePluginEnabled ? this._selectors.connectionStatus : this._selectors.connectionState;
                        this.removeClass(t, i), this.addClass(this._connectionState, i), this.addInnerHtml(r, i)
                    }
                }
                _updateTeamHeaderVisibility() {
                    this._teamVoicePluginEnabled && this._connectionState === f.VOICE_CONNECTED_STATE ? this.removeClass("hide", this._selectors.teamHeader) : this.addClass("hide", this._selectors.teamHeader)
                }
                ...
                _updateTeamConnectionState(e) {
                    if (this._teamConnectionState !== e) {
                        ...
                        t && (this._updatingTeamCheckbox = !0, t.checked = e === f.VOICE_CONNECTED_STATE, t.disabled = e === f.VOICE_CONNECTING_STATE || !this._teamVoiceAvailability, this._updatingTeamCheckbox = !1)
                    }
                }
                _updateTeamCheckboxState() {
                    const e = this.shadowRoot.querySelector(this._selectors.teamCheckbox);
                    if (e) {
                        const t = this._teamConnectionState === f.VOICE_CONNECTED_STATE,
                            n = this._teamConnectionState === f.VOICE_CONNECTING_STATE;
                        e.disabled = !t && (n || !this._teamVoiceAvailability)
                    }
                }
                _refreshTeamConnectionState() {
                    this._teamSession && Object.keys(this._teamSession).length > 0 ? this._updateTeamConnectionState(f.VOICE_CONNECTED_STATE) : this._updateTeamConnectionState(f.VOICE_DISCONNECTED_STATE)
                }
                _isVoiceEligible() {
                ...
                _connectionCheckboxChange(e) {
                    const t = e.target,
                        n = t.checked;
                    return n && this._connectionState === f.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(f.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, d.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e), t.checked = !1
                    }))) : n || this._connectionState !== f.VOICE_CONNECTED_STATE ? void 0 : d.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this))
                }
                _teamCheckboxChange(e) {
                    if (!this._teamVoicePluginEnabled || this._updatingTeamCheckbox) return;
                    const t = e.target,
                        n = t.checked;
                    return n && this._teamConnectionState === f.VOICE_DISCONNECTED_STATE ? (this._updateTeamConnectionState(f.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, h.default.connect().then(this._joinTeamVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinTeamVoiceSessionFailed(e), t.checked = !1
                    }))) : n || this._teamConnectionState !== f.VOICE_CONNECTED_STATE ? void 0 : h.default.disconnect().then(this._leaveTeamVoiceSessionSuccess.bind(this))
                }
                _leaveVoiceSessionSuccess() {
                    this._updateConnectionState(f.VOICE_DISCONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility(), this._playLeaveSound()
                }
                _joinVoiceSessionSuccess() {
                    this._updateConnectionState(f.VOICE_CONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility(), this._playJoinSound(), clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                ...
                _initDataBinding() {
                    this.lobbyDataListener = this.lobbyUpdated.bind(this), g.default.observe("lobby", this.lobbyDataListener), g.default.lobby().then(this.lobbyDataListener), this.clashChatListener = this.clashRostersUpdated.bind(this), b.default.observe("rosters", this.clashChatListener), b.default.clashRosters().then(this.clashChatListener), this.gameflowSessionListener = this.gameflowSessionUpdated.bind(this), m.default.observe("session", this.gameflowSessionListener), m.default.session().then(this.gameflowSessionListener), this.postgameStatsListener = this.postgameStatsUpdated.bind(this), A.default.observe("stats", this.postgameStatsListener), A.default.stats().then(this.postgameStatsListener), this.availabilityDataListener = this.availabilityUpdated.bind(this), d.default.observe("availability", this.availabilityDataListener), d.default.availability().then(this.availabilityDataListener), this.participantsDataListener = this.participantsUpdated.bind(this), d.default.observe("participants", this.participantsDataListener), d.default.participants().then(this.participantsDataListener), this.settingsDataListener = this.settingsUpdated.bind(this), d.default.observe("settings", this.settingsDataListener), d.default.settings().then(this.settingsDataListener), this.sessionDataListener = this.sessionUpdated.bind(this), _.default.observe("session", this.sessionDataListener), _.default.session().then(this.sessionDataListener), this.currentPlayerChatInfoListener = this.currentPlayerChatInfoUpdated.bind(this), v.default.observe("me", this.currentPlayerChatInfoListener), v.default.me().then(this.currentPlayerChatInfoListener), this.conversationsListener = this.conversationsUpdated.bind(this), v.default.observe("conversations", this.conversationsListener), v.default.conversations().then(this.conversationsListener), this.teamVoicePluginEnabledListener = this.teamVoicePluginEnabledUpdate.bind(this), u.default.observe("teamVoicePluginEnabled", this.teamVoicePluginEnabledListener), u.default.teamVoicePluginEnabled().then(this.teamVoicePluginEnabledListener), this.teamVoiceAvailabilityListener = this.teamVoiceAvailabilityUpdated.bind(this), h.default.observe("availability", this.teamVoiceAvailabilityListener), h.default.availability().then(this.teamVoiceAvailabilityListener), this.teamVoiceSessionListener = this.teamVoiceSessionUpdated.bind(this), h.default.observe("session", this.teamVoiceSessionListener), h.default.session().then(this.teamVoiceSessionListener)
                }
            ...
            T.tagName = "lol-parties-comm-panel";
            var $ = T;
            t.default = $
        }, (e, t, n) => {
            "use strict";
            ...
            class g extends r.default {
                ...
                constructor() {
                    super(), this._lastSliderUpdate = 0, this._teamVoicePluginEnabled = !1, this._isDraggingSlider = !1;
