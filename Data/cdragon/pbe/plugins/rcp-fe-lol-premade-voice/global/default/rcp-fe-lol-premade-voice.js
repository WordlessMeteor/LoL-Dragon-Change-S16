(() => {
    var e = [function(e, t, n) {
            ...
            const D = "chatParticipantsKey",
                I = "HONOR_LEVEL_TOO_LOW",
                V = "PLUGIN_DISABLED",
                M = "QUEUE_NOT_ENABLED",
                N = "NOT_IN_ACTIVE_GAME_PHASE",
                z = "VOICE_COMPLIANCE_AGREEMENT_NOT_ACCEPTED",
                L = "parties_comm_panel_team_voice_status_unavailable",
                j = {
                    [V]: "parties_comm_panel_team_voice_status_disabled",
                    [M]: L,
                    [N]: L,
                    [I]: "parties_comm_panel_team_voice_status_restricted",
            ...
            class U extends r.default {
                ...
                _refreshConnectionState() {
                    ...
                    e ? this._updateConnectionState(k.VOICE_CONNECTED_STATE) : this._connectionState !== k.VOICE_CONNECTING_STATE && this._updateConnectionState(k.VOICE_DISCONNECTED_STATE), t !== this._connectionState && (this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()), this._checkAvailabilityMessaging()
                }
                settingsUpdated(e) {
                ...
                _updateKeyBindIndicators() {
                    ...
                    if (e) {
                        const t = this._settings.inputMode === w.INPUT_MODE_PUSH_TO_TALK,
                ...
                lobbyUpdated(e) {
                    const t = e || {};
                    t.multiUserChatId && t.multiUserChatId !== this._multiUserChatId && (this._conversations && this._chatParticipantsObserver(t.multiUserChatId), this._headerType = $.HEADER_LOBBY), this._multiUserChatId = t.multiUserChatId;
                    const n = t && t.members || [];
                    this._partyMemberPuuids = new Set(n.map((e => e.puuid)).filter(Boolean)), this._updateTeamParticipants()
                }
                clashRostersUpdated(e) {
                    const t = (e || []).find((e => e.tournamentState !== B.CLASH_ROSTER_STATE.IDLE));
                    t && t.multiUserChatId && (t.multiUserChatId !== this._multiUserChatId && (this._conversations && this._chatParticipantsObserver(t.multiUserChatId), this._headerType = $.HEADER_CLASH, this._clashRoster = t), this._multiUserChatId = t.multiUserChatId)
                }
                ...
                _chatParticipantsObserver(e) {
                    if (f.default.removeObservers(D), this._conversations && e) {
                        const t = this._conversations.find((t => t.id.indexOf(e) > -1));
                        t && (f.default.createObserver(D, `/v1/conversations/${encodeURIComponent(t.id)}/participants`), f.default.observe(D, this.chatParticipantsUpdated.bind(this)))
                    }
                }
                _chatParticipant(e) {
                    let t = null;
                ...
                _updateTeamToggleState() {
                    ...
                    if (this._setTeamToggleMuteRestricted(e), !e && this._teamVoiceAvailabilityReason === I) return void this._setTeamToggleRestricted(!0);
                    this._setTeamToggleRestricted(!1);
                    const t = this._teamConnectionState === k.VOICE_CONNECTED_STATE,
                        n = this._teamConnectionState === k.VOICE_CONNECTING_STATE,
                ...
                _refreshTeamConnectionState() {
                    this._teamParticipants && this._teamParticipants.length > 0 ? this._updateTeamConnectionState(k.VOICE_CONNECTED_STATE) : this._updateTeamConnectionState(k.VOICE_DISCONNECTED_STATE)
                }
                _isVoiceEligible() {
                ...
                _connectionClick() {
                    return this._lockConnectionButton(), this._connectionState === k.VOICE_DISCONNECTED_STATE && this._isVoiceEligible() ? (this._updateConnectionState(k.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, m.default.connect().then((() => {
                        this._joinVoiceSessionSuccess(), this._unlockConnectionButton()
                    })).catch((e => {
                        this._joinVoiceSessionFailed(e), this._unlockConnectionButton()
                    }))) : this._connectionState === k.VOICE_CONNECTED_STATE ? m.default.disconnect().then((() => {
                ...
                _connectionMouseEnter() {
                    if (this._connectionState === k.VOICE_DISCONNECTED_STATE && this._isVoiceEligible()) {
                ...
                _connectionBarClick() {
                    if (!this._teamVoicePluginEnabled) return this._connectionState === k.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(k.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, m.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e)
                    }))) : this._connectionState === k.VOICE_CONNECTED_STATE ? m.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this)) : void 0
                }
                _connectionToggleClick() {
                    return this._connectionState === k.VOICE_DISCONNECTED_STATE ? (this._updateConnectionState(k.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, m.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e)
                    }))) : this._connectionState === k.VOICE_CONNECTED_STATE ? m.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this)) : void 0
                }
                _partyToggleClick() {
                    ...
                    return e && e.classList.contains("restricted") ? void 0 : this._connectionState === k.VOICE_DISCONNECTED_STATE ? (this._channelToggleOnSound.play(), this._updateConnectionState(k.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, m.default.connect().then(this._joinVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinVoiceSessionFailed(e)
                    }))) : this._connectionState === k.VOICE_CONNECTED_STATE ? (this._channelToggleOffSound.play(), m.default.disconnect().then(this._leaveVoiceSessionSuccess.bind(this))) : void 0
                }
                _teamToggleClick() {
                    ...
                    return e && e.classList.contains("restricted") ? void 0 : this._teamConnectionState === k.VOICE_DISCONNECTED_STATE ? (this._channelToggleOnSound.play(), this._teamVoiceConnectionFailed = !1, this._updateTeamConnectionState(k.VOICE_CONNECTING_STATE), this._lockOutMemberJoinSound = !0, u.default.connect().then(this._joinTeamVoiceSessionSuccess.bind(this)).catch((e => {
                        this._joinTeamVoiceSessionFailed(e)
                    }))) : this._teamConnectionState === k.VOICE_CONNECTED_STATE ? (this._channelToggleOffSound.play(), u.default.disconnect().then(this._leaveTeamVoiceSessionSuccess.bind(this))) : void 0
                }
                _leaveVoiceSessionSuccess() {
                    this._updateConnectionState(k.VOICE_DISCONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()
                }
                _joinVoiceSessionSuccess() {
                    this._updateConnectionState(k.VOICE_CONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility(), clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                ...
                _joinVoiceSessionFailed(e) {
                    if (e && e.data) {
                        ...
                        i.logger.warning(`Failed to join voice channel: ${t}`), this._updateConnectionState(k.VOICE_DISCONNECTED_STATE), this._updateTeamHeaderVisibility(), this._updateConnectionBarVisibility()
                    }
                }
                _leaveTeamVoiceSessionSuccess() {
                    this._teamVoiceConnectionFailed = !1, this._updateTeamConnectionState(k.VOICE_DISCONNECTED_STATE)
                }
                _joinTeamVoiceSessionSuccess() {
                    this._teamVoiceConnectionFailed = !1, this._updateTeamConnectionState(k.VOICE_CONNECTED_STATE), clearTimeout(this._memberJoinTimeout), this._memberJoinTimeout = setTimeout((() => {
                        this._lockOutMemberJoinSound = !1
                ...
                _joinTeamVoiceSessionFailed(e) {
                    if (e && e.data) {
                        this._lockOutMemberJoinSound = !1;
                        const t = e.data.message;
                        i.logger.warning(`Failed to join team voice channel: ${t}`), this._teamVoiceConnectionFailed = !0, this._updateTeamConnectionState(k.VOICE_DISCONNECTED_STATE)
                    }
                }
                ...
                _updateCurrentPlayerMuteButton() {
                    ...
                    const e = !this._teamVoicePluginEnabled && this._settings.inputMode === w.INPUT_MODE_PUSH_TO_TALK;
                ...
                _toggleMute() {
                    this._settings && (this._teamVoicePluginEnabled || this._settings.inputMode !== w.INPUT_MODE_PUSH_TO_TALK) && m.default.checkMicrophonePermissions().then((e => {
                ...
                _settingsClicked() {
                    this._isGameClientRunning || (this._playSound("/fe/lol-navigation/sfx-soc-ui-click-generic.ogg"), (0, w.default)())
                }
                ...
                _attachMuteSelfTooltip() {
                    ...
                    let t;
                    t = this._teamVoicePluginEnabled || this._settings.inputMode !== w.INPUT_MODE_PUSH_TO_TALK ? this._settings.localMicMuted ? i.tra.get("parties_comm_panel_tooltip_unmute_self") : i.tra.get("parties_comm_panel_tooltip_mute_self") : i.tra.get("parties_comm_panel_tooltip_mute_disabled"), S.default.attachSmallTooltip(e, t)
                }
                ...
                _updateToggleState(e, t) {
                    ...
                    n && (n.classList.remove(k.VOICE_CONNECTED_STATE, k.VOICE_DISCONNECTED_STATE, k.VOICE_CONNECTING_STATE, "disabled", "restricted", "disabled-disconnected"), n.classList.add(t))
                }
            ...
            U.tagName = "lol-parties-comm-panel";
            var F = U;
            t.default = F
        }, (e, t, n) => {
            "use strict";
