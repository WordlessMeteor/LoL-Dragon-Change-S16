(() => {
    var e = [, e => {
            ...
            var v = {
                ...
                ALL_RANKED_AND_RATED_QUEUE_TYPES: [..._, ...y]
            };
            t.default = v
        }, (e, t) => {
            "use strict";
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                Object.assign(e, {
                    ...
                    JadeScoreboardHeaderComponent: wn,
            ...
            var r = s.Ember.Service.extend({
                ...
                willDestroy() {
                    this._super(...arguments), s.db.unobserve(o, this), s.db.unobserve(l, this)
                },
