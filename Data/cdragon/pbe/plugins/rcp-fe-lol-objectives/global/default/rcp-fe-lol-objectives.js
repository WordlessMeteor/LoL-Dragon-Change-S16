(() => {
    var e = [, e => {
            ...
            t.OBJECTIVES_GAME_TAB_ASSETS_STATES = n;
            t.APPLICATION_ROUTE_NAME = {
                TFT: "rcp-fe-lol-tft",
                LOL_EVENT_HUB: "rcp-fe-lol-event-hub"
            };
            t.getObjectiveGameTab = e => Object.values(a).includes(e) ? e : a.LEAGUE_TAB;
            const o = {
                COMPLETED: "COMPLETED",
                PENDING: "PENDING",
                UPCOMING: "UPCOMING",
            ...
            const r = new Set(["BLUE_ESSENCE", "ORANGE_ESSENCE"]);
            t.CURRENCY_REWARD_TYPES = r;
            ...
            t.MISSION_EXPRESSION_TYPE = c;
            const d = {
                [c.AND]: " and ",
                [c.OR]: " or ",
                [c.OF]: " of "
            };
            t.MISSION_EXPRESSION_TYPE_SEARCH_SAFE = d;
            const m = {
                AND: c.AND,
                OR: c.OR
            };
            ...
            t.TFT_PASS_TYPE = p;
            const u = {
                [p.BATTLE_PASS]: "battle-pass",
                [p.EVENT_PASS]: "event-page",
                [p.UNKNOWN]: "battle-pass"
            };
            t.TFT_PASS_TYPE_TO_ROUTE = u;
            ...
            e.exports = a.Ember.Component.extend({
                ...
                bottomRewards: a.Ember.computed("rewards.[]", "isLOL", "lolEventHubType", (function() {
                    ...
                    return e.map((e => {
                        ...
                        let l;
                        return e.rewardType === n.REWARD_TYPE.BXP && (t ? (l = e.rewardType.toLowerCase(), s === o.LolEventHubType.HALL_OF_LEGENDS && (l = `${l}-hol`)) : l = n.REWARD_TYPE.DEFAULT), {
            ...
            e.exports = n.Ember.Component.extend({
                ...
                _inferEventHubTypeFromLocations: e => e.includes(o.EVENT_HUB_TYPE_OVERRIDE_LOCATION.BACKGROUND_GOLD) && e.includes(o.EVENT_HUB_TYPE_OVERRIDE_LOCATION.TEXT_LEVEL) ? i.LolEventHubType.HALL_OF_LEGENDS : null,
                click(e) {
                    const t = e?.target;
            ...
            const l = new class {
                ...
                show(e) {
                    this._componentState.isVisible = !0, this._navigate(e)
                }
                hide() {
                    this._componentState && (this._componentState.isVisible = !1), this._applicationInstance && this._applicationInstance.destroy(), a.LayerManager.removeLayer(this._applicationRootElement), this._application = null, this._applicationRootElement = null, this._applicationInstance = null
                }
                _navigate(e = {}) {
                    const t = e.gameTab ?? "",
                        s = e.group ?? "",
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                    ...
                    ErrorStateComponent: m.default,
                    MilestoneTooltipComponent: Y,
                    MasterySetCarouselComponent: X,
                    ...
                    LeagueSeasonPassComponent: h.default,
                    GenericObjectivesHeaderComponent: v.default,
                    ...
                    tra: a.traService,
                    PipNotificationsService: R.default,
                    UserExperienceService: B.default,
                    GamephaseService: H.default,
                    SeasonPassService: G.default,
                    GameDataService: V.default,
                    EqHelper: U.default,
                    TEMPLATES: {
                        ...
                        "components/generic-objectives-header": N.default,
                        "components/objectives-tooltip-requirements": L.default,
                        "components/objectives-tooltip-requirement-icon": D.default
                    }
                };
            ...
            t.default = a.Ember.Service.extend({
                ...
                isGracePeriod: !1,
                init() {
                    this._eventHubDB = (0, a.dataBinding)("/lol-event-hub", a.socket)
                },
