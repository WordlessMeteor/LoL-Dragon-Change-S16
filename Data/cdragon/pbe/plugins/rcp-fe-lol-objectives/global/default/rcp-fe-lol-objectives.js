    ...
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                    ...
                    MilestoneTooltipComponent: z,
                    MasterySetCarouselComponent: W,
                    ...
                    LeagueNpeComponent: f.default,
                    LeagueSeasonPassComponent: _.default,
                    LeagueMayhemCustomHubComponent: b.default,
                    GenericObjectivesHeaderComponent: E.default,
                    ObjectivesTooltipRequirementsComponent: T.default,
                    ObjectivesTooltipRequirementIconComponent: x.default,
                    ApplicationController: S.default,
                    tra: a.traService,
                    PipNotificationsService: V.default,
                    UserExperienceService: F.default,
                    GamephaseService: Y.default,
                    SeasonPassService: U.default,
                    GameDataService: X.default,
                    ...
                    EqHelper: q.default,
                    TEMPLATES: {
                        application: j.default,
                        "components/objectives-game-tabs": P.default,
                        "components/objectives-sub-nav-v2": I.default,
                        "components/objectives-main-v2": O.default,
                        "components/objectives-card-v2": A.default,
                        "components/objectives-progress-radial": y.default,
                        "components/objectives-reward-tooltip": w.default,
                        "components/error-state": C.default,
                        "components/header-types-base": k.default,
                        "components/league-hol": M.default,
                        "components/league-npe": N.default,
                        "components/league-season-pass": D.default,
                        "components/league-mayhem-custom-hub": L.default,
                        "components/league-demacia": R.default,
                        "components/generic-objectives-header": G.default,
                        "components/objectives-tooltip-requirements": B.default,
                        "components/objectives-tooltip-requirement-icon": H.default
                    }
                };
            ...
            t.default = n.Ember.Component.extend({
                ...
                isLeagueMayhemCustomHub: n.Ember.computed.equal("seasonPassData.seasonPassSubType", "MayhemCustomHub"),
            ...
            const a = s(1);
            t.default = a.Ember.Component.extend({
                classNames: ["league-mayhem-custom-hub"],
                classNameBindings: ["isOpeningPassAllowed:pass-link-enabled"],
                init() {
                    this._super(...arguments), this.onMouseEnter = this.onMouseEnter.bind(this), this.onClicked = this.onClicked.bind(this)
                },
                isOpeningPassAllowed: a.Ember.computed("gamePhaseService.isOpeningPassAllowed", "isLoading", (function() {
                    return this.get("gamePhaseService.isOpeningPassAllowed") && !this.get("isLoading")
                })),
                backgroundImage: a.Ember.computed("seasonPass", "seasonPassData", (function() {
                    const e = this.get("seasonPass"),
                        t = this.get("seasonPassData");
                    return e?.objectiveBannerImage || t?.overrideBackgroundImage
                })),
                currentLevel: a.Ember.computed.alias("seasonPass.trackProgress.currentLevel"),
                currentRank: a.Ember.computed("currentLevel", "tra", (function() {
                    const e = this.get("currentLevel"),
                        t = e >= 0 && e <= 5 ? e : 0;
                    return this.get("tra").get(`kiwi_s3_progression_rank${t}_title`)
                })),
                onMouseEnter: function() {
                    this.get("isOpeningPassAllowed") && this.element.dispatchEvent(new CustomEvent("pass-hover", {
                        bubbles: !0
                    }))
                },
                onClicked: function() {
                    this.get("isOpeningPassAllowed") && this.element.dispatchEvent(new CustomEvent("pass-clicked", {
                        bubbles: !0
                    }))
                },
                actions: {
            ...
            e.exports = a.HTMLBars.template({
                id: "LBlDFQX/",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-objectives\\\\src\\\\app\\\\templates\\\\components\\\\header-types\\\\header-types-base.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["isLoading"]]],null,14,13]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      "],["append",["helper",["generic-objectives-header"],null,[["seasonPassData","isLoading","gameType","objectiveCategoryType","gamePhaseService"],[["get",["seasonPassData"]],["get",["isLoading"]],["get",["gameType"]],["get",["objectiveCategoryType"]],["get",["gamePhaseService"]]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["append",["helper",["league-npe"],null,[["seasonPassData","seasonPass"],[["get",["seasonPassData"]],["get",["seasonPass"]]]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isNPE"]]],null,1,0],["text","  "]],"locals":[]},{"statements":[["text","    "],["append",["helper",["generic-objectives-header"],null,[["seasonPassData","gameType","gamePhaseService","isLoading","objectiveCategoryType","openPass"],[["get",["seasonPassData"]],["get",["gameType"]],["get",["gamePhaseService"]],["get",["isLoading"]],["get",["objectiveCategoryType"]],"openPass"]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isTftPass"]]],null,3,2]],"locals":[]},{"statements":[["text","      "],["append",["helper",["league-season-pass"],null,[["seasonPassData","gamePhaseService","isLoading","seasonPass","openPass"],[["get",["seasonPassData"]],["get",["gamePhaseService"]],["get",["isLoading"]],["get",["seasonPass"]],"openPass"]]],false],["text","\\n    "]],"locals":[]},{"statements":[["block",["if"],[["get",["isLeagueSeasonPass"]]],null,5]],"locals":[]},{"statements":[["text","      "],["append",["helper",["league-mayhem-custom-hub"],null,[["seasonPassData","gamePhaseService","isLoading","seasonPass","openPass"],[["get",["seasonPassData"]],["get",["gamePhaseService"]],["get",["isLoading"]],["get",["seasonPass"]],"openPass"]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isLeagueMayhemCustomHub"]]],null,7,6]],"locals":[]},{"statements":[["text","      "],["append",["helper",["league-hol"],null,[["seasonPassData","gamePhaseService","isLoading","seasonPass","openPass"],[["get",["seasonPassData"]],["get",["gamePhaseService"]],["get",["isLoading"]],["get",["seasonPass"]],"openPass"]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isLeagueHOL"]]],null,9,8]],"locals":[]},{"statements":[["text","      "],["append",["helper",["league-demacia"],null,[["seasonPassData","gamePhaseService","isLoading","seasonPass","openPass"],[["get",["seasonPassData"]],["get",["gamePhaseService"]],["get",["isLoading"]],["get",["seasonPass"]],"openPass"]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isLeagueDemacia"]]],null,11,10],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isLeaguePass"]]],null,12,4]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","objectives-season-pass-wrapper__loading-container"],["flush-element"],["text","\\n    "],["append",["helper",["uikit-spinner"],null,[["width","height"],["30px","30px"]]],false],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, s) => {
            const a = s(1).Ember;
            ...
            e.exports = a.HTMLBars.template({
                id: "T5n6Vh1T",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-objectives\\\\src\\\\app\\\\templates\\\\components\\\\header-types\\\\league-mayhem-custom-hub.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__container"],["dynamic-attr","onmouseenter",["unknown",["onMouseEnter"]],null],["dynamic-attr","onclick",["unknown",["onClicked"]],null],["modifier",["action"],[["get",[null]],"openPass"]],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__image-container"],["flush-element"],["text","\\n    "],["open-element","img",[]],["static-attr","class","league-mayhem-custom-hub__main-image"],["dynamic-attr","src",["unknown",["backgroundImage"]],null],["static-attr","alt",""],["flush-element"],["close-element"],["text","\\n  "],["close-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__text-container"],["flush-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__title"],["flush-element"],["append",["unknown",["tra","objectives_mayhem_title"]],false],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__text-hover-wrapper"],["flush-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__text-hover-wrapper_view"],["flush-element"],["text","\\n        "],["open-element","div",[]],["flush-element"],["append",["unknown",["tra","mayhem_custom_hub_view_studio"]],false],["close-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__text-hover-wrapper_view-icon"],["flush-element"],["close-element"],["text","\\n      "],["close-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","league-mayhem-custom-hub__text-hover-wrapper_rank"],["flush-element"],["append",["unknown",["currentRank"]],false],["close-element"],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, s) => {
            const a = s(1).Ember;
            ...
            t.default = a.Ember.Service.extend({
                ...
                _velocityData: null,
                init() {
                    this._super(...arguments), this._eventHubDB = (0, a.dataBinding)("/lol-event-hub", a.socket), this._shoppefrontDB = a.dataBinding.bindTo(a.socket), this._eventHubDB.observe("/v1/events", this, (e => {
                        this.set("_events", e || []);
                        const t = this.get("currentSeasonPassData");
                        t && this.set("currentSeasonPassData", {
                            ...t,
                            seasonPassSubType: this._getSeasonPassSubType(t.passId)
                        })
                    })), this._shoppefrontDB.get("/lol-shoppefront/v1/velocity").then((e => {
                ...
                willDestroy() {
                    this._eventHubDB.unobserve("/v1/events", this), this._super(...arguments)
                },
                _getSeasonPassSubType(e) {
                    const t = (this.get("_events") || []).find((t => t.eventId === e));
                    return t?.eventInfo?.seasonPassSubType
                },
                fetchSeasonPassData(e) {
                    if (e) {
                        const {
                            ...
                            tftPassType: l,
                            objectiveCategoryFilter: r,
                            seasonPassSubType: this._getSeasonPassSubType(t),
                            isLoading: !0
                        };
