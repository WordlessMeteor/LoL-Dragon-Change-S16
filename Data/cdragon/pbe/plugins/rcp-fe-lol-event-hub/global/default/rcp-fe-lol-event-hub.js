(() => {
    var e = [, e => {
            ...
            t.default = class {
                constructor() {
                    this.screenRoot = this.getScreenRoot(), this.application = null, this.eventHubDataBinding = (0, s.dataBinding)(l.EVENT_HUB_API, s.socket), this.binding = r, this.navRequestCounter = 0
                }
                getTargetDOMNode(e) {
                ...
                show(e) {
                    ...
                    return (e = e || {}).targetDivId || (t.push(this.screenRootReleasePromise), t.push(this.screenRoot.bump())), Promise.all(t).then((() => {
                        ...
                        this.getTargetDOMNode(e?.targetDivId).appendChild(this.application.domNode), e.showRewardTrackPage = !0, this.navRequestCounter += 1, s.externalModel.setProperties({
                            navOptions: e,
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                        ...
                        SeasonPassRoute: u.default,
                        ActivityCenterMilestonesRoute: d.default,
                        EmbeddedPluginRoute: p.default,
                        EventHubService: m.default,
                        LolMissionsService: h.default,
                        PatchlineService: v.default,
                        PlayerSettingsService: g.default,
                        RewardsService: f.default,
                        RewardItemEnhancerService: b.default,
                        RegionInfoService: E.default,
                        tra: s.traService,
                        EventHubSubNavComponent: C.default,
                        HelpModalComponent: _.default,
                        PageHeaderComponent: x.default,
                        PageHeaderSystemControlsComponent: T.default,
                        PurchaseBundlesModalComponent: y.default,
                        PurchaseLevelsModalComponent: k.default,
                        RewardDetailsComponent: S.default,
                        ClaimButtonComponent: w.default,
                        ProgressIndicatorComponent: P.default,
                        LobbyButtonComponent: R.default,
                        EmbeddedPluginHostComponent: I.default,
                        EventShopCardMultiPurchaseModalComponent: O.default,
                        EventShopCategoryNavBarComponent: L.default,
                        ...
                        EventShopTokenShopComponent: F.default,
                        EventShopXpComponent: Y.default,
                        ObjectiveCardWrapperComponent: A.default,
                        ...
                        HolLevelIconFlamesComponent: G.default,
                        HolNarrativeComponent: K.default,
                        HolPromotionBannerComponent: W.default,
                        SeasonPassTrackComponent: X.default,
                        SeasonPassOverviewComponent: Q.default,
                        SeasonPassChapterCardComponent: $.default,
                        ResetTimerComponent: ze,
                        FlatButtonCounterComponent: qe,
                        ...
                        ApplicationController: Z.default,
                        IndexController: J.default,
                        EventShopController: ee.default,
                        HallOfLegendsController: te.default,
                        SeasonPassController: ne.default,
                        ActivityCenterMilestonesController: se.default,
                        EmbeddedPluginController: ae.default,
                        EqHelper: le.default,
                        InventoryTypeNameHelper: oe.default,
                        SafeImagePathHelper: re.default,
                        TEMPLATES: {
                            application: ie.default,
                            index: ce.default,
                            [a.ROUTES.EVENT_SHOP]: ue.default,
                            [a.ROUTES.HALL_OF_LEGENDS]: de.default,
                            [a.ROUTES.SEASON_PASS]: pe.default,
                            [a.ROUTES.ACTIVITY_CENTER_MILESTONES]: me.default,
                            [a.ROUTES.EMBEDDED_PLUGIN]: he.default,
                            "components/event-hub-sub-nav": ye.default,
                            "components/help-modal": ve.default,
                            "components/page-header-system-controls": ge.default,
                            "components/page-header": fe.default,
                            "components/purchase-bundles-modal": be.default,
                            "components/purchase-levels-modal": Ee.default,
                            "components/reward-details": _e.default,
                            "components/claim-button": xe.default,
                            "components/progress-indicator": Te.default,
                            "components/lobby-button": ke.default,
                            "components/embedded-plugin-host": Se.default,
                            "components/objective-card-wrapper": we.default,
                            "components/event-shop-card-multi-purchase-modal": Pe.default,
                            "components/event-shop-category-nav-bar-tab": Ce.default,
                            "components/event-shop-category-nav-bar": Re.default,
                            "components/event-shop-category-offers": Ie.default,
                            "components/event-shop-fallback": Ae.default,
                            "components/event-shop-main-view": Oe.default,
                            ...
                            "components/season-pass-overview": Ge.default,
                            "components/season-pass-track": Ke.default
                        }
                    },
                    t = {
                        ComponentFactory: s.ComponentFactory,
                        MemoryBookComponent: q.default,
                        MemoryItemComponent: z.default,
                        PlayerSettingsService: g.default,
                        tra: s.traService,
                        TEMPLATES: {
                            "components/memory-book": je.default,
                            "componenets/memory-item": Fe.default
                        }
                    };
                s.emberApplicationFactory.setFactoryDefinition("MemoryBookComponent", t), s.emberApplicationFactory.setFactoryDefinition(Xe, e, {
                    EMBER_CLI_COMPAT: !0
                })
            };
            var s = n(1),
            ...
            const {
                FlatButtonCounterComponent: qe,
                ResetTimerComponent: ze
            } = s.SharedComponents, Xe = "rcp-fe-lol-event-hub";
            t.APP_NAME = Xe
        }, (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            const b = [...d, ...m, {
                ...
                E = "event-shop-offer-card";
            t.EVENT_SHOP_OFFER_CARD_CONTAINER_CLASSNAME = E;
            const _ = {
                [r.EVENT_SHOP]: {
            ...
            var x = {
                ...
                REWARD_TRACK_ITEM_STATE: u,
                EVENT_SHOP_OFFER_CARD_CONTAINER_CLASSNAME: E,
                ROUTES: o,
                EVENT_HUB_TYPES: r
            };
            t.default = x;
            ...
            var r = l.Ember.Service.extend({
                isSubmenuEnabled: !1,
                init() {
                    this._super(...arguments), this.eventHubDataBinding = (0, l.dataBinding)(s.EVENT_HUB_API, l.socket), this.clientConfigBinding = (0, l.dataBinding)("/lol-client-config", l.socket), this.eventSpecificObservers = [], this.getEvents(), this.observeSubmenuConfig(), this.observeNavigationButtonData()
                },
            ...
            const l = {
                ...
                i = s.dataBinding.bindTo((0, s.getProvider)().getSocket());
            var c = s.Ember.Component.extend({
                init() {
                ...
                options: s.Ember.computed("bundles", (function() {
                    ...
                    const t = l[e.length] || {},
                        ...
                        i = e.map(((e, t) => {
                            e.bundledItems.forEach((e => {
                                ...
                                const t = e.tags || [],
                                    n = e.inventoryType;
                                o.includes(n) ? e.mapAvailability = null : t.includes("jade_exclusive") ? e.mapAvailability = s.tra.get("cat_paw_jade_exclusive_flavor_text") : t.includes("jade_compatible") || r ? e.mapAvailability = null : e.mapAvailability = s.tra.get("cat_paw_jade_not_available_on_classic_flavor_text")
                            }));
                            return {
                    ...
                    let c;
                    const u = this.get("selectedOption");
                    if (1 === i.length) c = i[0];
                    else if (null !== u) c = i.find((e => u.details.itemId === e.details.itemId));
                    else if (3 === i.length) {
                        c = [...i].reverse().find((e => !e.isOwned))
                    } else c = i.find((e => !e.isOwned));
                    return c && (this.set("selectedOption", c), s.Ember.set(c, "selectedCssClass", "eh-purchase-bundles-modal-option-selected")), i
                })),
                ...
                async enrichBundles(e) {
                    const t = this.get("isJadeStore"),
                        n = [];
                    for (const a of e)
                        for (const e of a.bundledItems) {
                            e.displayName = e.name, e.quantity > 1 && (e.displayName = s.tra.formatString("event_hub_purchase_modal_summary_item_name_quantity", {
                                name: e.name,
                                quantity: e.quantity
                            }));
                            const a = e.inventoryType,
                                l = e.itemId;
                            if (o.includes(a)) {
                                s.Ember.set(e, "mapAvailability", null), s.Ember.set(e, "tags", []);
                                continue
                            }
                            const r = i.get(`/lol-store/v1/catalog/${a}/${l}/tags`).then((n => {
                                s.Ember.set(e, "tags", n || []), n && n.includes("jade_exclusive") ? s.Ember.set(e, "mapAvailability", s.tra.get("cat_paw_jade_exclusive_flavor_text")) : n && n.includes("jade_compatible") || t ? s.Ember.set(e, "mapAvailability", null) : s.Ember.set(e, "mapAvailability", s.tra.get("cat_paw_jade_not_available_on_classic_flavor_text"))
                            })).catch((() => {
                                s.Ember.set(e, "tags", []), t ? s.Ember.set(e, "mapAvailability", null) : s.Ember.set(e, "mapAvailability", s.tra.get("cat_paw_jade_not_available_on_classic_flavor_text"))
                            }));
                            n.push(r)
                        }
            ...
            var a = s.Ember.Component.extend({
                ...
                eventHubService: s.Ember.inject.service("event-hub"),
                navEvents: s.Ember.computed.alias("eventHubService.sortedNavEvents"),
                activeEventId: s.Ember.computed.alias("eventHubService.activeEventId"),
                isEnabled: s.Ember.computed("navEvents.[]", (function() {
                    return (this.get("navEvents") || []).length > 0
                })),
                selectedIndex: s.Ember.computed("navEvents.[]", "activeEventId", (function() {
                ...
                _highlightSelectedIndexObserver: s.Ember.observer("selectedIndex", (function() {
                    s.Ember.run.scheduleOnce("afterRender", this, this._highlightActiveEvent)
                })),
            ...
            const l = "rcp-fe-lol-kiwi-hub";
            var o = s.Ember.Component.extend({
                classNames: ["event-hub-embedded-plugin"],
                _eventIdDidChange: s.Ember.observer("eventId", (function() {
                    this.element && this._mountPlugin()
                })),
                didInsertElement() {
                    this._super(...arguments), this._mountPlugin()
                },
                willDestroyElement() {
                    this._unmountPlugin(), this._super(...arguments)
                },
                _mountPlugin() {
                    this._unmountPlugin();
                    ...
                    let t;
                    try {
                        t = s.default.getProvider().getOptional(l)
                    } catch (t) {
                        return void this._handleLoadError(t, e)
                    }
                    Promise.resolve(t).then((t => {
                        if (this._isCurrentLoad(e)) {
                            if (!t || "function" != typeof t.show || "function" != typeof t.hide) throw new Error("Plugin does not implement show() and hide()");
                            return this._mountedPlugin = t, t.show({
                                targetDivId: this.elementId
                            })
                        }
                    })).catch((t => this._handleLoadError(t, e)))
                },
                _unmountPlugin() {
                    if (this._loadGeneration = (this._loadGeneration || 0) + 1, this._mountedPlugin) {
                        try {
                            this._mountedPlugin.hide()
                        } catch (e) {
                            s.logger.error("Failed to hide embedded Event Hub plugin", l, e)
                        }
                        this._mountedPlugin = null
                    }
                },
                _isCurrentLoad(e) {
                    return !this.isDestroying && !this.isDestroyed && e === this._loadGeneration
                },
                _handleLoadError(e, t) {
                    this._isCurrentLoad(t) && (s.logger.error("Failed to load embedded Event Hub plugin", l, e), this.sendAction("onLoadError"))
                }
            });
            t.default = o
        }, (e, t, n) => {
            ...
            t.__esModule = !0, t.registerDefaultHelpers = function(e) {
                a.default(e), l.default(e), o.default(e), r.default(e), i.default(e), c.default(e), u.default(e)
            };
            var a = s(n(49)),
                l = s(n(50)),
                o = s(n(51)),
            ...
            t.default = function(e) {
                e.registerHelper("each", (function(e, t) {
                    ...
                    if (t.data && t.ids && (c = a.appendContextPath(t.data.contextPath, t.ids[0]) + "."), a.isFunction(e) && (e = e.call(this)), t.data && (i = a.createFrame(t.data)), e && "object" == typeof e)
                        if (a.isArray(e))
                            for (var d = e.length; l < d; l++) l in e && u(l, l, l === e.length - 1);
                        else {
                            var p = void 0;
                            for (var m in e) e.hasOwnProperty(m) && (void 0 !== p && u(p, l - 1), p = m, l++);
                            void 0 !== p && u(p, l - 1, !0)
            ...
            t.__esModule = !0, t.checkRevision = function(e) {
                ...
                var n = {
                    ...
                    invokePartial: function(n, s, l) {
                        ...
                        if (null == r && t.compile && (l.partials[l.name] = t.compile(n, e.compilerOptions, t), r = l.partials[l.name](s, l)), null != r) {
                            if (l.indent) {
                                for (var i = r.split("\n"), c = 0, u = i.length; c < u && (i[c] || c + 1 !== u); c++) i[c] = l.indent + i[c];
                                r = i.join("\n")
                            }
                            return r
                        }
                ...
                function s(t) {
                    ...
                    return e.useDepths && (o = a.depths ? t != a.depths[0] ? [t].concat(a.depths) : a.depths : [t]), (c = u(e.main, c, n, a.depths || [], l, i))(t, a)
                }
            ...
            function i(e, t, n, s, a, l, o) {
                ...
                return (r = u(n, r, e, o, s, l)).program = t, r.depth = o ? o.length : 0, r.blockParams = a || 0, r
            }
            ...
            var _ = {
                ...
                ALL_RANKED_AND_RATED_QUEUE_TYPES: [...b, ...E]
            };
            t.default = _
        }, (e, t) => {
            "use strict";
            ...
            var d = {
                ...
                LOWEST_DIVISION: i[0],
                LP_PER_DIVISION: 100,
                TIER_NAME_TO_ORDINAL: u(a),
                DIVISION_TO_ORDINAL: u(i),
            ...
            var s = n(1),
                ...
                o = s.Ember.Controller.extend({
                    ...
                    navRequestId: s.Ember.computed.alias("model.navRequestId"),
                    ...
                    availableEvents: s.Ember.computed("eventHubService.events.[]", (function() {
                        return (this.get("eventHubService.events") || []).map((({
                            ...
                            route: (0, a.getRouteByEventInfo)(t)
                        })))
                    })),
                    init() {
                    ...
                    handleAvailableEventsChanged() {
                        ...
                        const s = this.get("eventHubService.activeEventId"),
                            a = e.find((e => e.eventId === s));
                        if (a) return void this.send("selectEvent", a, n);
                    ...
                    applyPendingNavRequest(e, t) {
                        ...
                        const a = e.find((e => e.eventId === n));
                        return !(!a && 0 === e.length) && (this.set("handledNavRequestId", t), a ? (this.send("selectEvent", a, !0), !1) : (s.logger.error("Event hub was asked to navigate to an unknown event", n), !0))
                    },
                    getDefaultEvent(e) {
            ...
            var s = n(1),
                ...
                l = s.Ember.Controller.extend({
                    ...
                    actions: {
                        fallbackToBuiltIn() {
                            this.transitionToRoute(a.ROUTES.SEASON_PASS)
                        }
                    }
                });
            t.default = l
            ...
            e.exports = s.HTMLBars.template({
                id: "43GdmRY2",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\templates\\\\embedded-plugin.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["helper",["embedded-plugin-host"],null,[["eventId","onLoadError"],[["get",["eventHubService","activeEventId"]],"fallbackToBuiltIn"]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
            ...
            e.exports = s.HTMLBars.template({
                id: "h5FO3PLS",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\templates\\\\components\\\\embedded-plugin-host.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\components\\\\embedded-plugin-host.js\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const s = n(1).Ember;
