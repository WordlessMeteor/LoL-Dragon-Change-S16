(() => {
    var e = [, e => {
            ...
            t.default = class {
                constructor() {
                    this.screenRoot = this.getScreenRoot(), this.application = null, this.eventHubDataBinding = (0, a.dataBinding)(l.EVENT_HUB_API, a.socket), this.binding = r, this.navRequestCounter = 0
                }
                getTargetDOMNode(e) {
                ...
                show(e) {
                    ...
                    return (e = e || {}).targetDivId || (t.push(this.screenRootReleasePromise), t.push(this.screenRoot.bump())), Promise.all(t).then((() => {
                        ...
                        this.getTargetDOMNode(e?.targetDivId).appendChild(this.application.domNode), e.showRewardTrackPage = !0, this.navRequestCounter += 1, a.externalModel.setProperties({
                            navOptions: e,
                            navRequestId: this.navRequestCounter,
                            isVisible: !0
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const e = {
                        ...
                        ActivityCenterMilestonesRoute: u.default,
                        ...
                        tra: a.traService,
                        EventHubSubNavComponent: w.default,
                        ...
                        LobbyButtonComponent: P.default,
                        EventShopCardMultiPurchaseModalComponent: R.default,
                        EventShopCategoryNavBarComponent: A.default,
                        EventShopCategoryNavBarTabComponent: L.default,
                        EventShopCategoryOffersComponent: M.default,
                        EventShopFallbackComponent: N.default,
                        EventShopMainViewComponent: O.default,
                        EventShopOfferCardComponent: D.default,
                        EventShopProgressionComponent: B.default,
                        EventShopRewardTrackWrapperComponent: H.default,
                        EventShopTokenBalanceAmountComponent: V.default,
                        EventShopTokenShopComponent: U.default,
                        EventShopXpComponent: j.default,
                        ObjectiveCardWrapperComponent: I.default,
                        ...
                        HolLevelIconFlamesComponent: F.default,
                        HolNarrativeComponent: Y.default,
                        HolPromotionBannerComponent: G.default,
                        SeasonPassTrackComponent: q.default,
                        SeasonPassOverviewComponent: z.default,
                        SeasonPassChapterCardComponent: X.default,
                        ResetTimerComponent: Ye,
                        FlatButtonCounterComponent: Fe,
                        ...
                        EventShopController: Z.default,
                        HallOfLegendsController: J.default,
                        SeasonPassController: ee.default,
                        ActivityCenterMilestonesController: te.default,
                        EqHelper: ne.default,
                        InventoryTypeNameHelper: ae.default,
                        SafeImagePathHelper: se.default,
                        TEMPLATES: {
                            application: le.default,
                            index: oe.default,
                            [s.ROUTES.EVENT_SHOP]: re.default,
                            [s.ROUTES.HALL_OF_LEGENDS]: ie.default,
                            [s.ROUTES.SEASON_PASS]: ce.default,
                            [s.ROUTES.ACTIVITY_CENTER_MILESTONES]: de.default,
                            "components/event-hub-sub-nav": be.default,
                            "components/help-modal": ue.default,
                            "components/page-header-system-controls": pe.default,
                            "components/page-header": me.default,
                            "components/purchase-bundles-modal": he.default,
                            "components/purchase-levels-modal": ve.default,
                            "components/reward-details": ge.default,
                            "components/claim-button": fe.default,
                            "components/progress-indicator": _e.default,
                            "components/lobby-button": Ee.default,
                            "components/objective-card-wrapper": xe.default,
                            "components/event-shop-card-multi-purchase-modal": Te.default,
                            "components/event-shop-category-nav-bar-tab": ye.default,
                            "components/event-shop-category-nav-bar": ke.default,
                            "components/event-shop-category-offers": Se.default,
                            "components/event-shop-fallback": Ce.default,
                            "components/event-shop-main-view": we.default,
                            "components/event-shop-offer-card": Pe.default,
                            "components/event-shop-progression": Ie.default,
                            "components/event-shop-reward-track-wrapper": Re.default,
                            "components/event-shop-token-shop": Ae.default,
                            "components/event-shop-xp": Le.default,
                            "components/hol-level-icon-flames": Me.default,
                            "components/hol-narrative": Ne.default,
                            "components/hol-promotion-banner": Oe.default,
                            "components/season-pass-chapter-card": He.default,
                            "components/season-pass-overview": Ve.default,
                            "components/season-pass-track": Ue.default
                        }
                    },
                    t = {
                        ComponentFactory: a.ComponentFactory,
                        MemoryBookComponent: K.default,
                        MemoryItemComponent: W.default,
                        PlayerSettingsService: v.default,
                        tra: a.traService,
                        TEMPLATES: {
                            "components/memory-book": De.default,
                            "componenets/memory-item": Be.default
                        }
                    };
                a.emberApplicationFactory.setFactoryDefinition("MemoryBookComponent", t), a.emberApplicationFactory.setFactoryDefinition(Ge, e, {
                    EMBER_CLI_COMPAT: !0
                })
            };
            var a = n(1),
            ...
            const {
                FlatButtonCounterComponent: Fe,
                ResetTimerComponent: Ye
            } = a.SharedComponents, Ge = "rcp-fe-lol-event-hub";
            t.APP_NAME = Ge
        }, (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            const o = e => {
                const t = e?.eventInfo?.startDate,
                    n = t ? new Date(t).getTime() : NaN;
                return Number.isNaN(n) ? 0 : n
            };
            var r = l.Ember.Service.extend({
                isSubmenuEnabled: !1,
                init() {
                    this._super(...arguments), this.eventHubDataBinding = (0, l.dataBinding)(a.EVENT_HUB_API, l.socket), this.clientConfigBinding = (0, l.dataBinding)("/lol-client-config", l.socket), this.eventSpecificObservers = [], this.getEvents(), this.observeSubmenuConfig(), this.observeNavigationButtonData()
                },
                observeSubmenuConfig() {
                    this.clientConfigBinding.observe("/v3/client-config/lol.client_settings.event_hub.submenu", this, (e => {
                        this.set("isSubmenuEnabled", !0 === e?.enabled)
                    }))
                },
                observeNavigationButtonData() {
                    this.eventHubDataBinding.observe("/navigation-button-data", this, (e => {
                        this.isDestroying || this.isDestroyed || this.set("navigationButtonData", Array.isArray(e) ? e : [])
                    }))
                },
                getEvents() {
                ...
                eventsById: l.Ember.computed("events.[]", (function() {
                    return (this.get("events") || []).reduce(((e, t) => (t?.eventId && (e[t.eventId] = t), e)), {})
                })),
                sortedNavEvents: l.Ember.computed("navigationButtonData.[]", "isSubmenuEnabled", "eventsById", (function() {
                    if (!this.get("isSubmenuEnabled")) return [];
                    ...
                    return e.slice().sort(((e, n) => o(t[n.activeEventId]) - o(t[e.activeEventId]))).map((e => {
                        ...
                        return {
                            ...
                            route: (0, s.getRouteByEventHubType)(e.eventType),
                            showPip: e.showPip || !1,
                ...
                setActiveEvent(e) {
                    ...
                    if (!t || t !== e) {
                        ...
                        const t = (this.get("events") || []).find((({
                            eventId: t
                        }) => t === e));
                        if (!t) return l.logger.error("Attempted to activate unknown event hub event", e), void this.setProperties({
                            activeEventId: null,
                            activeEventType: null,
                            activeSeasonPassSubType: null
                        });
                        const n = t?.eventInfo?.eventType,
                ...
                observeEventSpecificData() {
                    ...
                    const t = a.EVENT_CONFIGS_BY_TYPE[e]?.observers || [];
                    for (const {
                            propertyName: e,
                            propertyPath: n,
                            defaultValue: a
                        ...
                        this.eventSpecificObservers.push({
                            ...
                            this.isDestroying || this.isDestroyed || (null == t && (t = a), this.setProperties({
                                [e]: t
                            }))
                        }))
                    }
                ...
                checkPassFullyUpgraded(e = void 0) {
                    ...
                    this.set("passFullyUpgraded", a)
                },
                async getPassBundles() {
                    return this.set("passLoading", !0), await this.eventHubDataBinding.get(this.getEventSpecificPropertyPath(a.PASS_BUNDLES_PATH), {
                        skipCache: !0
                    }).then((e => (this.set("bundles", e), e))).catch((e => {
                        throw l.logger.error("Failure loading pass bundles: ", e), this.set("bundles", null), new Error("")
                    })).finally((() => {
            ...
            const l = {
                ...
                o = ["EMOTE", "WARD_SKIN", "SUMMONER_ICON", "REGALIA_BANNER", "TRANSFER", "EVENT_PASS", "CURRENCY"],
                r = "/lol-client-config/v3/client-config/lol.client_settings.purchase_widget.discount_disabled",
                i = a.dataBinding.bindTo((0, a.getProvider)().getSocket());
            var c = a.Ember.Component.extend({
                init() {
                    this._super(...arguments), i.observe(r, this, (function(e) {
                ...
                displayBundleOptions: a.Ember.computed("eventHubService.passLoading", "options", (function() {
                    return !this.get("eventHubService.passLoading") && this.get("options").length
                })),
                displaySelectedOption: a.Ember.computed("displayBundleOptions", "selectedOption", (function() {
                ...
                options: a.Ember.computed("bundles", (function() {
                    ...
                    const t = l[e.length] || {},
                        ...
                        i = e.map(((e, t) => {
                            e.bundledItems.forEach((e => {
                                ...
                                const t = e.tags || [],
                                    n = e.inventoryType;
                                o.includes(n) ? e.mapAvailability = null : t.includes("jade_exclusive") ? e.mapAvailability = a.tra.get("cat_paw_jade_exclusive_flavor_text") : t.includes("jade_compatible") || r ? e.mapAvailability = null : e.mapAvailability = a.tra.get("cat_paw_jade_not_available_on_classic_flavor_text")
                            }));
                            return {
                    ...
                    let c;
                    const d = this.get("selectedOption");
                    if (1 === i.length) c = i[0];
                    else if (null !== d) c = i.find((e => d.details.itemId === e.details.itemId));
                    else if (3 === i.length) {
                        c = [...i].reverse().find((e => !e.isOwned))
                    } else c = i.find((e => !e.isOwned));
                    return c && (this.set("selectedOption", c), a.Ember.set(c, "selectedCssClass", "eh-purchase-bundles-modal-option-selected")), i
                })),
                ...
                async enrichBundles(e) {
                    const t = this.get("isJadeStore"),
                        n = [];
                    for (const s of e)
                        for (const e of s.bundledItems) {
                            e.displayName = e.name, e.quantity > 1 && (e.displayName = a.tra.formatString("event_hub_purchase_modal_summary_item_name_quantity", {
                                name: e.name,
                                quantity: e.quantity
                            }));
                            const s = e.inventoryType,
                                l = e.itemId;
                            if (o.includes(s)) {
                                a.Ember.set(e, "mapAvailability", null), a.Ember.set(e, "tags", []);
                                continue
                            }
                            const r = i.get(`/lol-store/v1/catalog/${s}/${l}/tags`).then((n => {
                                a.Ember.set(e, "tags", n || []), n && n.includes("jade_exclusive") ? a.Ember.set(e, "mapAvailability", a.tra.get("cat_paw_jade_exclusive_flavor_text")) : n && n.includes("jade_compatible") || t ? a.Ember.set(e, "mapAvailability", null) : a.Ember.set(e, "mapAvailability", a.tra.get("cat_paw_jade_not_available_on_classic_flavor_text"))
                            })).catch((() => {
                                a.Ember.set(e, "tags", []), t ? a.Ember.set(e, "mapAvailability", null) : a.Ember.set(e, "mapAvailability", a.tra.get("cat_paw_jade_not_available_on_classic_flavor_text"))
                            }));
                            n.push(r)
                        }
                    await Promise.all(n), this.set("bundles", [...e])
                },
                closeModal() {
                    this.setProperties({
                        showPurchaseModal: !1,
            ...
            var r = a.Ember.Component.extend(l, {
                ...
                initializePurchaseProgressModal() {
                    this.fetchProgressionPurchaseData(), a.Telemetry.sendCustomData(s.TELEMETRY.TABLE, {
            ...
            var l = a.Ember.Component.extend({
                ...
                passCompleteTra: a.Ember.computed("isSeasonPass", "traPrefix", "eventHubService.activeEventType", "eventHubService.activeSeasonPassSubType", (function() {
                    return this.get("isSeasonPass") && this.get("eventHubService.activeSeasonPassSubType") !== s.SEASON_PASS_SUB_TYPES.DEFAULT ? this.get(`tra.${this.get("traPrefix")}_event_hub_pass_complete`) : this.get("tra.event_hub_pass_complete")
                })),
            ...
            var s = a.Ember.Component.extend({
                classNames: ["rcp-fe-lol-event-hub-sub-nav"],
                eventHubService: a.Ember.inject.service("event-hub"),
                navEvents: a.Ember.computed.alias("eventHubService.sortedNavEvents"),
                activeEventId: a.Ember.computed.alias("eventHubService.activeEventId"),
                isEnabled: a.Ember.computed("navEvents.[]", (function() {
                    return (this.get("navEvents") || []).length > 0
                })),
                selectedIndex: a.Ember.computed("navEvents.[]", "activeEventId", (function() {
                    const e = this.get("navEvents") || [],
                        t = this.get("activeEventId");
                    return e.findIndex((e => e.eventId === t))
                })),
                didRender() {
                    this._super(...arguments), this._highlightActiveEvent()
                },
                _highlightSelectedIndexObserver: a.Ember.observer("selectedIndex", (function() {
                    a.Ember.run.scheduleOnce("afterRender", this, this._highlightActiveEvent)
                })),
                _highlightActiveEvent() {
                    if (this.isDestroyed || this.isDestroying || !this.element) return;
                    const e = this.element.querySelector("lol-uikit-navigation-bar.event-hub-sub-nav-container"),
                        t = this.get("selectedIndex");
                    e && t >= 0 && e.setAttribute("selectedindex", t)
                },
                actions: {
                    selectEvent(e) {
                        e && e.eventId !== this.get("activeEventId") && this.sendAction("onSelectEvent", e)
                    }
                }
            });
            t.default = s
            ...
            var p = u();
            p.create = u, d.default(p), p.default = p, t.default = p, e.exports = t.default
        }, (e, t, n) => {
            "use strict";
            ...
            t.default = function(e) {
                e.registerHelper("each", (function(e, t) {
                    ...
                    if (t.data && t.ids && (c = s.appendContextPath(t.data.contextPath, t.ids[0]) + "."), s.isFunction(e) && (e = e.call(this)), t.data && (i = s.createFrame(t.data)), e && "object" == typeof e)
                        if (s.isArray(e))
                            for (var u = e.length; l < u; l++) l in e && d(l, l, l === e.length - 1);
                        else {
                            var p = void 0;
                            for (var m in e) e.hasOwnProperty(m) && (void 0 !== p && d(p, l - 1), p = m, l++);
                            void 0 !== p && d(p, l - 1, !0)
            ...
            const n = "UNRANKED",
                ...
                l = "LEGEND",
                o = a[a.length - 1],
                r = [o, "MASTER", "GRANDMASTER", "CHALLENGER"],
                i = ["IV", "III", "II", "I"],
            ...
            var u = {
                ...
                LOWEST_DIVISION: i[0],
                LP_PER_DIVISION: 100,
                TIER_NAME_TO_ORDINAL: d(s),
                DIVISION_TO_ORDINAL: d(i),
            ...
            var l = a.Ember.Controller.extend({
                ...
                actions: {
                    selectEvent(e) {
                        e && e.eventId && this.get("eventHubService.activeEventId") !== e.eventId && (this.get("eventHubService").setActiveEvent(e.eventId), e.route && this.transitionToRoute(e.route))
                    }
                }
            });
            t.default = l
            ...
            var a = n(1),
                ...
                o = a.Ember.Controller.extend({
                    ...
                    navRequestId: a.Ember.computed.alias("model.navRequestId"),
                    handledNavRequestId: null,
                    ...
                    init() {
                        this._super(...arguments), this.handleAvailableEventsChanged = this.handleAvailableEventsChanged.bind(this), this.handleIsVisibleChanged = this.handleIsVisibleChanged.bind(this), this.addObserver("isVisible", this, this.handleIsVisibleChanged), this.addObserver("availableEvents", this.handleAvailableEventsChanged), this.addObserver("navRequestId", this.handleAvailableEventsChanged)
                    },
                    willDestroyElement() {
                        this.removeObserver("isVisible"), this.removeObserver("availableEvents"), this.removeObserver("navRequestId")
                    },
                    handleIsVisibleChanged() {
                        this.transitionToRoute(l.ROUTES.INDEX), this.set("handledNavRequestId", null), this.handleAvailableEventsChanged()
                    },
                    handleAvailableEventsChanged() {
                        ...
                        const e = this.get("availableEvents") || [],
                            t = this.get("navRequestId"),
                            n = t !== this.get("handledNavRequestId");
                        if (n && !this.applyPendingNavRequest(e, t)) return;
                        const a = this.get("eventHubService.activeEventId"),
                            s = e.find((e => e.eventId === a));
                        if (s) return void this.send("selectEvent", s, n);
                        const l = this.getDefaultEvent(e);
                        l && this.send("selectEvent", l, n)
                    },
                    applyPendingNavRequest(e, t) {
                        const n = this.get("navOptionsEventId");
                        if (!n) return this.set("handledNavRequestId", t), !0;
                        const s = e.find((e => e.eventId === n));
                        return !(!s && 0 === e.length) && (this.set("handledNavRequestId", t), s ? (this.send("selectEvent", s, !0), !1) : (a.logger.error("Event hub was asked to navigate to an unknown event", n), !0))
                    },
                    getDefaultEvent(e) {
                        if (this.get("eventHubService.isSubmenuEnabled")) {
                            const e = this.get("eventHubService.sortedNavEvents") || [];
                    ...
                    actions: {
                        selectEvent(e, t = !1) {
                            ...
                            const n = this.get("eventHubService.activeEventId") === e.eventId;
                            n && !t || (n || this.get("eventHubService").setActiveEvent(e.eventId), e.route && this.transitionToRoute(e.route))
                        }
                    }
                });
            t.default = o
            ...
            var i = a.Ember.Controller.extend({
                ...
                passBundles: a.Ember.computed.alias("eventHubService.bundles"),
                passPurchased: a.Ember.computed.alias("eventHubService.info.isPassPurchased"),
                passAvailable: a.Ember.computed.alias("eventHubService.passAvailable"),
                passLoading: a.Ember.computed.alias("eventHubService.passLoading"),
            ...
            var i = a.Ember.Controller.extend(r, {
                ...
                passBundles: a.Ember.computed.alias("eventHubService.bundles"),
                shouldDisplayPurchasePassButton: a.Ember.computed("passBundles", (function() {
                ...
                mandatoryDataLoaded: a.Ember.computed("chapters", "currentLevel", "chapterInView", "passLoading", "passAvailable", (function() {
            ...
            e.exports = a.HTMLBars.template({
                id: "MFV0ubZC",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["block",["if"],[["get",["isVisible"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","rcp-fe-lol-event-hub-application"],["dynamic-attr","style",["unknown",["backgroundImageStyle"]],null],["flush-element"],["text","\\n    "],["append",["helper",["event-hub-sub-nav"],null,[["onSelectEvent"],["selectEvent"]]],false],["text","\\n    "],["append",["unknown",["outlet"]],false],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const a = n(1).Ember;
            ...
            e.exports = a.HTMLBars.template({
                id: "wsxYlSEK",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\templates\\\\components\\\\event-hub-sub-nav.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\styles\\\\components\\\\event-hub-sub-nav.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-event-hub\\\\src\\\\app\\\\components\\\\event-hub-sub-nav.js\\" "],["text","\\n"],["block",["if"],[["get",["isEnabled"]]],null,4]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","          "],["open-element","span",[]],["static-attr","class","event-hub-sub-nav-pip"],["flush-element"],["close-element"],["text","\\n        "]],"locals":[]},{"statements":[["block",["if"],[["get",["event","showPip"]]],null,0]],"locals":[]},{"statements":[["text","          "],["open-element","span",[]],["static-attr","class","event-hub-sub-nav-count-badge"],["flush-element"],["text","\\n            "],["open-element","hextech-ui-badge",[]],["static-attr","background-color","yellow"],["static-attr","glow","yellow"],["static-attr","radius-style","square"],["static-attr","size","small"],["static-attr","font-size","large"],["flush-element"],["text","\\n              "],["open-element","span",[]],["flush-element"],["append",["unknown",["event","cappedUnclaimedRewardCount"]],false],["close-element"],["text","\\n            "],["close-element"],["text","\\n          "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["open-element","lol-uikit-navigation-item",[]],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"selectEvent",["get",["event"]]],null],null],["flush-element"],["text","\\n        "],["append",["unknown",["event","eventName"]],false],["text","\\n"],["block",["if"],[["get",["event","unclaimedRewardCount"]]],null,2,1],["text","      "],["close-element"],["text","\\n"]],"locals":["event"]},{"statements":[["text","  "],["open-element","lol-uikit-navigation-bar",[]],["static-attr","type","nav-bar-secondary"],["static-attr","class","event-hub-sub-nav-container"],["flush-element"],["text","\\n"],["block",["each"],[["get",["navEvents"]]],null,3],["text","  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const a = n(1).Ember;
    ...
    n.g = function() {
        ...
        s.addEventListener(l, (function(e) {
            (0, e.registrationHandler)((e => t.default.init(e, {
                ...
                const n = e.get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-shared-components/trans-digital-goods-disclaimer.json").overlay("/fe/lol-loot/trans.json").overlay("/fe/lol-paw/trans.json").overlay("/fe/lol-event-hub/trans.json").overlay("/fe/lol-objectives/trans.json"),
