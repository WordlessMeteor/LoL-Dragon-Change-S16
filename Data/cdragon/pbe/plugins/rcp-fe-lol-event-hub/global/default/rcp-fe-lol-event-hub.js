            ...
            var i = s.Ember.Component.extend({
                ...
                updateTrackWithRewardsInReview(e) {
                    const t = this.getLastOfArray(e) + 1,
                        n = t % 8 == 0;
                    if (t > 48) {
                        const e = this.getRewardTrack(!0).map((e => e.threshold)),
                            t = this.getLastOfArray(e) + 1;
                        this.updateSelectedLevel(e, t)
