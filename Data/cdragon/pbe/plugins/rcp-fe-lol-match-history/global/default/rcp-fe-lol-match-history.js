(() => {
    var e = [, e => {
            ...
            const {
                ...
                observer: h,
                computed: g
            } = n.Ember, f = "CHEATER_TERMINATED", y = "DISRUPTIVE_BEHAVIOR_TERMINATED", _ = "REMAKE", E = "EARLY_SURRENDER_LEAVER", T = "EARLY_SURRENDER_ACCOMPLICE", b = "VICTORY";
            e.exports = d.extend(s.FixDataBindingMixin, l.default, {
                ...
                calculateMatchResult: function(e) {
                    ...
                    return i ? y : "Abort_AntiCheatExit" === r ? f : a && !s && !l ? _ : a && o && s ? E : a && l ? T : t ? b : "DEFEAT"
                },
                calculateTitleClass: function(e) {
                    const t = "defeat",
                        a = "terminated";
                    return e === f || e === y ? a : e === _ ? "earlySurrender" : e === E || e === T ? t : e === b ? "victory" : t
                },
                calculateMatchResultTitle: function(e) {
                    return e === f || e === y ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_CHEATER_TERMINATED") : e === _ ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE") : e === E ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE_LEAVER") : e === T ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_REMAKE_RESTRICTED") : e === b ? this.get("tra.MATCH_HISTORY_MATCH_RESULT_VICTORY") : this.get("tra.MATCH_HISTORY_MATCH_RESULT_DEFEAT")
                },
            ...
            e.exports = n.HTMLBars.template({
                id: "yUwp+eKy",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["helper",["component"],[["get",["model","componentName"]]],[["model"],[["get",["model"]]]]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, e => {
            "use strict";
            ...
            e.exports = class {
                constructor(e, t) {
                    s.logger.trace("Creating Match Details Ember application"), h || function(e, t) {
                        r = s.Viewport.overlay().getScreenRoot("rcp-fe-lol-match-details-overlay"), d = r.getElement(), u = document.createElement("lol-uikit-full-page-modal"), u.className = "rcp-fe-lol-match-details-overlay-content", d.appendChild(u), u.addEventListener("closeButtonClick", f), u.addEventListener("closeMatchDetailModalOnly", y);
                        const n = {
                        ...
                        Object.assign(n, {
                            ...
                            JadeGraphCategoriesComponent: _,
            ...
            var T = {
                ...
                RANKED_AND_RATED_TFT_QUEUE_TYPES: y,
                ALL_RANKED_QUEUE_TYPES: _,
                ALL_RATED_QUEUE_TYPES: E,
                ALL_RANKED_AND_RATED_QUEUE_TYPES: [..._, ...E]
            };
            t.default = T
        }, (e, t) => {
            "use strict";
            ...
            e.exports = n.Ember.Component.extend({
                ...
                replayButton: null,
                isLocalPlayerInMatch: n.Ember.computed("gameData.participants.[]", "localPuuid", (function() {
                    const e = this.get("gameData.participants") || [],
                        t = this.get("localPuuid");
                    return !(0 === e.length || !t) && e.some((e => o(e) === t))
                })),
                isFriendInMatch: n.Ember.computed("gameData.participants.[]", "friends.[]", (function() {
                    const e = this.get("gameData.participants") || [],
                        t = this.get("friends") || [];
                    if (0 === e.length || 0 === t.length) return !1;
                    const a = new Set(t.map((e => e.puuid)).filter(Boolean));
                    return e.some((e => a.has(o(e))))
                })),
                isReplayRestricted: n.Ember.computed("isLocalPlayerInMatch", (function() {
                    if (!n.Replays.isReplaysRestrictionEnabled()) return !1;
                    return !this.get("isLocalPlayerInMatch")
                })),
                shouldShowReplayButton: n.Ember.computed("gameData", "isThirdPersonView", "whitelistedQueueIds", "isReplayRestricted", (function() {
                    const e = this.get("gameData");
                    return !(!e || !n.Replays.isGeneralReplaysEnabled()) && (!this.get("isReplayRestricted") && (!(this.get("isThirdPersonView") && !this.get("whitelistedQueueIds").includes(e.queueId)) || (n.logger.trace("Queue id for this game is not whitelisted, not adding replay button"), !1)))
                })),
            ...
            function p(e, t, a) {
                ...
                return n.Lodash.each(e, (e => {
                    ...
                    y[l.default.TEAM_BLUE_ID] = g.teamGolds[l.default.TEAM_BLUE_ID], y[l.default.TEAM_RED_ID] = g.teamGolds[l.default.TEAM_RED_ID], o.push({
            ...
            const o = a(92),
                ...
                r = n.Ember.Component.extend({
                    ...
                    draw: function(e, t) {
                        ...
                        u.append("svg:g").attr("class", "match-details-timeline-axis-y").attr("transform", _(r.margin.left, r.margin.top)).call(r.axis.y).selectAll("g").filter((e => 0 === e)).classed("zero-line", !0), u.append("svg:g").attr("class", "match-details-timeline-axis-x").attr("transform", _(r.margin.left, r.innerH + r.margin.top)).call(r.axis.x);
                        const h = u.append("svg:g").attr("transform", _(r.margin.left, r.margin.top)).attr("class", "match-details-timeline-chart-interact");
            ...
            function m(e) {
                ...
                const p = n.d3.svg.area().interpolate("linear").x((e => a.scale.x(e.x))).y0(a.scale.y(0)).y1((e => a.scale.y(e.y))),
                    ...
                    u = g(c),
                    y = t.append("svg:g");
                y.selectAll("path").data(u).enter().append("path").attr("class", (e => "data-area data-fill-" + e.teamId)).attr("d", (e => d(e.data))), y.selectAll("path").data(u).transition().delay(200).duration(430).ease("cubic-out").attr("d", (e => p(e.data)));
                const _ = t.append("svg:g");
                _.selectAll(".timeline-data-point").data(s).enter().append("circle").attr("class", (e => e.gold > 0 ? "timeline-data-point data-fill-100" : e.gold < 0 ? "timeline-data-point data-fill-200" : "timeline-data-point data-fill-even")).attr("cx", (e => a.scale.x(e.timestamp))).attr("cy", a.scale.y(0)).attr("r", (() => a.pointRarius)).attr("tooltip", (e => f(e, l, o, e.gold > 0 ? i : r))), _.selectAll(".timeline-data-point").data(s).transition().delay(200).duration(430).ease("cubic-out").attr("cy", (e => a.scale.y(e.gold)))
            }
            ...
            e.exports = n.HTMLBars.template({
                id: "+JuBIHQn",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\overview\\\\match-details-timeline-chart-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\overview\\\\match-details-timeline-chart-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-match-history\\\\src\\\\components\\\\overview\\\\match-details-timeline-chart-component\\\\index.js\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, a) => {
            "use strict";
            ...
            e.exports = n.Ember.Component.extend({
                ...
                renderInitialGraph: function() {
                    ...
                    const h = n.d3.scale.ordinal().rangeBands([0, u], .4),
                        ...
                        _ = n.d3.select(".match-graph-display .match-main-graph").append("svg").attr("width", m + c + i).attr("height", p + a + r),
                        E = _.append("g").attr("transform", "translate(" + c + "," + a + ")");
                    d.domain([0, 0]), h.domain(e.map((function(e) {
                        return e.graphYAxisIndex
                    }))), this._appendAxis(f, y, E, p), this._initialAvatarsRender(e, _, h), this.set("x", d), this.set("y0", h), this.set("y1", g), this.set("xAxis", f), this.set("yAxis", y), this.set("svg", E)
                },
