(() => {
    var e = [function(e, t, n) {
            ...
            var l = n(1),
                a = l.Ember.Route.extend({
                    ...
                    model() {
                        const e = this.get("persistenceService"),
                            t = [];
                        return t.push(e.getDefaultSettingPromise("account", "lol-chat")), t.push(l.db.get("/lol-platform-config/v1/namespaces/LcuSocial")), t.push(l.db.get("/lol-client-config/v3/client-config/lol.client_settings.discordIntegration.enabled")), t.push(l.db.get("/lol-chat/v1/is-discord-link-available")), Promise.all(t).then((e => ({
                            chatSettings: e[0],
                            socialToggles: e[1],
                            discordIntegrationEnabled: e[2],
                            isDiscordLinkAvailable: e[3]
                        })))
                    },
                    setupController(e, t) {
                        this._super(e, t), l.db.observe("/lol-chat/v1/is-discord-linked", this, (t => {
                            e.handleDiscordLinkedChange(t)
                        }))
                    },
                    deactivate() {
                        this._super(...arguments), l.db.unobserve("/lol-chat/v1/is-discord-linked", this)
                    }
                });
            t.default = a
        }, (e, t, n) => {
            ...
            var i = a.Ember.Controller.extend(s.default, {
                ...
                isDiscordLinkAvailable: a.Ember.computed.alias("model.isDiscordLinkAvailable"),
                isDiscordLinked: !1,
                ...
                handleDiscordLinkedChange(e) {
                    const t = this.get("isDiscordLinked"),
                        n = Boolean(e);
                    !t && n && this.get("isDiscordLinkAvailable") && this.set("showCongratsPopup", !0), this.set("isDiscordLinked", n)
                },
            ...
            var h = a.Ember.Controller.extend(s.default, {
                ...
                teamVoiceEnabled: a.Ember.computed.alias("voiceService.teamVoiceEnabled"),
                ...
                inputVolumeLabel: a.Ember.computed(m.property, (function() {
                    const e = Number.isInteger(this.get(m.property)) ? this.get(m.property) : m.defaultValue;
                    return this.get("tra.formatString")("voice_settings_input_gain", {
                        inputVolume: e
                    })
                })),
                inputModes: a.Ember.computed(p.property, (function() {
                    return [{
                        name: u,
                ...
                isInputModeVoice: a.Ember.computed(p.property, (function() {
                    return this.get(p.property) === u
                })),
                isInputModePushToTalk: a.Ember.computed(p.property, (function() {
                    return this.get(p.property) === d
                })),
                inputModeVoiceSensitivityLabel: a.Ember.computed(_.property, (function() {
                ...
                init() {
                    this._super(...arguments), this.bindSetting(o), this.bindSetting(i), this.bindSetting(r), this.bindSetting(c), this.bindSetting(m), this.bindSetting(p), this.bindSetting(_), this.bindSetting(g), this.bindSetting(E)
                },
                willDestroy() {
                    this._super(...arguments)
                },
                resetToDefault: function() {
                    this.changeSetting(o.property, o.defaultValue), this.changeSetting(i.property, i.defaultValue), this.changeSetting(r.property, r.defaultValue), this.changeSetting(c.property, c.defaultValue), this.changeSetting(m.property, m.defaultValue), this.changeSetting(p.property, p.defaultValue), this.changeSetting(_.property, _.defaultValue), this.changeSetting(g.property, g.defaultValue), this.changeSetting(E.property, E.defaultValue)
                },
                _showPTTPermissionsModal() {
                    this.changeSetting(p.property, u);
                ...
                actions: {
                    ...
                    selectInputMode: function(e) {
                        this.changeSetting(p.property, e), e === d && this.get("voiceService").isPushToTalkAvailable(!0).then((e => {
            ...
            const a = "/lol-premade-voice",
                ...
                o = "/lol-client-config/v3/client-config/lol.client_settings.team_voice.enabled",
                i = l.dataBinding.bindTo(l.socket);
            var r = l.Ember.Service.extend({
                captureDevices: void 0,
                teamVoiceEnabled: !1,
                init() {
                    this._super(...arguments), i.observe(s, this, (function(e) {
                        this.set("captureDevices", e)
                    })), i.observe(o, this, (function(e) {
                        this.set("teamVoiceEnabled", e || !1)
                    }))
                },
                isPushToTalkAvailable(e) {
                    const t = e ? 1 : 0;
                    return i.post(a + "/v1/push-to-talk/check-available", t)
                },
                willDestroy() {
                    this._super(...arguments), i.unobserve(s, this), i.unobserve(o, this)
                }
            });
            t.default = r
        }, (e, t, n) => {
            ...
            e.exports = l.HTMLBars.template({
                id: "Ue/nevFv",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "FXLQfXDo",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\loading.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["open-element","div",[]],["static-attr","style","display: flex; align-items: center; height: 100%;"],["flush-element"],["text","\\n  "],["append",["helper",["uikit-spinner"],null,[["style"],["margin-left: auto; margin-right: auto;"]]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const l = n(1).Ember;
            ...
            e.exports = l.HTMLBars.template({
                id: "88MW7Zrs",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\templates\\\\components\\\\honeyfruit-settings-error.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-settings\\\\src\\\\app\\\\components\\\\honeyfruit-settings-error.js\\" "],["text","\\n"],["append",["unknown",["tra","honeyfruit_settings_error"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }],
        t = {};
