(() => {
    var e = [function(e, t, n) {
            ...
            var N = a.Ember.Controller.extend(s.default, {
                ...
                inputModes: a.Ember.computed(f.property, (function() {
                    return [{
                        name: h,
                ...
                isInputModeVoice: a.Ember.computed(f.property, (function() {
                    return this.get(f.property) === h
                })),
                isInputModePushToTalk: a.Ember.computed(f.property, (function() {
                    return this.get(f.property) === S
                })),
                inputModeVoiceSensitivityLabel: a.Ember.computed(T.property, (function() {
                    const e = Number.isInteger(this.get(T.property)) ? this.get(T.property) : T.defaultValue;
                    return this.get("tra.formatString")("voice_settings_input_sensitivity", {
                        sensitivity: e
                    })
                })),
                init() {
                    this._super(...arguments), this.bindSetting(m), this.bindSetting(u), this.bindSetting(d), this.bindSetting(p), this.bindSetting(_), this.bindSetting(g), this.bindSetting(E), this.bindSetting(f), this.bindSetting(T), this.bindSetting(y), this.bindSetting(v), c.observe(o, this, (e => {
                ...
                resetToDefault: function() {
                    this.changeSetting(m.property, m.defaultValue), this.changeSetting(u.property, u.defaultValue), this.changeSetting(d.property, d.defaultValue), this.changeSetting(p.property, p.defaultValue), this.changeSetting(_.property, _.defaultValue), this.changeSetting(g.property, g.defaultValue), this.changeSetting(E.property, E.defaultValue), this.changeSetting(f.property, f.defaultValue), this.changeSetting(T.property, T.defaultValue), this.changeSetting(y.property, y.defaultValue), this.changeSetting(v.property, v.defaultValue)
                },
                _showPTTPermissionsModal() {
                    this.changeSetting(f.property, h);
                ...
                actions: {
                    ...
                    selectInputMode: function(e) {
                        this.changeSetting(f.property, e), e === S && this.get("voiceService").isPushToTalkAvailable(!0).then((e => {
            ...
            const a = "/lol-premade-voice",
                ...
                c = l.dataBinding.bindTo(l.socket);
            var m = l.Ember.Service.extend({
                ...
                init() {
                    this._super(...arguments), c.observe(s, this, (function(e) {
                        this.set("captureDevices", e)
                    })), c.observe(o, this, (function(e) {
                ...
                isPushToTalkAvailable(e) {
                    const t = e ? 1 : 0;
                    return c.post(a + "/v1/push-to-talk/check-available", t)
                },
                willDestroy() {
                    this._super(...arguments), c.unobserve(s, this), c.unobserve(o, this), c.unobserve(i, this), c.unobserve(r, this)
                }
            });
            t.default = m
        }, (e, t, n) => {
