(() => {
    var e = [, e => {
            ...
            const m = n(1),
                ...
                _ = m.Lodash,
                y = s.PositionAssignmentPreloadVideos;
            var v = new class {
                constructor() {
                    ...
                    return this.showPromise = this.showPromise.then(function() {
                        ...
                        this._isClashGame ? this.appControls.addMessage(this._clashDodgeMessage) : this._isRankedGame && this._isAutofilled ? this.appControls.addModal(this._rankedDodgeModal) : this._isCustomGame || this.appControls.addMessage(this._dodgeMessage), this.screenRoot.bump(), this._isShown = !0, f.endTracingEvent("champ-select-init"), Promise.all([this.gameflowBinding.get("/v1/session"), this.champSelectBinding.get("/v1/session"), d("/lol-summoner/v1/current-summoner").get(), d("/lol-inventory/v2/inventory/WARD_SKIN").get(), d("/lol-inventory/v2/inventory/CHAMPION").get()]).then((([e, t, n, i, s]) => {
                            ...
                            const {
                                ...
                                puuid: b,
                                summonerId: _
                            } = n, y = Array.isArray(i) ? i.length : 0, v = Array.isArray(s) ? s.filter((e => e.owned)).length : 0, x = JSON.stringify({
                                internalNowInEpochMs: c,
            ...
            var c = i.Ember.Component.extend(o, {
                ...
                isMapIntroVisible: i.Ember.computed("shouldPlayVideos", "showPositionAssignment", "currentSideMapIntroVideo", (function() {
            ...
            t.GAME_MODES_WITH_SUBTEAMS = {
                CHERRY: {
                    ...
                    queueOverrides: [{
                        queues: [1740, 1750, 1751, 1753, 1756, 1759, 1762, 1765],
                        value: {
                            teamSize: 3,
                            teamSizeLabel: "cherry_map_size_label",
                            subteams: [{
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                return function(e, t = null) {
                    ...
                    _ = i.SharedEmberComponents.EmberCollectionApi.registerToFactoryDefinition(_), !1;
                    return _
                }(e, t)
            ...
            var S = i.Ember.Component.extend(p, d, s.default, a.default, {
                ...
                isDemaciaBanPhase: i.Ember.computed("isDemacia", "session.timer.inBanPickPhase", "sessionActions.activeAction.isBan", (function() {
                    return this.get("isDemacia") && this.get("session.timer.inBanPickPhase") && this.get("sessionActions.activeAction.isBan")
                })),
                showDemaciaBanBg: i.Ember.computed("isDemaciaBanPhase", "uxSettings.largeAreaAnimationsEnabled", (function() {
                ...
                isDropInSpectator: i.Ember.computed.and("session.isLegacyChampSelect", "isSpectating"),
                showQuitButton: i.Ember.computed("session.showQuitButton", "isNotSpectating", "isDropInSpectator", (function() {
                    return this.get("session.showQuitButton") && (this.get("isNotSpectating") || this.get("isDropInSpectator"))
                })),
                disableQuitButton: i.Ember.computed("session.timer.timerAvailable", "session.timer.inFinalizationPhase", "session.timer.inGameStartingPhase", "isUILockedForGameStart", "isDropInSpectator", (function() {
                    this.get("isDropInSpectator") && this.get("session.timer.inGameStartingPhase");
                ...
                showPlayPositionAssignmentVideos: i.Ember.computed("uxSettings.largeAreaAnimationsEnabled", "isDemacia", (function() {
                ...
                currentSideMapImage: i.Ember.computed("map.id", "currentSummoner.side", "map.assets.map-north", "map.assets.map-south", (function() {
                    const e = "red" === this.get("currentSummoner.side") ? "north" : "south",
                        t = this.get(`map.assets.map-${e}`);
                    return t || null
                })),
                currentSideMapIntroVideo: i.Ember.computed("map.id", "currentSummoner.side", "map.assets.position-assignment-map-intro-north-video", "map.assets.position-assignment-map-intro-south-video", (function() {
                    const e = "red" === this.get("currentSummoner.side") ? "north" : "south",
                        t = this.get(`map.assets.position-assignment-map-intro-${e}-video`);
                    return t || null
                })),
            ...
            const o = n(1),
                ...
                c = l.Object.extend({
                    ...
                    enemyActiveAction: l.computed("activeActions.[]", "root.isSpectating", (function() {
                        const e = this.get("activeActions") || l.A();
                        return this.get("root.isSpectating") ? e.find((e => !e.get("actor.isOnLeftSide"))) : e.findBy("actor.isOnPlayersTeam", !1)
                    })),
                    alliedActiveAction: l.computed("activeActions.[]", "root.isSpectating", (function() {
                        const e = this.get("activeActions") || l.A();
                        return this.get("root.isSpectating") ? e.find((e => e.get("actor.isOnLeftSide"))) : e.findBy("actor.isOnPlayersTeam", !0)
                    })),
            ...
            const {
                RunMixin: u,
                DomMixin: h
            } = i.EmberAddons.EmberLifeline, g = "championFilterPreferenceKey", f = 3e3, S = [], b = [], _ = [];
            ...
            e.exports = i.HTMLBars.template({
                id: "/KgygFrc",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\game-info-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\game-info-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\game-info-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","team-size"],["flush-element"],["text","\\n  "],["append",["unknown",["teamSizeText"]],false],["text","\\n"],["close-element"],["text","\\n"],["open-element","div",[]],["static-attr","class","pick-mode"],["flush-element"],["text","\\n  "],["append",["unknown",["pickModeText"]],false],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = i.HTMLBars.template({
                id: "eee4+lWa",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\player-name-wrapper-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\player-name-wrapper-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\player-name-wrapper-component\\\\index.js\\" "],["text","\\n"],["append",["unknown",["displayName"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            n(138), e.exports = l.Component.extend({
                ...
                actions: {
                    quitCustom: function() {
                        ...
                        const e = this.get("isLegacyChampSelect") && this.get("isSpectating") ? "/lol-lobby/v1/lobby/custom/cancel-champ-select" : "/lol-lobby-team-builder/champ-select/v1/session/quit";
                        s.default.ajax({
                            type: "POST",
                            url: e
                        }).then((() => {
            ...
            e.exports = i.HTMLBars.template({
                id: "G4QhcLOd",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\reroll-button-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\reroll-button-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\reroll-button-component\\\\index.js\\" "],["text","\\n"],["block",["action-button"],null,[["disabled","click"],[["get",["rerollsDisabled"]],"reroll"]],0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","h4",[]],["flush-element"],["append",["unknown",["rerolls"]],false],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const c = i.Ember.Object.extend({
                    ...
                    showAwBadge: i.Ember.computed("skin.awUnlocked", "placeholder", (function() {
                        const e = this.get("placeholder"),
                            t = this.get("skin.awUnlocked");
                        return !e && !!t
                    })),
            ...
            e.exports = s.Ember.Component.extend({
                ...
                championIconStyle: s.Ember.computed("summoner.championIconStyle", "summoner.championId", "summoner.skinId", "summoner.isDonePicking", "summoner.isOnPlayersTeam", "championInventory", (function() {
                    const e = this.get("championAssetSubstitution"),
                        t = this.get("summoner.championIconStyle");
                    if (t) {
                        const n = this.get("championInventory"),
                            i = this.get("summoner.championId"),
                            s = n.findBy("id", i);
                        let o = a.INVALID_SKIN_ID;
                        if (this.get("summoner.isOnPlayersTeam") && this.get("summoner.isDonePicking") && (o = this.get("summoner.skinId") || a.INVALID_SKIN_ID), s) {
                            return `background-image: url('${e.maybeSubstituteSquarePortraitPath(s,o)}')`
                        }
                        return t
                    }
                    return "display:none"
            ...
            e.exports = i.HTMLBars.template({
                id: "H2gEs4Hy",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\missions-tracker-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\missions-tracker-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\missions-tracker-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["missionsButtonEnabled"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["missions-button"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            t.default = s.Ember.Service.extend({
                ...
                init: function() {
                    this._super(...arguments), s.db.get("/lol-login/v1/session").then((e => {
                        this.set("summonerId", e?.summonerId)
                    })), s.db.get("/lol-game-data/assets/v1/champion-summary.json").then((e => {
                ...
                handleChampSelectSession: function(e) {
                    ...
                    const t = e?.isSpectating,
                        n = e?.queueId,
                        i = this.get("summonerId"),
                        o = this.get("queueId");
                    if (e && t && n && n !== o && i) return this.set("queueId", n), s.db.get(`/lol-champions/v1/inventories/${i}/${n}/champions-minimal-per-queue`).then((e => {
                        const t = (e || []).map((e => e.id));
                        this.set("spectatorChampionIdsToShow", new Set(t))
                    }))
                },
            ...
            var _ = {
                ...
                ALL_RANKED_AND_RATED_QUEUE_TYPES: [...S, ...b]
            };
            t.default = _
        }, (e, t) => {
            "use strict";
            ...
            e.exports = i.HTMLBars.template({
                id: "ONiIOc0M",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["helper",["champ-select-root"],null,[["model"],[["get",["model"]]]]],false],["text","\\n\\n"],["append",["unknown",["outlet"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            const i = n(1).Ember;
            e.exports = i.HTMLBars.template({
                id: "lSevwujh",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\__MAIN__\\\\LeagueClientContent_Release\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-champ-select\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }],
        t = {};
