(() => {
    var e = [, e => {
            ...
            var S = i.Ember.Component.extend(p, d, s.default, a.default, {
                ...
                skipChampSelectIntroAnimations: i.Ember.computed("dynamicConfigService.SkipIntroAnimationsThresholdSeconds", "session.timer.totalTimeInPhase", "session.timer.inPlanningPhase", "isDemacia", (function() {
                    const e = this.get("dynamicConfigService.SkipIntroAnimationsThresholdSeconds") || l.DURATIONS.skipIntroAnimationsThresholdSeconds,
                        ...
                        n = this.get("session.timer.inPlanningPhase"),
                        i = this.get("isDemacia");
                    return n && t <= 1e3 * e || i
                })),
