    ...
    var e = [, e => {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                n.emberApplicationFactory.setFactoryDefinition("rcp-fe-lol-highlights", {
                    ...
                    HighlightsService: C.default,
                    tra: n.traService,
                    TEMPLATES: {
                        application: d.default,
                        index: u.default,
                        "components/highlights-panel": f.default,
                        "components/no-highlights-pane": b.default,
                        "components/highlights-loading": x.default,
                        "components/highlights-main-layout": v.default,
                        "components/highlights-list": _.default,
                        "components/highlights-list-item": y.default,
                        "components/edit-highlight-name": E.default,
                        "components/generic-tooltip": H.default,
                        "components/text-tooltip": w.default,
            ...
            var n = l(1),
                i = n.Ember.Component.extend({
                    ...
                    init() {
                        this._super(...arguments), n.TelemetryService.startTelemetryTimerEvent("profile_highlights")
                    },
                    willDestroy() {
                        n.TelemetryService.stopTelemetryTimerEvent("profile_highlights", "timeSpent", "profile")
                    }
                });
            t.default = i
        }, (e, t, l) => {
            ...
            e.exports = n.HTMLBars.template({
                id: "XERbQobb",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-highlights\\\\src\\\\app\\\\templates\\\\application.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["outlet"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, l) => {
            const n = l(1).Ember;
            e.exports = n.HTMLBars.template({
                id: "7otu0oou",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-highlights\\\\src\\\\app\\\\templates\\\\index.hbs\\" style-path=\\"null\\" js-path=\\"null\\" "],["text","\\n"],["append",["unknown",["highlights-panel"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, l) => {
            const n = l(1).Ember;
            ...
            e.exports = n.HTMLBars.template({
                id: "YG+VkEiT",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-highlights\\\\src\\\\app\\\\templates\\\\components\\\\generic-tooltip.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-highlights\\\\src\\\\app\\\\components\\\\generic-tooltip.js\\" "],["text","\\n"],["open-element","lol-uikit-tooltip",[]],["dynamic-attr","type",["unknown",["tooltipType"]],null],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"clickHandler"],null],null],["flush-element"],["text","\\n  "],["yield","default"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":["default"],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, l) => {
            const n = l(1).Ember;
            ...
            const l = (e, t, l = (e => e)) => {
                const n = [];
                for (const i of e || []) Object.prototype.hasOwnProperty.call(i, t) && n.push([l(i[t]), i]);
                return new Map(n)
            };
            t.mapBy = l;
...
//# sourceMappingURL=rcp-fe-lol-highlights.js.map