(() => {
    var e = [, e => {
            ...
            const {
                ...
                awInfo: d("isAwExtension", "awExtensionMessage", "awExpiryMessage", (function() {
                    return {
                ...
                _checkBoostOwnership(e) {
                    ...
                    g.get(`/lol-inventory/v2/inventory/${n}`).then((e => {
                        ...
                        if (a && String(t) === String(s?.boostContentId)) {
                            ...
                            t > o ? (this.set("bottomErrorMessageClass", "aw-expiry-info"), this.set("bottomErrorMessage", c)) : (this.set("isAwExtension", !0), this.set("awExtensionMessage", this.get("tra").formatString("cat_paw_aw_extension_info", {
                                duration: l
                            })), this.set("awExpiryMessage", c))
                        } else {
                            Date.now() + l * r.MILLISECONDS_IN_A_DAY > o && this.set("bottomErrorMessage", this.get("tra").formatString("cat_paw_error_validation_item_not_active"))
                        }
                    })).catch((e => {
            ...
            const {
                Component: i,
                computed: c
            } = s.Ember, r = "/lol-client-config/v3/client-config/lol.experiments", p = "/lol-settings/v2/local/lol-user-experience", m = s.dataBinding.bindTo(s.socket), u = i.extend({
                ...
                showOverlayImage: c("itemPurchaseOption.inventoryType", "itemPurchaseOption.subInventoryType", "pawSplashImage", (function() {
                    return !this.get("pawSplashImage") && !(this.get("itemPurchaseOption.inventoryType") === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN && !this.get("itemPurchaseOption.subInventoryType"))
                })),
            ...
            const {
                ...
                layout: n(91),
                style: n(92),
                overlayImagePath: c("itemPurchaseOption.assets.iconPath", "itemPurchaseOption.inventoryType", "itemPurchaseOption.imagePath", (function() {
