(() => {
    var e = [, e => {
            ...
            e.exports = a.HTMLBars.template({
                id: "mZd3lsHa",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\index.js\\" "],["text","\\n"],["append",["unknown",["text"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = a.HTMLBars.template({
                id: "pC86u/Gw",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\window-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\window-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\window-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["isLargeTwoColumnLandscapeTemplate"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["append",["unknown",["paw-template-large-two-column-landscape-template"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                Component: u,
                computed: d
            } = a.Ember, h = "/lol-client-config/v3/client-config/lol.experiments", g = a.dataBinding.bindTo(a.socket), _ = [i.default.Errors.NOT_ENOUGH_CURRENCY], f = [i.default.Errors.NOT_ENOUGH_CURRENCY, i.default.Errors.PARENT_NOT_OWNED], E = [s.PAW.INVENTORY_TYPES.CHAMPION_SKIN, s.PAW.INVENTORY_TYPES.BUNDLES], T = ["HEXTECH_BUNDLE", "MEGA_BUNDLE", "RECOLOR"], w = u.extend(l.default, {
                ...
                isUpsellEnabledForItem: d("itemPurchaseOption", (function() {
                    const e = this.get("itemPurchaseOption");
                    return E.includes(e?.inventoryType) && !T.includes(e?.subInventoryType)
                })),
                ...
                didInsertElement() {
                    this._super(...arguments), g.get(h).then((e => {
                ...
                willDestroy() {
                    this.set("onPurchased", null), this._clearTimeoutTimer(), g.unobserve(h, this), this._super(...arguments)
                },
                _purchase(e) {
                ...
                _handlePurchaseCompleted(e) {
                    ...
                    }), this.set("isPurchasing", !1), this.set("purchaseRequestSuccess", !0);
                ...
                _handleCatalogItemPurchaseOption(e) {
                    if (e) {
                        ...
                        l === s.PAW.INVENTORY_TYPES.BUNDLES && this.set("selectedBundle", {
                            ...
                            inventoryType: l,
                            data: t
                        }), this.get("shouldFetchRelatedItems") ? this.get("purchaseWidgetService").getRelatedItems(n, l).then((e => {
                ...
                _checkBoostOwnership(e) {
                    ...
                    g.get(`/lol-inventory/v2/inventory/${n}`).then((e => {
                        const n = Array.isArray(e) && e.find((e => String(e.uuid) === String(t))),
                            a = !!n;
                        this.set("_boostOwnedBeforePurchase", a);
                        ...
                        a.logger.error("Failed to check boost inventory: ", e), this.set("_boostOwnedBeforePurchase", !1)
                    }))
                },
                _triggerBoostFSC() {},
                ...
                _filterTopBannerErrorMessage: e => e.filter((e => f.includes(e))).shift(),
                _filterBottomErrorMessage: e => e.filter((e => !f.includes(e))).shift(),
            ...
            const {
                ...
                overlayImagePath: c("itemPurchaseOption.assets.iconPath", "itemPurchaseOption.inventoryType", "itemPurchaseOption.imagePath", "awInfo", (function() {
                    if ("BOOST" === this.get("itemPurchaseOption.inventoryType")) {
                        ...
                        return this.get("awInfo.isAw") ? e || null : e ? `/fe/lol-store/storefront/addon/public/img/composites/${e}` : null
                    }
            ...
            e.exports = a.HTMLBars.template({
                id: "hXuXUc3K",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-title-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-title-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-title-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-title-top"],["flush-element"],["append",["unknown",["title"]],false],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = a.HTMLBars.template({
                id: "cXz/bino",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v3\\\\__MAIN__\\\\LeagueClientContent_Beta\\\\15693\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","contents"],["dynamic-attr","style",["concat",["background:",["unknown",["color"]]]]],["flush-element"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
