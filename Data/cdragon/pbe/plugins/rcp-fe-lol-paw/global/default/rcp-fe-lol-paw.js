                ...
                _checkBoostOwnership(e) {
                    ...
                    g.get(`/lol-inventory/v2/inventory/${n}`).then((e => {
                        ...
                        if (a && String(t) === String(s?.boostContentId)) {
                            ...
                            t > o ? this.set("bottomErrorMessage", c) : (this.set("isAwExtension", !0), this.set("awExtensionMessage", this.get("tra").formatString("cat_paw_aw_extension_info", {
                                duration: l
