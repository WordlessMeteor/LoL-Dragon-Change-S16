(() => {
    var e = [, e => {
            ...
            var T = {
                ...
                ALL_RATED_QUEUE_TYPES: w,
                ALL_RANKED_AND_RATED_QUEUE_TYPES: [...E, ...w]
            };
            t.default = T
        }, (e, t) => {
            "use strict";
            ...
            var p = {
                ...
                LOWEST_TIER: a[0],
                DIVISIONS: c,
                HIGHEST_DIVISION: c[c.length - 1],
                LOWEST_DIVISION: c[0],
                LP_PER_DIVISION: 100,
                TIER_NAME_TO_ORDINAL: m(s),
                DIVISION_TO_ORDINAL: m(c),
            ...
            t.default = class {
                constructor() {
                    this.bindings = {
                        champions: (0, a.dataBinding)("/lol-champions", a.socket),
                        login: (0, a.dataBinding)("/lol-login", a.socket),
                        paw: (0, a.dataBinding)("/lol-purchase-widget", a.socket),
                        store: (0, a.dataBinding)("/lol-store", a.socket)
                ...
                traService() {
                    const e = (0, a.getProvider)().get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/lol-paw/trans.json").overlay("/fe/ember-libs/trans-loot-table.json").overlay("/fe/lol-shared-components/trans-digital-goods-disclaimer.json");
                ...
                setUpComponents(e) {
                    a.emberApplicationFactory.setFactoryDefinition({
                        ...
                        tra: e,
                        ComponentFactory: a.componentFactory,
                        PawRootComponent: n(69),
                        TopBannerComponent: n(74),
                        RelatedItemsOverlayComponent: n(77),
                        ItemDetailsComponent: n(80),
                        PurchaseOptionsComponent: n(83),
                        PurchaseWarningsComponent: n(86),
                        ItemSplashComponent: n(89),
                        OverlayImageComponent: n(92),
                        ContentDescriptionComponent: n(95),
                        DependencyDetailsComponent: n(98),
                        PriceDetailsComponent: n(101),
                        PriceButtonComponent: n(104),
                        DisclaimerCheckboxComponent: n(107),
                        ItemUnlockedComponent: n(110),
                        CelebrationVideoComponent: n(113),
                        PreviewVideoToggleComponent: n(115),
                        BadgeOverlayComponent: n(118),
                        AwSkinListComponent: n(121),
                        DigitalGoodsDisclaimerComponent: a.SharedEmberComponents.DigitalGoodsDisclaimerComponent,
                        PawChoiceComponent: n(124),
                        ItemChoiceComponent: n(127),
                        ItemChoiceDetailsComponent: n(132),
                        ItemChoiceDetailFullComponent: n(135),
                        BundleRootComponent: n(138),
                        BundleTitleComponent: n(141),
                        BundleDescriptionComponent: n(144),
                        BundleItemsComponent: n(147),
                        BundlePriceComponent: n(150),
                        BundlePurchaseComponent: n(153),
                        BundleUpsellComponent: n(156),
                        ChromaBundleDetailsComponent: n(159),
                        ChromaBundleOverlayImageComponent: n(161),
                        ChromaButtonComponent: n(164),
                        ChromaBundleContentItemsComponent: n(167),
                        PurchaseWidgetService: c.default,
                        PawTemplateService: i.default,
                        PawTemplateLargeTwoColumnLandscapeTemplateComponent: r.default,
                        PawTemplateImageCarouselComponent: m.default,
                        ...
                        PawTemplateVerticalListComponent: f.default,
                        PawTemplateWindowComponent: _.default
                    }), a.emberApplicationFactory.setFactoryDefinition({
                        name: "PAWRPTopUpModalComponent",
                        tra: e,
                        ComponentFactory: a.componentFactory,
                        PAWRPTopUpModalComponent: n(168)
                    })
                }
                enable() {
                    this.enabled = !0
            ...
            e.exports = {
                TELEMETRY_EVENT_ID: {
                    ...
                    LOL_PAW_CLICK: "lol_paw_click",
                    LOL_PAW_NUMERIC: "lol_paw_numeric",
                    RELATED_ITEM_CLICK: "lol_paw_related_item_click",
                    RELATED_ITEM_PURCHASE: "lol_paw_related_item_purchase"
                },
                ...
                TELEMETRY_BUTTON_NAMES: {
                    VIDEO_TOGGLE: "preview_video_toggle",
                    SPLASH_TOGGLE: "splash_toggle"
                }
            }
        }, (e, t, n) => {
            "use strict";
            const {
                PAW: a
            } = n(3), s = n(34).default, l = [{
                inventoryType: a.INVENTORY_TYPES.BUNDLES,
                subInventoryType: s.STATSTONES_BUNDLE
            }];
            e.exports = {
                ...
                NOT_FOUND_ICON: "/fe/lol-paw/images/not-found.png",
                AW_SKINS_KR_PATH: "/fe/lol-paw/aw_skins_kr.csv",
                DEFAULT_BACKGROUND_PATH: 'url("/fe/lol-paw/images/bg-chroma-card.jpg")',
                REFUNDABLE_BUNDLE_TYPES: l,
                EXCLUDED_JADE_DISCLAIMER_INVENTORY_TYPES: ["EMOTE", "WARD_SKIN", "SUMMONER_ICON", "REGALIA_BANNER", "TRANSFER", "EVENT_PASS", "CURRENCY"],
                MILLISECONDS_IN_A_MINUTE: 6e4,
                MILLISECONDS_IN_A_HOUR: 36e5,
                MILLISECONDS_IN_A_DAY: 864e5,
                MILLISECONDS_IN_A_WEEK: 6048e5
            }
        }, (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            t.default = {
                ...
                BORDER_SET_BUNDLE: "BORDER_SET_BUNDLE",
            ...
            var m = a.Ember.Service.extend(i.default, {
            ...
            var m = s.Ember.Service.extend(r, {
                init() {
                    this._super(...arguments), this._dataBinding = (0, s.dataBinding)("lol-purchase-widget"), s.db.get("/lol-game-data/assets/v1/lolcurrency.json").then((e => {
                        ...
                        this.set("currentLocale", e?.locale), this.set("region", e?.region)
                    })), s.db.get("/system/v1/builds").then((e => {
                        this.set("patchline", e?.patchline)
                    }))
                },
                isKREnv: s.Ember.computed("region", "patchline", (function() {
                    return "KR" === this.get("region") || this.get("patchline")?.endsWith("_KR") || this.get("patchline")?.endsWith("_KRmac")
                })),
                getMissingVOData(e = []) {
                ...
                getAwSkins: () => Promise.all([fetch(i.AW_SKINS_KR_PATH).then((e => {
                    if (!e.ok) throw new Error(`Request for ${i.AW_SKINS_KR_PATH} failed with status ${e.status}`);
                    return e.text()
                })), s.db.get("/lol-game-data-inventory/v1/items/contentIds/inventoryTypes/CHAMPION_SKIN")]).then((([e, t]) => (0, o.getAwSkinNames)(e, t))),
                getItem(e, t) {
                ...
                purchaseItem(e, t, n) {
                    ...
                    })), s.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                        id: c.TELEMETRY_EVENT_ID.START_PURCHASE,
                        purchaseDataItems: JSON.stringify(a)
                    }), Promise.race([this._getTimeoutPromise(i.MAX_WAITING_TIME_IN_MS), this._dataBinding.post("/v2/purchaseItems", {
                        items: a
                    })])
                }
            });
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.getAwSkinNames = function(e, t) {
                return e.split("\n").map((e => e.trim())).map((e => t?.[e]?.gipName)).filter((e => !!e)).sort(((e, t) => e > t ? 1 : -1))
            }
        }, (e, t, n) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            e.exports = a.HTMLBars.template({
                id: "3LoFNNSe",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\text-component\\\\index.js\\" "],["text","\\n"],["append",["unknown",["text"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = a.HTMLBars.template({
                id: "HPG4zZAI",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\title-subtitle-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\title-subtitle-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-template\\\\title-subtitle-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-template-title-subtitle-base paw-template-title-subtitle-title"],["flush-element"],["append",["unknown",["title"]],false],["close-element"],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-template-title-subtitle-base paw-template-title-subtitle-subtitle"],["flush-element"],["append",["unknown",["subtitle"]],false],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                Component: u,
                computed: d
            } = a.Ember, h = "/lol-client-config/v3/client-config/", g = h + "lol.experiments", f = a.dataBinding.bindTo(a.socket), _ = [i.default.Errors.NOT_ENOUGH_CURRENCY], E = [i.default.Errors.NOT_ENOUGH_CURRENCY, i.default.Errors.PARENT_NOT_OWNED], w = [s.PAW.INVENTORY_TYPES.CHAMPION_SKIN, s.PAW.INVENTORY_TYPES.BUNDLES], T = ["HEXTECH_BUNDLE", "MEGA_BUNDLE", "RECOLOR"], y = u.extend(l.default, {
                ...
                isAw: !1,
                isAwExtension: !1,
                awExtensionMessage: null,
                awExpiryMessage: null,
                isViewingAwSkinList: !1,
                awInfo: d("isAw", "isAwExtension", "awExtensionMessage", "awExpiryMessage", "purchaseWidgetService.isKREnv", (function() {
                    return {
                        isAw: this.get("isAw"),
                        isExtension: this.get("isAwExtension"),
                        extensionMessage: this.get("awExtensionMessage"),
                        expiryMessage: this.get("awExpiryMessage"),
                        showSkinList: !(!this.get("isAw") || !this.get("purchaseWidgetService.isKREnv"))
                    }
                })),
                nonRefundableDisclaimerEnabled: d.readOnly("pawConfig.nonRefundableDisclaimerEnabled"),
                alwaysShowPurchaseDisclaimer: d("pawConfig.alwaysShowPurchaseDisclaimer", "purchaseWidgetService.isKREnv", (function() {
                    return !(!this.get("pawConfig.alwaysShowPurchaseDisclaimer") && !this.get("purchaseWidgetService.isKREnv"))
                })),
                ...
                skins: d.readOnly("purchaseWidgetService.skins"),
                inventoryTypeSpecialStyle: d("itemPurchaseOption.inventoryType", (function() {
                    return this.get("itemPurchaseOption.inventoryType")?.toLowerCase()
                })),
                pawTemplateService: a.Ember.inject.service("paw-template"),
                isPawTemplateModal: d.notEmpty("pawTemplateData"),
                isLoading: d("isLoadingCatalogItemInfo", "isLoadingRelatedItems", (function() {
                    return this.get("isLoadingCatalogItemInfo") || this.get("isLoadingRelatedItems")
                })),
                isLoadingRelatedItems: d("relatedItems", "isUpsellFlagEnabled", (function() {
                    return void 0 === this.get("relatedItems") && this.get("isUpsellFlagEnabled")
                })),
                ...
                relatedBundlesToShow: d("relatedItems", "catalogItemPurchaseOption", (function() {
                    const e = this.get("relatedItems") || [],
                        t = this.get("catalogItemPurchaseOption");
                    if (t?.item?.inventoryType !== s.PAW.INVENTORY_TYPES.CHAMPION_SKIN) {
                        return [...e.filter((e => e.item.inventoryType !== s.PAW.INVENTORY_TYPES.CHAMPION_SKIN)).slice(0, 2), t]
                    }
                    return e.slice(0, 3)
                })),
                baseSkinItem: d("catalogItemPurchaseOption", "relatedItems", (function() {
                    const e = this.get("catalogItemPurchaseOption"),
                        t = this.get("relatedItems");
                    if (e?.item?.inventoryType === s.PAW.INVENTORY_TYPES.CHAMPION_SKIN) return e;
                    const n = t?.find((e => e.item.inventoryType === s.PAW.INVENTORY_TYPES.CHAMPION_SKIN));
                    if (n && (n.item.assets = n?.assets, !n.purchaseOptions)) {
                        this.get("purchaseWidgetService").getItem(n.item.itemId, n.item.inventoryType).then((e => {
                            const t = this._transformCatalogItemMetadata(e);
                            this.set("baseSkinItem", t)
                        })).catch((e => {
                            a.logger.error("Failed to fetch base skin purchase options: ", e)
                        }))
                    }
                    return n
                })),
                showCelebrationVideo: d("isPotatoModeEnabled", "purchaseSuccess", "supportsMultipleItems", "fscTriggered", (function() {
                    return !this.get("isPotatoModeEnabled") && this.get("purchaseSuccess") && !this.get("supportsMultipleItems") && !this.get("fscTriggered")
                })),
                ...
                isUpsellEnabledForItem: d("itemPurchaseOption", (function() {
                    const e = this.get("itemPurchaseOption");
                    return w.includes(e?.inventoryType) && !T.includes(e?.subInventoryType)
                })),
                showUpsellModal: d("isUpsellEnabledForItem", "isUpsellFlagEnabled", "relatedBundlesToShow", (function() {
                    const e = this.get("isUpsellFlagEnabled"),
                        t = this.get("relatedBundlesToShow")?.length > 0,
                        n = this.get("isUpsellEnabledForItem");
                    return e && n && t
                })),
                shouldFetchRelatedItems: d("isUpsellFlagEnabled", "isUpsellEnabledForItem", (function() {
                    return this.get("isUpsellFlagEnabled") && this.get("isUpsellEnabledForItem")
                })),
                ...
                walletBalanceChanged: a.Ember.observer("wallet", (function() {
                    !this.get("isPurchasing") && !this.get("purchaseSuccess") && this._loadCatalogItemInfo()
                })),
                topBannerErrorMessage: d("validationErrors", (function() {
                    return this._filterAndExtractHumanReadableErrorMessage(this.get("validationErrors"), this._filterTopBannerErrorMessage)
                })),
                bottomErrorMessage: d("validationErrors", (function() {
                    return this._filterAndExtractHumanReadableErrorMessage(this.get("validationErrors"), this._filterBottomErrorMessage)
                })),
                bundleErrorMessage: d("validationErrors", (function() {
                    return this._filterAndExtractHumanReadableErrorMessage(this.get("validationErrors"), this._filterBundleErrorMessage)
                })),
                showBundlesSplashPawModal: d("isBundledItem", "catalogItemPurchaseOption", "showUpsellModal", (function() {
                    return !(!this.get("isBundledItem") || !this.get("catalogItemPurchaseOption.pawSplashImage") || this.get("showUpsellModal"))
                })),
                init() {
                ...
                didInsertElement() {
                    this._super(...arguments), f.get(h + "operational.awConfig").then((e => {
                        this.set("_awSettings", e)
                    })), f.get(g).then((e => {
                        this.set("isUpsellFlagEnabled", "enable" === e?.paw_skin_bundles_upsell), this.get("isPawTemplateModal") ? this.get("pawTemplateService").validateOffer() : this._loadCatalogItemInfo()
                    }))
                },
                actions: {
                    purchase(e) {
                    ...
                    viewAwSkinList() {
                        this.set("isViewingAwSkinList", !0)
                    },
                    closeAwSkinList() {
                        this.set("isViewingAwSkinList", !1)
                    }
                },
                willDestroy() {
                    this.set("onPurchased", null), this._clearTimeoutTimer(), f.unobserve(g, this), this._super(...arguments)
                },
                _purchase(e) {
                    const t = a.datadogRum.proxy.startDurationVital("client.xp.storefront.product.purchase");
                    a.datadogRum.proxy.addAction("client.xp.storefront.product.purchase.request", e), this.set("isPurchasing", !0);
                    const n = this.get("purchaseWidgetService"),
                        s = this.get("source"),
                        l = this.get("sectionId");
                    return n.purchaseItem(e, s, l).then(this._handlePurchaseRequestFinished.bind(this)).catch(this._handlePurchaseError.bind(this)).finally((() => {
                        a.datadogRum.proxy.stopDurationVital(t, {
                            context: {
                                purchaseOption: e,
                                result: this.get("purchaseRequestSuccess")
                            }
                        })
                    }))
                },
                _extractPurchaseResultInfo: e => ({
                    itemIds: e?.items?.map((e => e?.itemKey?.itemId)).filter((e => !!e)) ?? [],
                    inventoryTypes: e?.items?.map((e => e?.itemKey?.inventoryType)).filter((e => !!e)) ?? [],
                    sources: [...new Set(e?.items?.map((e => e?.source)).filter((e => !!e)) ?? [])],
                    transactionIds: e?.transactions?.map((e => e.transactionId)).filter((e => !!e)) ?? []
                }),
                ...
                _handlePurchaseCompleted(e) {
                    ...
                    a.datadogRum.proxy.addAction("client.xp.storefront.product.purchase.success", {
                        purchaseDetails: e
                    ...
                    }), this.set("isPurchasing", !1), this.set("purchaseRequestSuccess", !0), this._triggerAramWardrobeFsc();
                    const n = this.get("onPurchased");
                    n && n(e)
                },
                _handlePurchaseError(e) {
                    if (this.set("isPurchasing", !1), this.set("purchaseRequestSuccess", !1), a.privateAPI.removePAWModal(), e instanceof Error) {
                        const t = this._buildCustomError("client.xp.storefront.product.purchase.error", e, "Error purchasing product");
                        return a.datadogRum.proxy.addError(t, {
                            itemId: this.get("itemId"),
                            items: this.get("items"),
                            inventoryType: this.get("inventoryType")
                        }), a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                    ...
                    const s = this._buildCustomError("client.xp.storefront.product.purchase.error", null, "Error purchasing product");
                    a.datadogRum.proxy.addError(s, {
                        itemId: this.get("itemId"),
                        items: this.get("items"),
                        contents: n,
                        inventoryType: this.get("inventoryType"),
                ...
                _loadSingleCatalogItemInfo() {
                    const e = this.get("purchaseWidgetService"),
                        ...
                        l = a.datadogRum.proxy.startDurationVital("client.xp.storefront.product.view");
                    a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, s), Promise.race([this._getTimeoutPromise(r.MAX_WAITING_TIME_IN_MS), e.getItem(t, n)]).then(this._handleCatalogItemPurchaseOption.bind(this)).catch(this._handleCatalogItemInfoError.bind(this)).finally((() => {
                        a.datadogRum.proxy.stopDurationVital(l, {
                            context: {
                                itemId: this.get("itemId"),
                                inventoryType: this.get("inventoryType"),
                                result: this.get("itemLoadSuccess")
                            }
                        })
                    }))
                },
                _loadMultipleCatalogItemInfo() {
                    const e = this.get("purchaseWidgetService"),
                        ...
                        l = a.datadogRum.proxy.startDurationVital("client.xp.storefront.product.view");
                    a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, s), Promise.race([this._getTimeoutPromise(r.MAX_WAITING_TIME_IN_MS), e.getItems(t, n)]).then(this._handleCatalogItemPurchaseOption.bind(this)).catch(this._handleCatalogItemInfoError.bind(this)).finally((() => {
                        a.datadogRum.proxy.stopDurationVital(l, {
                            context: {
                                itemId: this.get("itemId"),
                                inventoryType: this.get("inventoryType"),
                ...
                _loadCatalogItemInfo() {
                    ...
                    const e = this.get("supportsMultipleItems");
                    a.datadogRum.proxy.addAction("client.xp.storefront.product.view.request", {
                        itemId: this.get("itemId"),
                        inventoryType: this.get("inventoryType")
                    }), e ? this._loadMultipleCatalogItemInfo() : this._loadSingleCatalogItemInfo()
                },
                _handleCatalogItemPurchaseOption(e) {
                    if (e) {
                        const t = this._transformCatalogItemMetadata(e),
                            n = this.get("tags") || this.get("items.tags");
                        if (n && n.length && t.item) {
                            const e = t.item,
                                a = e.tags || [];
                            e.tags = [...new Set([...a, ...n])]
                        }
                        this.set("catalogItemPurchaseOption", t);
                        const l = this.get("itemId"),
                            o = this.get("inventoryType");
                        o === s.PAW.INVENTORY_TYPES.BUNDLES && this.set("selectedBundle", {
                            id: l,
                            inventoryType: o,
                            data: t
                        }), this._checkAramWardrobeOwnership(t), this.get("shouldFetchRelatedItems") ? this.get("purchaseWidgetService").getRelatedItems(l, o).then((e => {
                            const t = Object.values(e || {});
                            this.set("relatedItems", t)
                        })).catch((e => {
                            a.logger.error("Failed to get related skins: ", e), this.set("relatedItems", [])
                    ...
                    const t = this.get("items.itemIds"),
                        n = this.get("items.inventoryType");
                    a.datadogRum.proxy.addAction("client.xp.storefront.product.view.success", {
                        itemIds: t,
                        inventoryType: n
                    }), this.set("itemLoadSuccess", !0), a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                ...
                _handleCatalogItemInfoError(e) {
                    ...
                    if (e instanceof Error || e instanceof TypeError) {
                        t = this._getCatalogPurchaseOptionWithValidationErrors([i.default.Errors.GENERIC_ERROR]);
                        const n = this._buildCustomError("client.xp.storefront.product.view.error", e, "Error viewing product");
                        a.datadogRum.proxy.addError(n, {
                            itemId: this.get("itemId"),
                            items: this.get("items"),
                            inventoryType: this.get("inventoryType")
                        }), a.Telemetry.sendCustomData(c.TELEMETRY_EVENT_NAME, {
                        ...
                        const e = this._buildCustomError("client.xp.storefront.product.view.error", null, "Error viewing product, validation error");
                        a.datadogRum.proxy.addError(e, {
                            itemId: this.get("itemId"),
                            items: this.get("items"),
                            inventoryType: this.get("inventoryType"),
                    ...
                    this.set("catalogItemPurchaseOption", t), this.set("itemLoadSuccess", !1), this._hideLoadingSpinner()
                },
                _checkAramWardrobeOwnership(e) {
                    const t = e?.item?.itemInstanceId,
                        n = e?.item?.inventoryType,
                    ...
                    f.get(`/lol-inventory/v2/inventory/${n}`).then((e => {
                        const n = Array.isArray(e) && e.find((e => String(e.uuid) === String(t))),
                            a = !!n;
                        this.set("_aramWardrobeOwnedBeforePurchase", a);
                        const l = new Date(s.endDate).getTime();
                        ...
                        a.logger.error("Failed to check ARAM Wardrobe inventory: ", e), this.set("_aramWardrobeOwnedBeforePurchase", !1)
                    }))
                },
                _triggerAramWardrobeFsc() {
                    const e = this.get("_awSettings");
                    if (!e) return;
                    const t = Date.now(),
                        n = e.startDate ? new Date(e.startDate).getTime() : 0,
                        s = e.endDate ? new Date(e.endDate).getTime() : 0;
                    if (!n || !s || t < n || t > s) return;
                    const l = this.get("catalogItemPurchaseOption"),
                        o = l?.item?.itemInstanceId;
                    if (!o || String(o) !== String(e.boostContentId)) return;
                    const i = this.get("_aramWardrobeOwnedBeforePurchase"),
                        c = this.get("tra"),
                        r = i ? c.get("cat_paw_aw_fsc_extension_title") : c.get("cat_paw_aw_fsc_activation_title"),
                        m = r,
                        p = i ? c.get("cat_paw_aw_fsc_extension_description") : c.get("cat_paw_aw_fsc_activation_description"),
                        u = {
                            id: `paw-fsc-${o}-${Date.now()}`,
                            canvas: {
                                title: r,
                                subtitle: m,
                                description: p,
                                canvasBackgroundImage: "/fe/lol-static-assets/images/aram-wardrobe/celebration-bg.png",
                                canvasSize: "LARGE",
                                canvasDesign: "DESCRIPTION_BELOW",
                                buttonText: this.get("tra").get("cat_paw_fsc_cool_button")
                            },
                            media: {
                                introAnimation: "",
                                introAnimationAudio: "",
                                ...
                                loopAnimationAudio: "",
                                transitionAnimation: "",
                                transitionAnimationAudio: ""
                            },
                            rewards: [{
                                image: "/fe/lol-static-assets/images/aram-wardrobe/celebration-icon.png",
                                title: "",
                                subtitle: ""
                            }]
                        };
                    this.set("fscTriggered", !0), f.post("/lol-rewards/v1/celebrations/fsc", u).then((() => {
                        a.privateAPI.removePAWModal()
                    })).catch((e => {
                        a.logger.error("Failed to trigger FSC celebration: ", e)
                    }))
                },
                _transformCatalogItemMetadata(e) {
                    return (0, m.transformCatalogItemMetadata)(e, this.get("skins"))
                },
                _showLoadingSpinner() {
                ...
                _filterTopBannerErrorMessage: e => e.filter((e => E.includes(e))).shift(),
                _filterBottomErrorMessage: e => e.filter((e => !E.includes(e))).shift(),
                _filterBundleErrorMessage: e => e.filter((e => !_.includes(e))).shift(),
                _filterAndExtractHumanReadableErrorMessage(e, t) {
                    if (!e || e.length <= 0) return null;
                    const n = t(e);
                    return void 0 === n ? null : this.get(`tra.${n.messageKey}`)
                },
                _getTimeoutPromise: e => new Promise((function(t, n) {
                    setTimeout((function() {
                        n(new Error(`Request has not return after ${e}ms`))
                ...
                _buildCustomError(e, t, n) {
                    const a = new Error(t?.message || t || n);
                    return a.name = e, a.stack = t?.stack, a.cause = t, a
                }
            });
            e.exports = y
        }, (e, t, n) => {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.calculateAdjustedTotalAmount = function(e, t) {
                if (!e || !t) return 0;
                let n = 0;
                return e.forEach((e => {
                    const {
                ...
                if (!t || t <= 0 || !e || e < 0) return 0;
                if (e >= t) return 0;
                return Math.round((t - e) / t * 100)
            }, t.calculateUnadjustedTotalAmount = function(e, t) {
                if (!e || !t) return 0;
                let n = 0;
                return e.forEach((e => {
                    if (!e.owned) {
                ...
                const t = e.metadata.map((e => {
                    ...
                    return t && t.icon && t.position && (0, c.isNowWithinActivationDates)(t.activeDate, t.inactiveDate) ? {
                        className: `badge-position-${t.position}`,
                        imageUrl: `url(/fe/lol-paw/images/${t.icon}-banner.png)`
                    } : null
                })).filter((e => !!e));
                return t.length > 0 ? t : null
            }, t.getItemPriceDetails = function(e) {
                if (e.bundledItems?.length > 0) return e.purchaseOptions?.[0].priceDetails;
                const t = (e.purchaseOptions ?? []).flatMap((e => e.priceDetails ?? [])),
                    n = e.item.inventoryType,
                    a = e.item.subInventoryType,
                    s = e.item.itemId,
                    l = t.find((e => {
                        const t = e?.itemKey;
                        return t?.inventoryType === n && t?.itemId === s && t?.subInventoryType === a
                    }));
                return l ? [l] : []
            }, t.getItemSubtitle = function(e, t) {
                const {
                    inventoryType: n,
                    subInventoryType: a
                } = e;
                if (n === s.PAW.INVENTORY_TYPES.CHAMPION_SKIN && a === o.default.CHROMA) return t.get("cat_paw_bundled_type_chroma");
                if (a === o.default.CHROMA_BUNDLE) return t.get("cat_paw_bundled_type_chroma_bundle");
                if (a === o.default.BORDER_SET_BUNDLE) return t.get("cat_paw_bundled_type_border_set");
                if (a === o.default.MEGA_BUNDLE) return t.get("cat_paw_bundled_type_mega_bundle");
                return t.get(`cat_paw_bundled_type_${n.toLowerCase()}`)
            }, t.getLimitedTimeBadge = function(e, t) {
                if (!e || !e.inactiveDate) return null;
                const n = new Date(1e3 * e.inactiveDate);
                if (isNaN(n.valueOf())) return null;
                const a = n.valueOf() - Date.now();
                if (a <= 0) return null;
                const s = a < i.MILLISECONDS_IN_A_WEEK;
                return {
                    text: (0, c.getFormattedDurationString)(a, 1, t),
                    color: s ? "yellow" : "grey",
                    icon: s ? "clock-dark" : "clock",
                    isExpiringSoon: s
                }
            }, t.getMapAvailability = function(e, t, n = !1) {
                const {
                    tags: a = [],
                    inventoryType: s
                } = e;
                if (i.EXCLUDED_JADE_DISCLAIMER_INVENTORY_TYPES.includes(s)) return null;
                if (a.includes("jade_exclusive")) return t.get("cat_paw_jade_exclusive_flavor_text");
                if (a.includes("jade_compatible") || n) return null;
                return t.get("cat_paw_jade_not_available_on_classic_flavor_text")
            }, t.getPawSplashImage = function(e) {
                if (!e || !e.metadata || !e.metadata.length) return null;
                ...
                if (e.inventoryType === n) {
                    return t(e.tags.includes("statstone_epic") ? "tra.cat_paw_bundled_eternal_rarity_epic" : "tra.cat_paw_bundled_eternal_rarity_common")
                }
                return null
            }, t.isChromaBundle = function(e) {
                return e === o.default.CHROMA_BUNDLE || e === o.default.CHROMA
            }, t.shouldDisplayBundleNonRefundableDisclaimer = function(e, t, n) {
                if (n) return !1;
                return -1 === i.REFUNDABLE_BUNDLE_TYPES.findIndex((n => n.inventoryType === e && n.subInventoryType === t))
            }, t.transformCatalogItemMetadata = function(e, t = {}) {
                const n = e.item;
                if (!n) return e;
                if (n.metadata?.length) {
                    const t = n.metadata.map((e => {
                        ...
                        return t && t.tag && (0, c.isNowWithinActivationDates)(t.activeDate, t.inactiveDate) ? t.tag : null
                    })).filter((e => !!e));
                    n.metadata.forEach((({
                        type: t,
                        value: n
                        ...
                        switch (t) {
                            case "HIDDEN_BUNDLE_ITEMS":
                                try {
                                    ...
                                    l.logger.warning("Cannot parse HIDDEN_BUNDLE_ITEMS JSON, defaulting to hiding no items", e)
                                }
                                return;
                        ...
                        item: {
                            ...n,
                            tags: n.tags.concat(t)
                        }
                    })
                }
                if (!e.pawSplashImage && n.inventoryType === s.PAW.INVENTORY_TYPES.BUNDLES && (n.subInventoryType === o.default.CHROMA_BUNDLE || n.subInventoryType === o.default.BORDER_SET_BUNDLE)) {
                    const a = e.bundledItems?.find((e => "CHAMPION_SKIN" === e.inventoryType));
                    if (a) {
                        const s = t[a.itemId];
                        if (s) switch (n.subInventoryType) {
                            case o.default.CHROMA_BUNDLE:
                                e.pawSplashImage = s?.loadScreenPath;
                                break;
                            case o.default.BORDER_SET_BUNDLE:
                                e.pawSplashImage = s?.loadScreenVintagePath
                        }
                    }
                }
                return e
            ...
            const m = "silvershields_3000",
                p = "silvershields_5000";
            ...
            function u(e, t) {
                ...
                if (n?.cost > 0) {
                    if (n.discount > 0) {
                        const e = 1 - n.discount;
                        if (e > 0) return Math.ceil(n.cost / e)
                    }
                    return n.cost
                }
                return 0
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.getFormattedDurationString = function(e, t, n) {
                e = Math.max(e, 0);
                const s = Math.floor(e / a.MILLISECONDS_IN_A_WEEK),
                    l = Math.floor(e / a.MILLISECONDS_IN_A_DAY) % 7,
                    o = Math.floor(e / a.MILLISECONDS_IN_A_HOUR) % 24,
                    i = Math.ceil(e / a.MILLISECONDS_IN_A_MINUTE) % 60,
                    c = [n.formatString("cat_paw_date_time_abbreviation_week", {
                        weeks: s
                    }), n.formatString("cat_paw_date_time_abbreviation_day", {
                        days: l
                    }), n.formatString("cat_paw_date_time_abbreviation_hour", {
                        hours: o
                    }), n.formatString("cat_paw_date_time_abbreviation_minute", {
                        minutes: i
                    })],
                    r = c.findIndex((e => "0" !== e?.[0]));
                return c.slice(r, r + t).join(" ")
            ...
            e.exports = a.HTMLBars.template({
                id: "hG6lYseN",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-root-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-root-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\paw-root-component\\\\index.js\\" "],["text","\\n"],["open-element","lol-uikit-dialog-frame",[]],["static-attr","class","dialog-frame"],["static-attr","dismissable","true"],["static-attr","dismissable-type","inside"],["static-attr","no-default-padding",""],["static-attr","dismissable-icon-background",""],["flush-element"],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-modal-layout"],["flush-element"],["text","\\n"],["block",["if"],[["get",["isPawTemplateModal"]]],null,12,11],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","            "],["append",["helper",["celebration-video"],null,[["bundleUpsell"],[["get",["showUpsellModal"]]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","                "],["append",["helper",["top-banner"],null,[["sale","itemPurchaseOption","message"],[["get",["sale"]],["get",["itemPurchaseOption"]],["get",["topBannerErrorMessage"]]]]],false],["text","\\n                "],["append",["helper",["component"],[["get",["contentRendererComponent"]]],[["catalogItemPurchaseOption","dependencies","bundledItems","purchaseSuccess","isJadeStore","awInfo"],[["get",["catalogItemPurchaseOption"]],["get",["dependencies"]],["get",["bundledItems"]],["get",["purchaseSuccess"]],["get",["isJadeStore"]],["get",["awInfo"]]]]],false],["text","\\n                "],["append",["helper",["purchase-options"],null,[["wallet","itemPurchaseOption","purchaseOptions","alwaysShowPurchaseDisclaimer","purchaseSuccess","isPurchasing","isJadeStore","itemUnlockedMessage","awInfo","errorMessage","errorMessageClass","purchase","viewAwSkinList"],[["get",["wallet"]],["get",["itemPurchaseOption"]],["get",["purchaseOptions"]],["get",["alwaysShowPurchaseDisclaimer"]],["get",["purchaseSuccess"]],["get",["isPurchasing"]],["get",["isJadeStore"]],["get",["itemUnlockedMessage"]],["get",["awInfo"]],["get",["bottomErrorMessage"]],["get",["bottomErrorMessageClass"]],"purchase","viewAwSkinList"]]],false],["text","\\n              "]],"locals":[]},{"statements":[["text","                "],["append",["helper",["bundle-root"],null,[["catalogItemPurchaseOption","itemPurchaseOption","wallet","purchaseOptions","alwaysShowPurchaseDisclaimer","purchaseSuccess","isPurchasing","isJadeStore","errorMessage","validationErrors","purchase"],[["get",["catalogItemPurchaseOption"]],["get",["itemPurchaseOption"]],["get",["wallet"]],["get",["purchaseOptions"]],["get",["alwaysShowPurchaseDisclaimer"]],["get",["purchaseSuccess"]],["get",["isPurchasing"]],["get",["isJadeStore"]],["get",["bundleErrorMessage"]],["get",["validationErrors"]],"purchase"]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isBundledItem"]]],null,2,1]],"locals":[]},{"statements":[["text","                "],["append",["helper",["bundle-upsell"],null,[["relatedBundlesToShow","catalogItemPurchaseOption","selectedBundle","wallet","alwaysShowPurchaseDisclaimer","purchaseSuccess","isPurchasing","isJadeStore","errorMessage","validationErrors","source","purchase"],[["get",["relatedBundlesToShow"]],["get",["baseSkinItem"]],["get",["selectedBundle"]],["get",["wallet"]],["get",["alwaysShowPurchaseDisclaimer"]],["get",["purchaseSuccess"]],["get",["isPurchasing"]],["get",["isJadeStore"]],["get",["bundleErrorMessage"]],["get",["validationErrors"]],["get",["source"]],"purchase"]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["showUpsellModal"]]],null,4,3]],"locals":[]},{"statements":[["text","              "],["append",["helper",["paw-choice"],null,[["choices","wallet","purchaseOptions","alwaysShowPurchaseDisclaimer","purchaseSuccess","isPurchasing","isJadeStore","errorMessage","purchase"],[["get",["catalogItemPurchaseOption","choices"]],["get",["wallet"]],["get",["purchaseOptions"]],["get",["alwaysShowPurchaseDisclaimer"]],["get",["purchaseSuccess"]],["get",["isPurchasing"]],["get",["isJadeStore"]],["get",["bottomErrorMessage"]],"purchase"]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","          "],["open-element","div",[]],["dynamic-attr","class",["concat",["paw-content ",["helper",["if"],[["get",["supportsMultipleItems"]],"no-padding"],null]]]],["flush-element"],["text","\\n"],["block",["if"],[["get",["supportsMultipleItems"]]],null,6,5],["text","          "],["close-element"],["text","\\n"],["block",["if"],[["get",["showCelebrationVideo"]]],null,0],["text","        "]],"locals":[]},{"statements":[["text","          "],["append",["helper",["aw-skin-list"],null,[["goBack"],[["helper",["action"],[["get",[null]],"closeAwSkinList"],null]]]],false],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isViewingAwSkinList"]]],null,8,7]],"locals":[]},{"statements":[["text","          "],["open-element","div",[]],["static-attr","class","spinner-wrapper"],["flush-element"],["text","\\n            "],["append",["helper",["uikit-spinner"],null,[["src"],["/fe/lol-paw/images/spinner.png"]]],false],["text","\\n          "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["open-element","div",[]],["dynamic-attr","class",["concat",["paw-window\\n          ",["unknown",["inventoryTypeSpecialStyle"]],"\\n          ",["helper",["if"],[["get",["isAw"]],"paw-window-aw"],null],"\\n          ",["helper",["if"],[["get",["supportsMultipleItems"]],"paw-window-choice"],null],"\\n          ",["helper",["if"],[["get",["showBundlesSplashPawModal"]],"paw-window-bundles-splash"],null],"\\n          ",["helper",["if"],[["get",["showUpsellModal"]],"paw-window-upsell"],null]]]],["flush-element"],["text","\\n"],["block",["if"],[["get",["isLoading"]]],null,10,9],["text","      "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["append",["unknown",["paw-template-window"]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                currencyIconPaths: o("items.@each.currencyType", "purchaseWidgetService.gameDataCurrencies", (function() {
                    const e = this.get("items") || [],
                        t = this.get("purchaseWidgetService.gameDataCurrencies") || [],
                        n = {};
                    return e.forEach((e => {
                        if (e.currencyType && !n[e.currencyType]) {
                            const a = t.find((t => t.lolCurrencyId === e.currencyType));
                            n[e.currencyType] = a?.iconPath || ""
                        }
                    })), n
                })),
                enrichedItems: o("items.@each.data", "items.@each.inactiveDate", (function() {
                    const e = this.get("items") || [],
                        t = this.get("tra");
                    return e.map((e => {
                        const n = {
                        ...
                        if (e.data) {
                            const a = e.data.purchaseOptions?.[0],
                                l = e.data.bundledItems;
                            if (a && l) {
                                const t = (0, s.getItemPriceDetails)(e.data),
                                    a = e.currencyType,
                                    o = (0, s.calculateAdjustedTotalAmount)(t, a),
                                    i = 0 === l?.length ? (0, s.calculateUnadjustedTotalAmountNonBundle)(t) : (0, s.calculateUnadjustedTotalAmount)(l, a);
                                (0, s.calculateDiscountPercentage)(o, i) > 0 && (n.adjustedPrice = o, n.unadjustedPrice = i, n.hasDiscount = !0)
                            }
                            const o = (0, s.getLimitedTimeBadge)(e.data.item, t);
                            o && (n.limitedTimeBadge = o)
                        }
                        return n
                    }))
                })),
                actions: {
                    selectCurrentItem(e) {
                        this.sendAction("selectCurrentItem", e)
                    }
                }
            });
            e.exports = i
            ...
            e.exports = a.HTMLBars.template({
                id: "TwRmalY4",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\related-items-overlay-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\related-items-overlay-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\related-items-overlay-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","related-items-overlay"],["flush-element"],["text","\\n"],["block",["each"],[["get",["enrichedItems"]]],null,3],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","                "],["append",["unknown",["item","price"]],false],["text","\\n"]],"locals":[]},{"statements":[["text","                "],["open-element","span",[]],["static-attr","class","discounted-price"],["flush-element"],["append",["unknown",["item","adjustedPrice"]],false],["close-element"],["text","\\n                "],["open-element","span",[]],["static-attr","class","original-price"],["flush-element"],["append",["unknown",["item","unadjustedPrice"]],false],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","          "],["open-element","div",[]],["static-attr","class","related-item-limited-time-badge"],["flush-element"],["text","\\n            "],["open-element","hextech-ui-badge",[]],["dynamic-attr","icon",["concat",[["unknown",["item","limitedTimeBadge","icon"]]]]],["dynamic-attr","background-color",["unknown",["item","limitedTimeBadge","color"]],null],["static-attr","size","small"],["flush-element"],["append",["unknown",["item","limitedTimeBadge","text"]],false],["close-element"],["text","\\n          "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","related-item-entry"],["modifier",["action"],[["get",[null]],"selectCurrentItem",["get",["item"]]]],["flush-element"],["text","\\n      "],["open-element","div",[]],["dynamic-attr","class",["concat",["related-item-thumbnail ",["helper",["if"],[["helper",["eq"],[["get",["selectedItem","id"]],["get",["item","id"]]],null],"selected"],null]]]],["dynamic-attr","style",["concat",["background-image: url(\'",["unknown",["item","imagePath"]],"\');"]]],["flush-element"],["text","\\n        "],["append",["helper",["badge-overlay"],null,[["item","discount"],[["get",["item"]],["get",["item","discount"]]]]],false],["text","\\n"],["block",["if"],[["get",["item","limitedTimeBadge"]]],null,2],["text","        "],["open-element","div",[]],["static-attr","class","related-item-info"],["flush-element"],["text","\\n          "],["open-element","div",[]],["static-attr","class","related-item-name"],["flush-element"],["append",["unknown",["item","name"]],false],["close-element"],["text","\\n          "],["open-element","div",[]],["static-attr","class","related-item-price-row"],["flush-element"],["text","\\n            "],["open-element","img",[]],["static-attr","class","related-item-currency-icon"],["dynamic-attr","src",["concat",[["helper",["get"],[["get",["currencyIconPaths"]],["get",["item","currencyType"]]],null]]]],["flush-element"],["close-element"],["text","\\n            "],["open-element","span",[]],["static-attr","class","related-item-price-amount"],["flush-element"],["text","\\n"],["block",["if"],[["get",["item","hasDiscount"]]],null,1,0],["text","            "],["close-element"],["text","\\n          "],["close-element"],["text","\\n        "],["close-element"],["text","\\n      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":["item"]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                Component: i,
                computed: c
            } = s.Ember, r = "1, 10, 19", m = "/lol-client-config/v3/client-config/lol.experiments", p = "/lol-settings/v2/local/lol-user-experience", u = s.dataBinding.bindTo(s.socket), d = i.extend({
                ...
                init() {
                    this._super(...arguments), this.set("isPreviewVideoToggleEnabled", !1), this.initDataBindings()
                },
                initDataBindings() {
                    u.observe(m, this, (function(e) {
                        this.set("isPreviewVideoToggleEnabled", "enable" === e?.paw_skin_preview)
                    })), u.observe(p, this, (function(e) {
                        this.set("isPotatoModeEnabled", e?.data?.potatoModeEnabled ?? !1)
                    }))
                },
                willDestroy() {
                    u.unobserve(m, this), u.unobserve(p, this)
                },
                showPreviewVideoToggle: c("itemPurchaseOption", "isPreviewVideoToggleEnabled", (function() {
                    return this.get("itemPurchaseOption.subInventoryType") !== o.default.CHROMA && this.get("itemPurchaseOption.assets.previewVideoUrl") && this.get("isPreviewVideoToggleEnabled")
                })),
                showBoostSplashAsBackground: c("itemPurchaseOption.inventoryType", "isVideoMode", (function() {
                    return "BOOST" === this.get("itemPurchaseOption.inventoryType") && !this.get("isVideoMode")
                })),
                boostBackgroundImageUrl: c("itemPurchaseOption.assets.splashPath", "pawSplashImage", (function() {
                    const e = this.get("pawSplashImage"),
                        t = this.get("itemPurchaseOption.assets.splashPath");
                    return e || t || "/fe/lol-paw/images/paw-splash-bg.jpg"
                })),
                itemInnerContentStyle: c("showBoostSplashAsBackground", "boostBackgroundImageUrl", (function() {
                    return this.get("showBoostSplashAsBackground") ? `background-image: linear-gradient(to bottom, rgba(${r}, 0.45) 0%, rgba(${r}, 0.5) 25%, rgba(${r}, 0.72) 50%, rgba(${r}, 0.92) 68%, rgba(${r}, 1) 80%), url(${this.get("boostBackgroundImageUrl")});` : null
                })),
                showOverlayImage: c("itemPurchaseOption.inventoryType", "itemPurchaseOption.subInventoryType", "pawSplashImage", (function() {
                    const e = this.get("itemPurchaseOption.inventoryType");
                    return (!this.get("pawSplashImage") || "BOOST" === e) && !(e === l.PAW.INVENTORY_TYPES.CHAMPION_SKIN && !this.get("itemPurchaseOption.subInventoryType"))
                })),
                isItemDependencyLoyaltyUnlocked: c("itemPurchaseOption", "dependencies.[]", (function() {
                    let e = !1;
                    return this.get("dependencies").forEach((t => {
                        t.loyaltyUnlocked && (e = !0)
                    })), e
                })),
                loyaltyHintText: c((function() {
                    return this.get("tra.cat_paw_loyalty_unlocked_hint")
                })),
                actions: {
                    setVideoMode(e) {
                        this.set("isVideoMode", e)
                    }
                }
            });
            e.exports = d
            ...
            e.exports = a.HTMLBars.template({
                id: "55MXAyx+",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-details-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-details-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-details-component\\\\index.js\\" "],["text","\\n"],["block",["unless"],[["get",["showBoostSplashAsBackground"]]],null,3],["open-element","div",[]],["dynamic-attr","class",["concat",["item-inner-content ",["helper",["if"],[["get",["showBoostSplashAsBackground"]],"item-inner-content--boost-splash"],null]]]],["dynamic-attr","style",["unknown",["itemInnerContentStyle"]],null],["flush-element"],["text","\\n  "],["append",["helper",["overlay-image"],null,[["showOverlayImage","itemPurchaseOption","awInfo"],[["get",["showOverlayImage"]],["get",["itemPurchaseOption"]],["get",["awInfo"]]]]],false],["text","\\n"],["block",["if"],[["get",["showPreviewVideoToggle"]]],null,2],["text","  "],["append",["helper",["content-description"],null,[["itemPurchaseOption","purchaseSuccess","isJadeStore","awInfo"],[["get",["itemPurchaseOption"]],["get",["purchaseSuccess"]],["get",["isJadeStore"]],["get",["awInfo"]]]]],false],["text","\\n"],["close-element"],["text","\\n"],["block",["if"],[["get",["dependencies"]]],null,1],["open-element","hr",[]],["static-attr","class","content-separator"],["flush-element"],["close-element"],["text","\\n\\n"],["block",["if"],[["get",["isItemDependencyLoyaltyUnlocked"]]],null,0]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","loyalty-hint"],["flush-element"],["text","\\n    "],["open-element","p",[]],["static-attr","class","loyalty-hint__text"],["flush-element"],["text","\\n      "],["open-element","img",[]],["static-attr","class","loyalty-hint__logo"],["static-attr","src","/fe/lol-static-assets/images/xbox-game-pass-loyalty-hint.svg"],["static-attr","alt","Rewards Program Logo"],["flush-element"],["close-element"],["text","\\n      "],["append",["unknown",["loyaltyHintText"]],false],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["append",["helper",["dependency-details"],null,[["dependencies"],[["get",["dependencies"]]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["append",["helper",["preview-video-toggle"],null,[["onToggle"],[["helper",["action"],[["get",[null]],"setVideoMode"],null]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["append",["helper",["item-splash"],null,[["itemPurchaseOption","pawSplashImage","showOverlayImage","isVideoMode","isPotatoModeEnabled"],[["get",["itemPurchaseOption"]],["get",["pawSplashImage"]],["get",["showOverlayImage"]],["get",["isVideoMode"]],["get",["isPotatoModeEnabled"]]]]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                awSkinListDisclaimerPrefix: o("tra.cat_paw_aw_skin_list_disclaimer", (function() {
                    return this.get("tra.cat_paw_aw_skin_list_disclaimer").split("{{skinListLink}}")[0]
                })),
                awSkinListDisclaimerSuffix: o("tra.cat_paw_aw_skin_list_disclaimer", (function() {
                    return this.get("tra.cat_paw_aw_skin_list_disclaimer").split("{{skinListLink}}")[1]
                })),
                ...
                actions: {
                    ...
                    viewAwSkinList() {
                        this.sendAction("viewAwSkinList")
                    },
                    closeModal() {
            ...
            e.exports = a.HTMLBars.template({
                id: "9GajH4Zp",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\purchase-options-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\purchase-options-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\purchase-options-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["purchaseSuccess"]]],null,9,8]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","lol-uikit-flat-checkbox",[]],["static-attr","name","missingVOCheckbox"],["static-attr","class","paw-purchase-disclaimer"],["flush-element"],["text","\\n      "],["open-element","input",[]],["static-attr","slot","input"],["static-attr","type","checkbox"],["static-attr","name","missingVOCheckbox"],["dynamic-attr","onchange",["helper",["action"],[["get",[null]],"toggleMissingVOCheckbox"],null],null],["flush-element"],["close-element"],["text","\\n      "],["open-element","label",[]],["static-attr","slot","label"],["static-attr","for","missingVOCheckbox"],["static-attr","class","lol-settings-checkbox-label"],["flush-element"],["text","\\n        "],["append",["unknown",["missingVOData","checkboxText"]],false],["text","\\n      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["append",["helper",["disclaimer-checkbox"],null,[["toggleDisclaimerValue"],["toggleDisclaimerValue"]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-purchase-options-aw-skin-list-disclaimer"],["flush-element"],["text","\\n      "],["append",["unknown",["awSkinListDisclaimerPrefix"]],false],["open-element","a",[]],["static-attr","class","paw-aw-skin-list-link"],["modifier",["action"],[["get",[null]],"viewAwSkinList"]],["flush-element"],["append",["unknown",["tra","cat_paw_aw_skin_list_disclaimer_link_text"]],false],["close-element"],["append",["unknown",["awSkinListDisclaimerSuffix"]],false],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","scrollable-paw-warnings missing-vo-disclaimer"],["flush-element"],["text","\\n      "],["open-element","lol-uikit-scrollable",[]],["flush-element"],["text","\\n        "],["open-element","div",[]],["static-attr","class","paw-warning"],["flush-element"],["append",["unknown",["missingVOData","disclaimerText"]],false],["close-element"],["text","\\n      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["append",["helper",["purchase-warnings"],null,[["itemPurchaseOption"],[["get",["itemPurchaseOption"]]]]],false],["text","\\n"],["block",["if"],[["get",["missingVOData"]]],null,3],["block",["if"],[["get",["awInfo","showSkinList"]]],null,2],["block",["if"],[["get",["alwaysShowPurchaseDisclaimer"]]],null,1],["block",["if"],[["get",["missingVOData"]]],null,0],["text","  "],["append",["helper",["price-details"],null,[["purchaseOptions","itemPurchaseOption","wallet","purchaseEnabled","purchase","padding","awInfo"],[["get",["purchaseOptions"]],["get",["itemPurchaseOption"]],["get",["wallet"]],["get",["purchaseEnabled"]],"purchase",["get",["padding"]],["get",["awInfo"]]]]],false],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","paw-purchase-options-error"],["flush-element"],["text","\\n    "],["open-element","p",[]],["dynamic-attr","class",["concat",[["unknown",["errorMessageClass"]]]]],["flush-element"],["append",["unknown",["errorMessage"]],false],["close-element"],["text","\\n    "],["open-element","lol-uikit-flat-button",[]],["static-attr","class","paw-purchase-options-error-close-button"],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"closeModal"],null],null],["flush-element"],["text","\\n      "],["append",["unknown",["tra","cat_paw_error_purchase_internal_fail_close"]],false],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["errorMessage"]]],null,5,4]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","spinner-wrapper"],["flush-element"],["text","\\n    "],["append",["helper",["uikit-spinner"],null,[["src"],["/fe/lol-paw/images/spinner.png"]]],false],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["isPurchasing"]]],null,7,6]],"locals":[]},{"statements":[["text","  "],["append",["helper",["item-unlocked"],null,[["itemPurchaseOption"],[["get",["itemPurchaseOption"]]]]],false],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                initDataBindings() {
                    i.observe(o, this, (function(e) {
                        this.set("embeddedVideoUrlSettings", e?.contentPreviewConfig)
                    }))
                },
                willDestroy() {
                    i.unobserve(o, this)
                },
                buildContentPreviewURL(e) {
                    const t = this.get("isPotatoModeEnabled"),
                        n = this.get("embeddedVideoUrlSettings"),
                        a = Object.assign({}, n.queryParams);
                    t && (a.autoplay = 0);
                    let s = `${n?.baseURL}${e}?`;
                    if (s) {
                        for (const [e, t] of Object.entries(a)) s += `&${e}=${t}`;
                        return s = s.replace(/{videoID}/g, e), s
                    }
                    return ""
                },
                videoUrl: l("isVideoMode", (function() {
                    if (this.get("isVideoMode")) {
                        const e = this.get("itemPurchaseOption.assets.previewVideoUrl");
                        if (!e) return null;
                        if (e.includes("embed")) {
                            const t = e.split("embed/")[1].split("?")[0];
                            return this.buildContentPreviewURL(t)
                        }
                        const t = e.split("v=")[1];
                        return this.buildContentPreviewURL(t)
                    }
                ...
                backgroundImageUrl: l("itemPurchaseOption.assets.splashPath", "pawSplashImage", (function() {
                    const e = this.get("pawSplashImage"),
                        t = this.get("itemPurchaseOption.assets.splashPath");
                    return e || t || "/fe/lol-paw/images/paw-splash-bg.jpg"
                })),
            ...
            e.exports = a.HTMLBars.template({
                id: "dV9VjJev",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-splash-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-splash-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-splash-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["isVideoMode"]]],null,3,2],["block",["if"],[["get",["showEmblem"]]],null,1]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      "],["open-element","img",[]],["static-attr","class","emblem-image"],["dynamic-attr","src",["concat",[["unknown",["emblem","emblemPath","large"]]]]],["flush-element"],["close-element"],["text","\\n"]],"locals":["emblem"]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","emblem-container"],["flush-element"],["text","\\n"],["block",["each"],[["get",["emblems"]]],null,0],["text","  "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["open-element","img",[]],["dynamic-attr","class",["concat",["background-image ",["helper",["if"],[["get",["showOverlayImage"]],"half-opacity"],null]]]],["dynamic-attr","src",["concat",[["unknown",["backgroundImageUrl"]]]]],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["open-element","iframe",[]],["static-attr","class","overlay-video-background"],["dynamic-attr","src",["concat",[["unknown",["videoUrl"]]]]],["static-attr","frameborder","0"],["static-attr","allow","autoplay; encrypted-media"],["static-attr","allowfullscreen",""],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                overlayImagePath: c("itemPurchaseOption.assets.iconPath", "itemPurchaseOption.inventoryType", "itemPurchaseOption.imagePath", "awInfo", (function() {
                    if ("BOOST" === this.get("itemPurchaseOption.inventoryType")) {
                        ...
                        const e = this.get("itemPurchaseOption.imagePath");
                        return e ? `/fe/lol-store/storefront/addon/public/img/composites/${e}` : null
                    }
                    return this.get("itemPurchaseOption.assets.iconPath")
                })),
                renderOverlayImage: c("showOverlayImage", "overlayImagePath", (function() {
                    return this.get("showOverlayImage") && !!this.get("overlayImagePath")
                })),
                ...
                overlayBackgroundPath: c("itemPurchaseOption.assets.iconBackgroundPath", "itemPurchaseOption.inventoryType", (function() {
                    return "BOOST" === this.get("itemPurchaseOption.inventoryType") ? "none" : this.get("itemPurchaseOption.assets.iconBackgroundPath") || 'url("/fe/lol-paw/images/bg-chroma-card.jpg")'
                })),
            ...
            e.exports = a.HTMLBars.template({
                id: "XtXlfvh/",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\overlay-image-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\overlay-image-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\overlay-image-component\\\\index.js\\" "],["text","\\n"],["block",["if"],[["get",["renderOverlayImage"]]],null,1]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","        "],["open-element","img",[]],["static-attr","src","/fe/lol-paw/images/icon-chroma.png"],["static-attr","class","chroma-icon"],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["dynamic-attr","class",["concat",["overlay-image-wrapper ",["unknown",["inventoryTypeSpecialStyle"]]]]],["dynamic-attr","style",["concat",["background-image: ",["unknown",["overlayBackgroundPath"]]]]],["flush-element"],["text","\\n    "],["open-element","div",[]],["dynamic-attr","class",["concat",["overlay-image-border ",["unknown",["inventoryTypeSpecialStyle"]]]]],["flush-element"],["text","\\n      "],["open-element","img",[]],["dynamic-attr","class",["concat",["paw-purchase-overlay-image ",["helper",["if"],[["get",["awInfo","isAw"]],"aram-wardrobe"],null]]]],["dynamic-attr","src",["concat",[["unknown",["overlayImagePath"]]]]],["flush-element"],["close-element"],["text","\\n"],["block",["if"],[["get",["showChromaIcon"]]],null,0],["text","    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const r = o.extend({
                ...
                itemName: i("itemPurchaseOption.name", "itemPurchaseOption.inventoryType", (function() {
                    const e = this.get("itemPurchaseOption");
                    if ("BOOST" === e?.inventoryType) {
                        const t = (0, s.getBoostName)(e, this.get("tra"));
                        if (t) return t
                    }
                    return this.get("itemPurchaseOption.name")
                })),
                itemSubtitle: i("itemPurchaseOption", "tra.metadata", (function() {
                    const e = this.get("itemPurchaseOption");
                    if ("BOOST" === e?.inventoryType) {
                        const t = (0, s.getBoostDescription)(e, this.get("tra"));
                        if (t) return t
                    }
                    let t = this.get("itemPurchaseOption.description");
                    if (!t) {
                        const e = this.get("itemPurchaseOption");
                        if (e && e.inventoryType) {
                            let n = null;
                            ...
                            if (n = c(a, `cat_paw_subtitle_${s.toLowerCase()}`, n), l) {
                                n = c(a, `cat_paw_subtitle_${s.toLowerCase()}_${l.toLowerCase()}`, n)
                            }
                            t = n ? a.get(n) : ""
                        }
                    }
                ...
                enrichedFlavorText: i("itemPurchaseOption.tags", "itemPurchaseOption.inventoryType", "purchaseSuccess", "isJadeStore", (function() {
                    if (this.get("purchaseSuccess") || !this.get("itemPurchaseOption")) return null;
                    const e = this.get("itemPurchaseOption.inventoryType");
                    if (l.EXCLUDED_JADE_DISCLAIMER_INVENTORY_TYPES.includes(e)) return null;
                    const t = this.get("itemPurchaseOption.tags") || [],
                        n = this.get("tra");
                    return t.includes("jade_exclusive") ? n.get("cat_paw_jade_exclusive_flavor_text") : t.includes("jade_compatible") || this.get("isJadeStore") ? null : n.get("cat_paw_jade_not_available_on_classic_flavor_text")
                })),
                subtitle: i("itemSubtitle", "purchaseSuccess", "tra.cat_paw_modal_item_unlocked_title", (function() {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.getBoostDescription = function(e, t) {
                const n = e.tags || [],
                    a = e.duration || 0;
                let s;
                if (n.includes("IP_WIN") || n.includes("XP_WIN")) s = a > 1 ? "cat_paw_rental_duration_type_wins" : "cat_paw_rental_duration_type_win";
                else {
                    if (!n.includes("IP") && !n.includes("XP")) return null;
                    s = a > 1 ? "cat_paw_rental_duration_type_days" : "cat_paw_rental_duration_type_day"
                }
                return t.formatString("cat_paw_boost_prepurchase_message", {
                    count: a,
                    daysOrWins: t.get(s)
                })
            }, t.getBoostName = function(e, t) {
                const n = e.tags || [],
                    a = e.duration || 0;
                let s, l;
                const o = "IP_WIN";
                if (n.includes(o) || n.includes("XP_WIN")) s = n.includes(o) ? t.get("cat_paw_boost_type_ip") : t.get("cat_paw_boost_type_xp"), l = a > 1 ? "cat_paw_boost_duration_wins_label_plural" : "cat_paw_boost_duration_wins_label";
                else {
                    if (!n.includes("IP") && !n.includes("XP")) return null;
                    s = n.includes("IP") ? t.get("cat_paw_boost_type_ip") : t.get("cat_paw_boost_type_xp"), l = a > 1 ? "cat_paw_boost_duration_days_label_plural" : "cat_paw_boost_duration_days_label"
                }
                return t.formatString(l, {
                    count: a,
                    boostType: s
                })
            }
            ...
            e.exports = a.HTMLBars.template({
                id: "5RoNJRn/",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\content-description-component\\\\layout.hbs\\" style-path=\\"null\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\content-description-component\\\\index.js\\" "],["text","\\n"],["open-element","lol-uikit-content-block",[]],["static-attr","padding","small"],["static-attr","class","item-description"],["flush-element"],["text","\\n  "],["open-element","h3",[]],["static-attr","class","title-text"],["flush-element"],["append",["unknown",["itemName"]],false],["close-element"],["text","\\n  "],["open-element","p",[]],["flush-element"],["append",["unknown",["subtitle"]],false],["close-element"],["text","\\n"],["block",["if"],[["get",["enrichedFlavorText"]]],null,1],["block",["if"],[["get",["awInfo","isExtension"]]],null,0],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","br",[]],["flush-element"],["close-element"],["text","\\n    "],["open-element","p",[]],["static-attr","class","aw-extension-info"],["flush-element"],["append",["unknown",["awInfo","extensionMessage"]],false],["close-element"],["text","\\n    "],["open-element","p",[]],["static-attr","class","aw-expiry-info"],["flush-element"],["append",["unknown",["awInfo","expiryMessage"]],false],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","p",[]],["static-attr","class","map-availability-info"],["flush-element"],["append",["unknown",["enrichedFlavorText"]],false],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                layout: n(102),
                style: n(103),
                showBoostRefundDisclaimer: l("itemPurchaseOption.inventoryType", "awInfo.showSkinList", (function() {
                    return "BOOST" === this.get("itemPurchaseOption.inventoryType") && !this.get("awInfo.showSkinList")
                })),
            ...
            e.exports = a.HTMLBars.template({
                id: "nsfmMFod",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\price-details-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\price-details-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\price-details-component\\\\index.js\\" "],["text","\\n"],["open-element","lol-uikit-content-block",[]],["dynamic-attr","padding",["concat",[["unknown",["paddingWithDefault"]]]]],["static-attr","class","paw-price-details"],["flush-element"],["text","\\n"],["block",["if"],[["get",["showBoostRefundDisclaimer"]]],null,1],["text","  "],["append",["helper",["digital-goods-disclaimer"],null,[["class"],["paw-price-details-digital-goods-disclaimer"]]],false],["text","\\n"],["block",["each"],[["get",["purchaseOptions"]]],null,0],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["append",["helper",["price-button"],null,[["itemPurchaseOption","wallet","purchaseOption","purchaseEnabled","purchase"],[["get",["itemPurchaseOption"]],["get",["wallet"]],["get",["purchaseOption"]],["get",["purchaseEnabled"]],"purchase"]]],false],["text","\\n"]],"locals":["purchaseOption"]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-price-details-boost-refund-disclaimer digital-goods-disclaimer"],["flush-element"],["text","\\n      "],["append",["unknown",["tra","cat_paw_boost_refund_disclaimer_text"]],false],["text","\\n      "],["open-element","a",[]],["static-attr","class","digital-goods-disclaimer-url"],["dynamic-attr","href",["concat",[["unknown",["tra","cat_paw_boost_refund_disclaimer_url"]]]]],["static-attr","target","_blank"],["static-attr","rel","noopener noreferrer"],["flush-element"],["text","\\n        "],["append",["unknown",["tra","cat_paw_boost_refund_disclaimer_learn_more"]],false],["text","\\n      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                initDataBindings() {
                    c.observe(i, this, (function(e) {
                        this.set("isRPTopUpEnabled", e)
                    }))
                },
                willDestroy() {
                    c.unobserve(i, this), this.closeRpTopUpModal()
                },
                closeRpTopUpModal() {
                ...
                newBalance: l("tra.cat_paw_purchase_cant_afford_message", "aggregatedPriceDetails", "wallet", (function() {
                    ...
                    return e.forEach((e => {
                        ...
                        Object.prototype.hasOwnProperty.call(t, a) ? n.push({
                            currencyType: a,
                            remaining: t[a] - s,
                ...
                showRPTopUpModal: function() {
                    const e = -1 * this.get("cantAffordBalance").remaining,
                        ...
                        s = this.get("itemPurchaseOption");
                    s.price = this.get("aggreatedPriceDetails");
                    const l = btoa(encodeURIComponent(JSON.stringify(s))),
                        o = a.componentFactory.create("PAWRPTopUpModalComponent", {
                            price: e,
                            itemName: t
                        }),
                        i = a.modalManager.add({
                            type: "DialogConfirm",
                            data: {
                                contents: o.domNode,
                    ...
                    this.set("RPTopUpModalComponent", o), this.set("RPTopUpModal", i)
                },
                actions: {
            ...
            const {
                Component: o,
                computed: i
            } = a.Ember, c = a.dataBinding.bindTo((0, a.getProvider)().getSocket());
            ...
            const m = o.extend({
                ...
                init() {
                    ...
                    })), c.get("/system/v1/builds").then((e => {
                        this.set("patchline", e?.patchline)
                    }))
                },
                isKREnv: i("region", "patchline", (function() {
                    return "KR" === this.get("region") || this.get("patchline")?.endsWith("_KR") || this.get("patchline")?.endsWith("_KRmac")
                })),
                krPurchaseSuccessMessage: i("isKREnv", (function() {
                    if (this.get("isKREnv")) return a.Ember.String.htmlSafe(this.get("tra.cat_paw_kr_purchase_success_message"))
                })),
                unlockSuccessMessage: i("itemPurchaseOption.{inventoryType,subInventoryType,name}", "tra.cat_paw_modal_item_unlocked_details", (function() {
                    let e = "cat_paw_unlock_message";
                    const t = this.get("tra"),
                        n = this.get("itemPurchaseOption");
                    let a = this.get("itemPurchaseOption.name");
                    if (n && n.inventoryType) {
                        ...
                        if ("BOOST" === s) {
                            const e = (0, l.getBoostName)(n, t);
                            e && (a = e)
                        }
                        if (e = r(t, `cat_paw_unlock_message_${s.toLowerCase()}`, e), o) {
                            e = r(t, `cat_paw_unlock_message_${s.toLowerCase()}_${o.toLowerCase()}`, e)
                        }
                    }
            ...
            e.exports = a.HTMLBars.template({
                id: "DFdo0Jbi",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-unlocked-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-unlocked-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\item-unlocked-component\\\\index.js\\" "],["text","\\n"],["open-element","p",[]],["static-attr","class","unlock-success-message"],["flush-element"],["append",["unknown",["unlockSuccessMessage"]],false],["close-element"],["text","\\n"],["block",["if"],[["get",["isKREnv"]]],null,0],["open-element","div",[]],["static-attr","class","done-button-row"],["flush-element"],["text","\\n  "],["open-element","lol-uikit-flat-button",[]],["dynamic-attr","onclick",["helper",["action"],[["get",[null]],"closeModal"],null],null],["static-attr","data-dd-action-name","button.store.paw.done"],["flush-element"],["text","\\n    "],["append",["unknown",["tra","cat_paw_modal_button_done"]],false],["text","\\n  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","  "],["open-element","p",[]],["static-attr","class","kr-purchase-success-message"],["flush-element"],["append",["unknown",["krPurchaseSuccessMessage"]],false],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                classNameBindings: ["bundleUpsell:bundle-upsell"],
            ...
            const {
                ...
                videoStartTime: null,
                willDestroy() {
                    if (this._super(...arguments), this.get("isVideoMode") && this.get("videoStartTime")) {
                        const e = Math.floor((Date().getTime() - this.get("videoStartTime")) / 1e3),
                            t = {
                                id: s.TELEMETRY_EVENT_ID.LOL_PAW_NUMERIC,
                                name: "videos_watched_seconds",
                                value: e
                            };
                        a.Telemetry.sendCustomData(s.TELEMETRY_EVENT_NAME, t)
                    }
                },
                actions: {
                    toggleSkinPreview() {
                        this.set("isVideoMode", !this.get("isVideoMode"));
                        const e = this.get("isVideoMode");
                        "function" == typeof this.onToggle && this.onToggle(e);
                        const t = e ? s.TELEMETRY_BUTTON_NAMES.VIDEO_TOGGLE : s.TELEMETRY_BUTTON_NAMES.SPLASH_TOGGLE,
                            n = {
                                id: s.TELEMETRY_EVENT_ID.LOL_PAW_CLICK,
                                buttonName: t
                            };
                        if (a.Telemetry.sendCustomData(s.TELEMETRY_EVENT_NAME, n), e && this.set("videoStartTime", (new Date).getTime()), !e && this.get("videoStartTime")) {
                            const e = (new Date).getTime() - this.get("videoStartTime"),
                                t = Math.floor(e / 1e3),
                                n = {
                                    id: s.TELEMETRY_EVENT_ID.LOL_PAW_NUMERIC,
                                    name: "videos_watched_seconds",
                            ...
                            a.Telemetry.sendCustomData(s.TELEMETRY_EVENT_NAME, n), this.set("videoStartTime", null)
                        }
                    }
                }
            });
            ...
            e.exports = a.HTMLBars.template({
                id: "vd5R1mS2",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\preview-video-toggle-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\preview-video-toggle-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\preview-video-toggle-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","media-toggle"],["dynamic-attr","onClick",["helper",["action"],[["get",[null]],"toggleSkinPreview"],null],null],["flush-element"],["text","\\n  "],["open-element","button",[]],["static-attr","type","button"],["dynamic-attr","class",["concat",["media-toggle-button splash ",["helper",["if"],[["get",["isVideoMode"]],"inactive","active"],null]]]],["flush-element"],["text","\\n    "],["open-element","img",[]],["dynamic-attr","src",["concat",["/fe/lol-static-assets/images/",["helper",["if"],[["get",["isVideoMode"]],"splash-inactive.png","splash-active.png"],null]]]],["static-attr","alt","Splash Icon"],["flush-element"],["close-element"],["text","\\n    "],["append",["unknown",["tra","cat_paw_preview_video_toggle_splash"]],false],["text","\\n  "],["close-element"],["text","\\n\\n  "],["open-element","button",[]],["static-attr","type","button"],["dynamic-attr","class",["concat",["media-toggle-button video ",["helper",["if"],[["get",["isVideoMode"]],"active","inactive"],null]]]],["flush-element"],["text","\\n    "],["open-element","img",[]],["dynamic-attr","src",["concat",["/fe/lol-static-assets/images/",["helper",["if"],[["get",["isVideoMode"]],"video-active.png","video-inactive.png"],null]]]],["static-attr","alt","Skin Icon"],["flush-element"],["close-element"],["text","\\n    "],["append",["unknown",["tra","cat_paw_preview_video_toggle_preview"]],false],["text","\\n  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                decoratorBadge: o("item.data.item", (function() {
                    ...
                    const t = (0, s.getExtraDecoratorBadges)(e.data.item);
                    return t?.[0] || null
                }))
            });
            e.exports = i
            ...
            e.exports = a.HTMLBars.template({
                id: "PvrfzM3A",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\badge-overlay-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\badge-overlay-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\badge-overlay-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","badge-overlay-container"],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","badge-overlay-left"],["flush-element"],["text","\\n"],["block",["if"],[["get",["decoratorBadge"]]],null,0],["text","  "],["close-element"],["text","\\n"],["close-element"],["text","\\n"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      "],["open-element","div",[]],["static-attr","class","item-extra-decorator-badge"],["dynamic-attr","style",["concat",["background-image: ",["unknown",["decoratorBadge","imageUrl"]]]]],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                loadFailed: !1,
                searchTerm: "",
                isLoading: l("skinNames", "loadFailed", (function() {
                    return !this.get("skinNames") && !this.get("loadFailed")
                })),
                showLoadError: l("skinNames.[]", "loadFailed", (function() {
                    return this.get("loadFailed") || 0 === this.get("skinNames.length")
                })),
                filteredSkinNames: l("skinNames.[]", "searchTerm", (function() {
                    const e = this.get("skinNames") || [],
                        t = this.get("searchTerm").toLowerCase();
                    return t ? e.filter((e => e.toLowerCase().includes(t))) : e
                })),
                showNoSearchResults: l("isLoading", "showLoadError", "filteredSkinNames", (function() {
                    return !this.get("isLoading") && !this.get("showLoadError") && 0 === this.get("filteredSkinNames.length")
                })),
                didInsertElement() {
                    this._super(...arguments), this.get("purchaseWidgetService").getAwSkins().then((e => {
                        this.isDestroying || this.isDestroyed || this.set("skinNames", e)
                    })).catch((e => {
                        a.logger.error("Failed to load the ARAM Wardrobe skin list: ", e), this.isDestroying || this.isDestroyed || this.set("loadFailed", !0)
                    }))
                },
                actions: {
                    updateSearchTerm(e) {
                        this.set("searchTerm", e)
                    },
                    goBackToMain() {
                        this.get("goBack")()
                    }
            ...
            e.exports = a.HTMLBars.template({
                id: "GtwQ70PC",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\aw-skin-list-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\aw-skin-list-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\aw-skin-list-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-aw-skin-list-back-button"],["modifier",["action"],[["get",[null]],"goBackToMain"]],["flush-element"],["close-element"],["text","\\n"],["open-element","lol-uikit-content-block",[]],["static-attr","class","paw-aw-skin-list-header"],["flush-element"],["text","\\n  "],["open-element","h4",[]],["static-attr","class","paw-aw-skin-list-title"],["flush-element"],["append",["unknown",["tra","cat_paw_aw_skin_list_header"]],false],["close-element"],["text","\\n"],["close-element"],["text","\\n"],["block",["if"],[["get",["isLoading"]]],null,6,5]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","          "],["open-element","p",[]],["static-attr","class","paw-aw-skin-list-name"],["flush-element"],["append",["get",["skinName"]],false],["close-element"],["text","\\n"]],"locals":["skinName"]},{"statements":[["text","    "],["open-element","lol-uikit-scrollable",[]],["static-attr","class","paw-aw-skin-list-scrollable"],["static-attr","overflow-masks","enabled"],["flush-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","paw-aw-skin-list-names"],["flush-element"],["text","\\n"],["block",["each"],[["get",["filteredSkinNames"]]],null,0],["text","      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-aw-skin-list-no-results"],["flush-element"],["append",["unknown",["tra","cat_paw_aw_skin_list_no_search_results"]],false],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","paw-aw-skin-list-search"],["flush-element"],["text","\\n    "],["open-element","lol-uikit-flat-input",[]],["flush-element"],["text","\\n      "],["open-element","input",[]],["static-attr","type","search"],["static-attr","name","search"],["dynamic-attr","placeholder",["unknown",["tra","cat_paw_aw_skin_list_search_placeholder"]],null],["dynamic-attr","value",["unknown",["searchTerm"]],null],["dynamic-attr","oninput",["helper",["action"],[["get",[null]],"updateSearchTerm"],[["value"],["target.value"]]],null],["static-attr","autocomplete","off"],["static-attr","autocorrect","off"],["static-attr","autocapitalize","off"],["static-attr","spellcheck","false"],["flush-element"],["close-element"],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n"],["block",["if"],[["get",["showNoSearchResults"]]],null,2,1]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","paw-aw-skin-list-error"],["flush-element"],["append",["unknown",["tra","cat_paw_aw_skin_list_load_error"]],false],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["showLoadError"]]],null,4,3]],"locals":[]},{"statements":[["text","  "],["open-element","div",[]],["static-attr","class","spinner-wrapper"],["flush-element"],["text","\\n    "],["append",["helper",["uikit-spinner"],null,[["src"],["/fe/lol-paw/images/spinner.png"]]],false],["text","\\n  "],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                Component: c,
                computed: r
            } = s.Ember, m = "linear-gradient(to top, black 0px, rgba(0,0,0, 0.8) 310px, transparent 80%)", p = c.extend({
                ...
                backgroundImageHoverIn: r("backgroundImage", (function() {
                    const e = this.get("backgroundImage");
                    return `linear-gradient(180deg, rgba(240, 230, 210, 0.1) 0%, transparent 100%), ${m}, url(${e})`
                })),
            ...
            const {
                ...
                layout: n(139),
                style: n(140),
                hasDiscount: m("catalogItemPurchaseOption.sale.discount", (function() {
                    return this.get("catalogItemPurchaseOption.sale.discount") > 0
                })),
                formattedBundledItems: m("catalogItemPurchaseOption.bundledItems", "catalogItemPurchaseOption.hiddenBundleItems", "isJadeStore", (function() {
                    const e = this.get("catalogItemPurchaseOption.hiddenBundleItems");
                    return this.get("catalogItemPurchaseOption.bundledItems").filter((t => !e || !e.find((e => t.itemId === e.itemId && t.inventoryType === e.inventoryType)))).map((e => {
                        const {
                            inventoryType: t,
                            itemId: n,
                            assets: a,
                            ...
                            CHAMPION_SKIN: p
                        } = l.PAW.INVENTORY_TYPES, {
                            iconPath: u,
                            tilePath: d
                        } = a, h = m.quantity, g = e.owned, f = (0, c.getStatstoneRarity)(e), _ = this.get("isJadeStore"), E = (0, c.getItemSubtitle)(e, this.get("tra")), w = (0, c.getMapAvailability)(e, this.get("tra"), _), T = h > 1 ? this.get("tra").formatString("cat_paw_bundle_item_quantity_and_name", {
                            quantity: h,
                            name: e.name
                        }) : e.name;
                        let y = u || d || e.imagePath || i.NOT_FOUND_ICON;
                        return t === p && r !== o.default.CHROMA && (y = d || u || e.imagePath || i.NOT_FOUND_ICON), {
                            itemBackgroundPath: t === p ? i.DEFAULT_BACKGROUND_PATH : void 0,
                            imagePath: y,
                            itemId: n,
                            owned: g,
                            itemRarity: f,
                ...
                bundleEnrichedFlavorText: m("catalogItemPurchaseOption.bundledItems.@each.tags", "catalogItemPurchaseOption.bundledItems.@each.inventoryType", "purchaseSuccess", "isJadeStore", (function() {
                    if (this.get("purchaseSuccess") || this.get("isJadeStore")) return null;
                    const e = this.get("catalogItemPurchaseOption.bundledItems") || [],
                        t = this.get("tra");
                    return e.some((e => {
                        if (i.EXCLUDED_JADE_DISCLAIMER_INVENTORY_TYPES.includes(e.inventoryType)) return !1;
                        const t = e.tags || [];
                        return !t.includes("jade_exclusive") && !t.includes("jade_compatible")
                    })) ? t.get("cat_paw_jade_bundle_partial_incompatibility_flavor_text") : null
                })),
                showBundleDescription: m("catalogItemPurchaseOption.item.description", "bundleEnrichedFlavorText", (function() {
                    return !(!this.get("catalogItemPurchaseOption.item.description") && !this.get("bundleEnrichedFlavorText"))
                })),
                isChromaBundle: s.Ember.computed("catalogItemPurchaseOption.item.subInventoryType", (function() {
                    return (0, c.isChromaBundle)(this.get("catalogItemPurchaseOption.item.subInventoryType"))
                })),
                displayBundleNonRefundableDisclaimer: s.Ember.computed("catalogItemPurchaseOption.item.inventoryType", "catalogItemPurchaseOption.item.subInventoryType", "alwaysShowPurchaseDisclaimer", (function() {
                    const e = this.get("catalogItemPurchaseOption.item.inventoryType") || "",
                        t = this.get("catalogItemPurchaseOption.item.subInventoryType") || "",
                        n = this.get("alwaysShowPurchaseDisclaimer");
                    return (0, c.shouldDisplayBundleNonRefundableDisclaimer)(e, t, n)
                })),
                showPrice: m("errorMessage", (function() {
                    return !this.get("errorMessage")
                })),
                infoContainerWidthClass: m("catalogItemPurchaseOption.pawSplashImage", (function() {
                    return !!this.get("catalogItemPurchaseOption.pawSplashImage") ? "paw-bundle-root-info-container-half-size" : "paw-bundle-root-info-container-full-size"
                })),
                actions: {
                    purchase: function(e) {
                        this.sendAction("purchase", e)
            ...
            const {
                ...
                didInsertElement() {
                    this._super(...arguments);
                    const e = this.get("element").querySelector(".paw-bundle-description-text");
                    e && this.set("isOverflowing", e.scrollHeight > e.clientHeight)
                },
                descriptionIsShrunk: l("isOverflowing", "seeMoreIsExpanded", (function() {
                    return this.get("isOverflowing") && !this.get("seeMoreIsExpanded")
                })),
                descriptionIsExpanded: l("isOverflowing", "seeMoreIsExpanded", (function() {
                    return this.get("isOverflowing") && this.get("seeMoreIsExpanded")
                })),
                actions: {
                    toggleSeeMore() {
            ...
            const {
                Component: l,
                computed: o
            } = a.Ember, i = "/lol-client-config/v3/client-config/lol.client_settings.purchase_widget.discount_disabled", c = a.dataBinding.bindTo((0, a.getProvider)().getSocket()), r = l.extend({
                init() {
                ...
                currencyIconPath: o("bundleCurrency", (function() {
                    ...
                    return "IP" === this.get("bundleCurrency") ? `${e}/blue-essence-icon.svg` : `${e}/riot-points-icon.svg`
                })),
                translatedCurrencyName: o("bundleCurrency", (function() {
                    return this.get(`tra.cat_paw_modal_currency_${this.get("bundleCurrency")?.toLowerCase()}`)
                })),
                catalogItemPrimaryPurchaseOption: o("catalogItemPurchaseOption.purchaseOptions.0.priceDetails", (function() {
                    return this.get("catalogItemPurchaseOption.purchaseOptions.0.priceDetails")
                })),
                adjustedTotalAmount: o("catalogItemPrimaryPurchaseOption", "bundleCurrency", (function() {
                    const e = this.get("catalogItemPrimaryPurchaseOption"),
                        t = this.get("bundleCurrency");
                    return (0, s.calculateAdjustedTotalAmount)(e, t)
                })),
                isBundle: o("catalogItemPurchaseOption.bundledItems", (function() {
                    return this.get("catalogItemPurchaseOption.bundledItems").length > 0
                })),
                unadjustedTotalAmount: o("bundleCurrency", "catalogItemPurchaseOption.bundledItems", "catalogItemPrimaryPurchaseOption", (function() {
                    const e = this.get("bundleCurrency"),
                        t = this.get("catalogItemPurchaseOption.bundledItems");
                    return this.get("isBundle") ? (0, s.calculateUnadjustedTotalAmount)(t, e) : (0, s.calculateUnadjustedTotalAmountNonBundle)(this.get("catalogItemPrimaryPurchaseOption"))
                })),
                discountPercentage: o("adjustedTotalAmount", "unadjustedTotalAmount", (function() {
                    const e = this.get("adjustedTotalAmount"),
                        t = this.get("unadjustedTotalAmount");
                    return (0, s.calculateDiscountPercentage)(e, t)
                })),
                hasDiscount: o("discountPercentage", (function() {
                    return this.get("discountPercentage") > 0
                })),
                displayDiscount: a.Ember.computed("catalogItemPurchaseOption", "discountDisabledIds", "isBundle", (function() {
                    const e = this.get("discountDisabledIds");
                    if (!this.get("isBundle")) return !0;
                    if (!e) return !1;
                    const t = this.get("catalogItemPurchaseOption"),
                        n = t?.item?.itemId;
                    return !e.includes(n)
                }))
            });
            ...
            e.exports = a.HTMLBars.template({
                id: "oC4qBprF",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-price-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-price-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-price-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-price-total"],["flush-element"],["append",["unknown",["tra","cat_paw_bundled_discount_unadjusted_title"]],false],["close-element"],["text","\\n"],["open-element","img",[]],["static-attr","class","paw-bundle-price-currency-icon"],["dynamic-attr","src",["unknown",["currencyIconPath"]],null],["flush-element"],["close-element"],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-price-amount"],["flush-element"],["append",["unknown",["adjustedTotalAmount"]],false],["text"," "],["append",["unknown",["translatedCurrencyName"]],false],["close-element"],["text","\\n"],["block",["if"],[["get",["displayDiscount"]]],null,1]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-bundle-price-discount"],["flush-element"],["append",["unknown",["unadjustedTotalAmount"]],false],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-price-percent"],["flush-element"],["text","-"],["append",["unknown",["discountPercentage"]],false],["text","%"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["block",["if"],[["get",["hasDiscount"]]],null,0]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                ...
                termsOfServiceDisclaimer: i((function() {
                    ...
                    return s.Ember.String.htmlSafe(e.formatString("cat_paw_bundle_tos_disclaimer", {
                        disclaimerLink: t
                    }))
                })),
                purchaseRestricted: s.Ember.computed("validationErrors", (function() {
            ...
            const {
                ...
                CHAMPION_SKIN: u
            } = l.PAW.INVENTORY_TYPES, d = 1, h = 2, g = 3, f = 4, _ = m.extend({
                ...
                bundlePurchaseOptionsCache: {},
                init() {
                    this._super(...arguments)
                },
                didReceiveAttrs() {
                    this._super(...arguments);
                    const e = this.get("selectedBundle");
                    e && e.data && this.set("selectedBundlePurchaseOption", e.data)
                },
                pawSessionId: p((function() {
                    return `paw_${Date.now()}_${Math.random().toString(36).substr(2,9)}`
                })),
                backgroundImageUrl: p("catalogItemPurchaseOption.item.assets.splashPath", "catalogItemPurchaseOption.pawSplashImage", (function() {
                    const e = this.get("catalogItemPurchaseOption.item.assets.splashPath");
                    return this.get("catalogItemPurchaseOption.pawSplashImage") || e || c.DEFAULT_BACKGROUND_PATH
                })),
                bundleOverlayImageUrl: p("selectedBundlePurchaseOption", (function() {
                    const e = this.get("selectedBundlePurchaseOption");
                    if (!e) return null;
                    const t = e.pawSplashImage;
                    return e?.item?.subInventoryType !== o.default.CHROMA_BUNDLE && t ? t : null
                })),
                subTitle: p("selectedBundle", "catalogItemPurchaseOption", (function() {
                    const e = this.get("selectedBundle"),
                        t = this.get("tra");
                    if (e) return (0, r.getItemSubtitle)(e.data.item, t);
                    const n = this.get("catalogItemPurchaseOption.item");
                    return (0, r.getItemSubtitle)(n, t)
                })),
                formattedBundledItems: p("catalogItemPurchaseOption", "selectedBundle", (function() {
                    const e = this.get("catalogItemPurchaseOption.item"),
                        t = this.get("catalogItemPurchaseOption.hiddenBundleItems"),
                        n = this.get("catalogItemPurchaseOption.dependencies") || [],
                        a = this.get("selectedBundle.data");
                    let s;
                    s = a && a.bundledItems ? a.bundledItems.map((e => ({
                        ...e.item,
                        ...e
                    }))) : this.get("catalogItemPurchaseOption.bundledItems") || [];
                    let i = [];
                    i = e && n.length > 0 ? [...n, ...s] : s;
                    const m = (a ? s : [e, ...i].filter(Boolean)).filter((e => !t || !t.find((t => e.itemId === t.itemId && e.inventoryType === t.inventoryType)))).map((e => {
                        const {
                            inventoryType: t,
                            itemId: n,
                            assets: a,
                            ...
                            iconPath: u,
                            tilePath: d
                        } = a || {}, h = m ? m.quantity : 1, g = e.owned, f = (0, r.getStatstoneRarity)(e), _ = (0, r.getItemSubtitle)(e, this.get("tra")), E = h > 1 ? this.get("tra").formatString("cat_paw_bundle_item_quantity_and_name", {
                            quantity: h,
                            name: e.name
                        }) : e.name;
                        let w = u || d || e.imagePath || c.NOT_FOUND_ICON;
                        t === p && i !== o.default.CHROMA && (w = d || u || e.imagePath || c.NOT_FOUND_ICON);
                        let T = null;
                        if (!g) {
                            const a = this.get("catalogItemPurchaseOption");
                            if (a && a.purchaseOptions && a.purchaseOptions.length > 0) {
                                const e = a.purchaseOptions[0];
                                if (e.priceDetails && e.priceDetails.length > 0) {
                                    const a = e.priceDetails.find((e => e.itemKey && e.itemKey.itemId === n && e.itemKey.inventoryType === t));
                                    a && a.price && (T = {
                                        price: a.price.price,
                                        currencyType: a.price.currencyType
                                    })
                                }
                            }
                            if (!T && e.prices && e.prices.length > 0) {
                                const t = e.prices[0];
                                T = {
                                    price: t.cost,
                                    currencyType: t.currency
                                }
                            }
                        }
                        return {
                            itemBackgroundPath: t === p || t === l.PAW.INVENTORY_TYPES.CHAMPION ? c.DEFAULT_BACKGROUND_PATH : void 0,
                            imagePath: w,
                            itemId: n,
                            owned: g,
                            itemRarity: f,
                ...
                isChromaBundle: s.Ember.computed("selectedBundle.data.item.subInventoryType", (function() {
                    return (0, r.isChromaBundle)(this.get("selectedBundle.data.item.subInventoryType"))
                })),
                displayBundleNonRefundableDisclaimer: s.Ember.computed("catalogItemPurchaseOption.item.inventoryType", "catalogItemPurchaseOption.item.subInventoryType", "alwaysShowPurchaseDisclaimer", (function() {
                    const e = this.get("catalogItemPurchaseOption.item.inventoryType") || "",
                        t = this.get("catalogItemPurchaseOption.item.subInventoryType") || "",
                        n = this.get("alwaysShowPurchaseDisclaimer");
                    return (0, r.shouldDisplayBundleNonRefundableDisclaimer)(e, t, n)
                })),
                limitedTimeBadge: p("catalogItemPurchaseOption.item", "selectedBundle.inactiveDate", "selectedBundle.data.item", (function() {
                    const e = this.get("selectedBundle"),
                        t = this.get("catalogItemPurchaseOption"),
                        n = this.get("tra");
                    return e ? (0, r.getLimitedTimeBadge)(e?.data?.item, n) : t?.item ? (0, r.getLimitedTimeBadge)(t.item, n) : null
                })),
                dynamicCatalogItemPurchaseOption: p("catalogItemPurchaseOption", "selectedBundlePurchaseOption", "catalogItemPurchaseOption.dependencies", (function() {
                    const e = this.get("catalogItemPurchaseOption"),
                        t = this.get("selectedBundlePurchaseOption");
                    return t || e
                })),
                allItemsToShow: p("catalogItemPurchaseOption", "relatedBundlesToShow", "bundlePurchaseOptionsCache", (function() {
                    const e = this.get("catalogItemPurchaseOption"),
                        t = this.get("relatedBundlesToShow") || [],
                        n = this.get("bundlePurchaseOptionsCache"),
                        a = this.get("purchaseWidgetService"),
                        o = [];
                    return e && o.push(this._createItemData(e)), t.forEach((e => {
                        o.push(this._createItemData(e));
                        const t = e.item.itemId;
                        e.item.inventoryType !== l.PAW.INVENTORY_TYPES.BUNDLES || n[t] || a.getItem(t, e.item.inventoryType).then((e => {
                            const a = (0, r.transformCatalogItemMetadata)(e, this.get("purchaseWidgetService.skins"));
                            n[t] = a, this.notifyPropertyChange("bundlePurchaseOptionsCache")
                        })).catch((e => {
                            s.logger.error("Failed to fetch bundle purchase options: ", e)
                        }))
                    })), o.sort(((e, t) => e.sortPriority - t.sortPriority)), o
                })),
                selectedItem: p("selectedBundle", "catalogItemPurchaseOption", (function() {
                    const e = this.get("selectedBundle"),
                        t = this.get("catalogItemPurchaseOption");
                    return e || (t && t.item.inventoryType === u ? {
                        id: t.item.itemId,
                        inventoryType: t.item.inventoryType,
                        data: t
                    } : null)
                })),
                _createItemData(e) {
                    const t = e.item.inventoryType,
                        n = (this.get("tra"), this.get("bundlePurchaseOptionsCache"));
                    if (t === u) {
                        const n = (0, r.getItemPriceDetails)(e)?.[0];
                        return {
                            id: e.item.itemId,
                            inventoryType: t,
                            subInventoryType: e.item.subInventoryType,
                            name: e.item.name,
                            imagePath: e.item?.assets?.tilePath || e.assets.tilePath,
                            price: n?.price?.price,
                            currencyType: n?.price?.currencyType,
                            inactiveDate: e.inactiveDate,
                            data: e,
                            sortPriority: d
                        }
                    }
                    if (t === l.PAW.INVENTORY_TYPES.BUNDLES) {
                        const a = e.item.itemId,
                            s = e.item.subInventoryType,
                            l = n[a] || e;
                        let i = f;
                        return s === o.default.BORDER_SET_BUNDLE ? i = h : (0, r.isChromaBundle)(s) && (i = g), {
                            id: e.item.itemId,
                            inventoryType: t,
                            subInventoryType: s,
                            name: e.item.name,
                            imagePath: e.item.imagePath,
                            price: e.bundleFinalPrice,
                            currencyType: "RP",
                            inactiveDate: e.item.inactiveDate,
                            data: l,
                            sortPriority: i
                        }
                    }
                ...
                actions: {
                    purchase: function(e) {
                        const t = e.priceDetails?.[0],
                            n = t?.itemKey?.itemId || e.item?.itemId,
                            a = t?.itemKey?.inventoryType || e.item?.inventoryType;
                        s.Telemetry.sendCustomData(i.TELEMETRY_EVENT_NAME, {
                            id: i.TELEMETRY_EVENT_ID.RELATED_ITEM_PURCHASE,
                            itemId: n,
                            inventoryType: a,
                            source: this.get("source"),
                            pawSourceId: this.get("catalogItemPurchaseOption.item.itemId"),
                            pawSessionId: this.get("pawSessionId")
                        }), this.sendAction("purchase", e)
                    },
                    selectCurrentItem: function(e) {
                        if (e && e.inventoryType === l.PAW.INVENTORY_TYPES.BUNDLES) {
                            this.set("selectedBundle", e);
                            const t = this.get("bundlePurchaseOptionsCache"),
                                n = e.data.item.itemId,
                                a = e.data.item.inventoryType;
                            if (s.Telemetry.sendCustomData(i.TELEMETRY_EVENT_NAME, {
                                    id: i.TELEMETRY_EVENT_ID.RELATED_ITEM_CLICK,
                                    itemId: n,
                                    inventoryType: a,
                                    source: this.get("source"),
                                    pawSourceId: this.get("catalogItemPurchaseOption.item.itemId"),
                                    pawSessionId: this.get("pawSessionId")
                                }), t[n]) this.set("selectedBundlePurchaseOption", t[n]);
                            else {
                                this.get("purchaseWidgetService").getItem(n, a).then((e => {
                                    const a = (0, r.transformCatalogItemMetadata)(e, this.get("purchaseWidgetService.skins"));
                                    t[n] = a, this.set("selectedBundlePurchaseOption", a)
                                })).catch((e => {
                                    s.logger.error("Failed to get bundle purchase option: ", e), this.set("selectedBundlePurchaseOption", null)
                                }))
                            }
                        } else this.set("selectedBundle", null), this.set("selectedBundlePurchaseOption", null)
                    }
                }
            });
            e.exports = _
            ...
            e.exports = a.HTMLBars.template({
                id: "jglfUGr9",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-upsell-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-upsell-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\bundle\\\\bundle-upsell-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-left-section"],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-image-container"],["flush-element"],["text","\\n    "],["open-element","img",[]],["dynamic-attr","class",["concat",["paw-bundle-upsell-image fade-in ",["helper",["if"],[["get",["bundleOverlayImageUrl"]],"blurred"],null]]]],["dynamic-attr","src",["unknown",["backgroundImageUrl"]],null],["flush-element"],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-image-container-shroud"],["flush-element"],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-bottom-gradient"],["flush-element"],["close-element"],["text","\\n"],["block",["if"],[["get",["isChromaBundle"]]],null,4],["block",["if"],[["get",["bundleOverlayImageUrl"]]],null,3],["block",["if"],[["get",["limitedTimeBadge"]]],null,2],["text","  "],["close-element"],["text","\\n"],["block",["if"],[["get",["relatedBundlesToShow","length"]]],null,1],["close-element"],["text","\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-vertical-line"],["flush-element"],["close-element"],["text","\\n\\n"],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-info-container"],["flush-element"],["text","\\n  "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-title"],["flush-element"],["text","\\n    "],["append",["helper",["bundle-title"],null,[["title","subtitle"],[["get",["catalogItemPurchaseOption","item","name"]],["get",["catalogItemPurchaseOption","item","subtitle"]]]]],false],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-sub-title"],["flush-element"],["append",["unknown",["subTitle"]],false],["close-element"],["text","\\n  "],["close-element"],["text","\\n\\n  "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-separator"],["flush-element"],["close-element"],["text","\\n\\n  "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-shrinking-wrapper"],["flush-element"],["text","\\n"],["block",["if"],[["get",["catalogItemPurchaseOption","item","description"]]],null,0],["text","    "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-items fade-in"],["flush-element"],["text","\\n      "],["append",["helper",["bundle-items"],null,[["catalogItemPurchaseOption","formattedBundledItems","displayBundleNonRefundableDisclaimer","alwaysShowPurchaseDisclaimer","showPrice","showItemPrices"],[["get",["catalogItemPurchaseOption"]],["get",["formattedBundledItems"]],["get",["displayBundleNonRefundableDisclaimer"]],["get",["alwaysShowPurchaseDisclaimer"]],true,true]]],false],["text","\\n    "],["close-element"],["text","\\n  "],["close-element"],["text","\\n\\n  "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-separator"],["flush-element"],["close-element"],["text","\\n  \\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-price fade-in"],["flush-element"],["text","\\n      "],["append",["helper",["bundle-price"],null,[["catalogItemPurchaseOption"],[["get",["dynamicCatalogItemPurchaseOption"]]]]],false],["text","\\n    "],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-separator"],["flush-element"],["close-element"],["text","\\n    "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-footer-wrapper"],["flush-element"],["text","\\n      "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-footer"],["flush-element"],["text","\\n        "],["append",["helper",["bundle-purchase"],null,[["catalogItemPurchaseOption","wallet","purchase","isPurchasing","purchaseSuccess","alwaysShowPurchaseDisclaimer","displayBundleNonRefundableDisclaimer","errorMessage","validationErrors"],[["get",["dynamicCatalogItemPurchaseOption"]],["get",["wallet"]],"purchase",["get",["isPurchasing"]],["get",["purchaseSuccess"]],["get",["alwaysShowPurchaseDisclaimer"]],["get",["displayBundleNonRefundableDisclaimer"]],["get",["errorMessage"]],["get",["validationErrors"]]]]],false],["text","\\n      "],["close-element"],["text","\\n    "],["close-element"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-description"],["flush-element"],["text","\\n        "],["append",["helper",["bundle-description"],null,[["description"],[["get",["catalogItemPurchaseOption","item","description"]]]]],false],["text","\\n      "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","    "],["open-element","div",[]],["static-attr","class","paw-bundle-upsell-sidenav-overlay"],["flush-element"],["text","\\n      "],["append",["helper",["related-items-overlay"],null,[["items","selectedItem","selectCurrentItem"],[["get",["allItemsToShow"]],["get",["selectedItem"]],"selectCurrentItem"]]],false],["text","\\n    "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["open-element","div",[]],["static-attr","class","paw-bundle-limited-time-badge"],["flush-element"],["text","\\n        "],["open-element","hextech-ui-badge",[]],["dynamic-attr","icon",["concat",[["unknown",["limitedTimeBadge","icon"]]]]],["dynamic-attr","background-color",["unknown",["limitedTimeBadge","color"]],null],["static-attr","size","medium"],["flush-element"],["append",["unknown",["limitedTimeBadge","text"]],false],["close-element"],["text","\\n      "],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["open-element","img",[]],["static-attr","class","paw-bundle-overlay-image fade-in"],["dynamic-attr","src",["unknown",["bundleOverlayImageUrl"]],null],["flush-element"],["close-element"],["text","\\n"]],"locals":[]},{"statements":[["text","      "],["open-element","img",[]],["static-attr","class","paw-bundle-chroma-overlay-image fade-in"],["static-attr","src","/fe/lol-static-assets/svg/paw-upsell-chroma-overlay.svg"],["flush-element"],["close-element"],["text","\\n"]],"locals":[]}],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            e.exports = a.HTMLBars.template({
                id: "No5Ujxh7",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\layout.hbs\\" style-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\style.styl\\" js-path=\\"T:\\\\vfs\\\\mount\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-paw\\\\src\\\\components\\\\ui\\\\chroma-bundle\\\\chroma-button-component\\\\index.js\\" "],["text","\\n"],["open-element","div",[]],["static-attr","class","contents"],["dynamic-attr","style",["concat",["background:",["unknown",["color"]]]]],["flush-element"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
            ...
            const {
                computed: c
            } = a.Ember, r = a.Ember.A, m = s.default.extend({
    ...
    n.r = e => {
        ...
        s.addEventListener(l, (function(e) {
            (0, e.registrationHandler)((async e => {
                const s = {
                ...
                await t.default.init(e, s), await t.default.add({
                    db: t.default.dataBinding.bindTo(e.getSocket())
                });
                const l = n(2).default,
                    o = n(27).default,
                    i = n(28).default,
                    c = new(0, n(30).default),
                    r = new l(c);
...
//# sourceMappingURL=rcp-fe-lol-paw.js.map