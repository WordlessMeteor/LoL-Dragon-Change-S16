(() => {
    var e = [, e => {
            ...
            t.default = class {
                ...
                setUpComponents(e) {
                    a.emberApplicationFactory.setFactoryDefinition({
                        ...
                        DependencyDetailsComponent: n(95),
                        PriceDetailsComponent: n(98),
                        PriceButtonComponent: n(101),
                        DisclaimerCheckboxComponent: n(104),
                        ItemUnlockedComponent: n(107),
                        CelebrationVideoComponent: n(110),
                        PreviewVideoToggleComponent: n(112),
                        BadgeOverlayComponent: n(115),
                        DigitalGoodsDisclaimerComponent: a.SharedEmberComponents.DigitalGoodsDisclaimerComponent,
                        PawChoiceComponent: n(118),
                        ItemChoiceComponent: n(121),
                        ItemChoiceDetailsComponent: n(126),
                        ItemChoiceDetailFullComponent: n(129),
                        BundleRootComponent: n(132),
                        BundleTitleComponent: n(135),
                        BundleDescriptionComponent: n(138),
                        BundleItemsComponent: n(141),
                        BundlePriceComponent: n(144),
                        BundlePurchaseComponent: n(147),
                        BundleUpsellComponent: n(150),
                        ChromaBundleDetailsComponent: n(153),
                        ChromaBundleOverlayImageComponent: n(155),
                        ChromaButtonComponent: n(158),
                        ChromaBundleContentItemsComponent: n(161),
                        PurchaseWidgetService: n(162),
                        ...
                        tra: e,
                        ComponentFactory: a.componentFactory,
                        PAWRPTopUpModalComponent: n(163)
                    })
                }
                enable() {
                    this.enabled = !0
            ...
            const {
                ...
                showOverlayImage: c("itemPurchaseOption.assets.iconPath", "itemPurchaseOption.inventoryType", "itemPurchaseOption.subInventoryType", (function() {
                    return this.get("itemPurchaseOption.assets.iconPath") && (this.get("itemPurchaseOption.inventoryType") !== l.PAW.INVENTORY_TYPES.CHAMPION_SKIN || this.get("itemPurchaseOption.subInventoryType"))
                })),
            ...
            const {
                Component: l,
                computed: o
            } = a.Ember, i = a.dataBinding.bindTo((0, a.getProvider)().getSocket());
            ...
            const r = l.extend({
                ...
                style: n(109),
                init() {
                    this._super(...arguments), i.get("/riotclient/region-locale").then((e => {
                        this.set("region", e?.region)
                    })), i.get("/system/v1/builds").then((e => {
                        this.set("patchline", e?.patchline)
                    }))
                },
                isKREnv: o("region", "patchline", (function() {
                    return "KR" === this.get("region") || this.get("patchline")?.endsWith("_KR") || this.get("patchline")?.endsWith("_KRmac")
                })),
                krPurchaseSuccessMessage: o("isKREnv", (function() {
                ...
                unlockSuccessMessage: o("itemPurchaseOption.{inventoryType,subInventoryType,name}", "tra.cat_paw_modal_item_unlocked_details", (function() {
                    ...
                    if (n && n.inventoryType) {
                        ...
                        if (e = c(t, `cat_paw_unlock_message_${a.toLowerCase()}`, e), s) {
                            e = c(t, `cat_paw_unlock_message_${a.toLowerCase()}_${s.toLowerCase()}`, e)
                        }
                    }
