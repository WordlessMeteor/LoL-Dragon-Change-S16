    ...
    var e = [, e => {
                ...
                selectSkin(e, t, n) {
                    ...
                    this.getEmberApplication().renderPromise.then((() => {
                        this._modal = s.add({
                            ...
                            Number.isInteger(t) && e(t, n), this.removeCallbacks(), this._endTelemetrySession()
                        })), n(), this._hasOngoingSession = !0, r.default.startTelemetrySession()
                    }))
                }
                removeCallbacks() {
                    this._emberApplicationModel && (this._emberApplicationModel.set("onSkinSelected", null), this._emberApplicationModel.set("onDefault", null), this._emberApplicationModel.set("selectedSkinId", null), this._emberApplicationModel.set("selectedAugments", null), this._emberApplicationModel.set("onCloseButtonClicked", null))
                }
                destroy() {
            ...
            var s = new class {
                ...
                addUserBehaviorCount(e, t) {
                    Object.prototype.hasOwnProperty.call(this._userActivities, e) || (this._userActivities[e] = {
                        count: 0
                    });
                    const n = this._userActivities[e];
                    n.count++, null != t && (Object.prototype.hasOwnProperty.call(n, t) ? n[t]++ : n[t] = 1)
                }
            ...
            const {
                ...
                computed: N
            } = i.Ember, h = "lol-collectibles-libs-virtual-list";
            var R = d.extend({
                ...
                skinAugments: N("skinsStore.skinAugmentInventory.[]", (function() {
                    return (this.get("skinsStore.skinAugmentInventory") ?? []).reduce(((e, t) => (e[t.uuid] = t.owned, e)), {})
                })),
                ...
                _skinTileClickCallback(e, t) {
                    ...
                    if (e && e !== n) {
                        ...
                        n && (n(e), S(this, "selectedSkinId", e), S(this, "selectedAugments", t), i.refresh()), c.default.addUserBehaviorValue(u.USER_ACTIVITIES.PREVIEW_SKIN, e), c.default.setUserBehaviorValue(u.USER_ACTIVITIES.SET_BACKGROUND_SKIN_ID, e)
                    }
                },
                ...
                _initialiseVirtualList(e) {
                    ...
                    return t || (t = document.createElement(h), t.container = e, t.containerHeightPx = r.COLLECTION_GRID_HEIGHT, t.createElement = this._createRow.bind(this), t.updateElement = this._updateRow.bind(this), t.resetElement = this._resetRow.bind(this), t.deleteElement = this._deleteRow.bind(this), e.appendChild(t)), t
                },
                _createRow(e) {
            ...
            var l = class {
                ...
                _createSkinTile(e) {
                    ...
                    o.classList.add("tile-label"), o.textContent = e.name, i.appendChild(o), n.appendChild(i);
                ...
                _onSkinTileClick(e) {
                    ...
                    this._getThumbnailClickCallback() && this._getThumbnailClickCallback()(parseInt(t.dataset.skinId, o.PARSEINT_DEFAULT_RADIX), t.dataset.skinAugments), r.SFX.skinTileSelectSound.play()
                }
                _onMouseEnter() {
            ...
            e.exports = i.HTMLBars.template({
                id: "8RjsfBIQ",
                block: '{"statements":[["comment","#ember-component template-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\Releases_16_12\\\\LeagueClientContent_Release\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-skins-picker\\\\src\\\\components\\\\skins-grid-component\\\\layout.hbs\\" style-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\Releases_16_12\\\\LeagueClientContent_Release\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-skins-picker\\\\src\\\\components\\\\skins-grid-component\\\\style.styl\\" js-path=\\"T:\\\\cid\\\\p4\\\\v4\\\\Releases_16_12\\\\LeagueClientContent_Release\\\\15692\\\\DevRoot\\\\Client\\\\fe\\\\rcp-fe-lol-skins-picker\\\\src\\\\components\\\\skins-grid-component\\\\index.js\\" "],["text","\\n"],["open-element","lol-uikit-scrollable",[]],["static-attr","class","skins-grid-content"],["static-attr","overflow-masks","enabled"],["flush-element"],["text","\\n"],["close-element"]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
                meta: {}
            })
        }, (e, t, n) => {
            "use strict";
                        ...
                        t.skins.forEach((n => {
                            ...
                            if (o && o.tiers.length > 0) {
                                for (let e = o.tiers.length - 1; e >= 0; e--) {
                                    const r = o.tiers[e];
                                    r.champOwnership = t.ownership, r.championId = t.id, r.parentSkin = n.id, i.push(r)
                                }
                                e.push(...i.reverse())
...
//# sourceMappingURL=rcp-fe-lol-skins-picker.js.map