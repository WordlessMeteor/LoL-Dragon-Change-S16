(() => {
    var e = [, e => {
            ...
            t.GAMEPHASE = g;
            const v = new Set([g.NONE, g.LOBBY, g.CHECKED_INTO_TOURNAMENT, g.FAILED_TO_LAUNCH, g.TERMINATED_IN_ERROR]);
            t.GAMEPHASE_OBJECTIVES_BANNER_DEEPLINK_ALLOWED = v;
