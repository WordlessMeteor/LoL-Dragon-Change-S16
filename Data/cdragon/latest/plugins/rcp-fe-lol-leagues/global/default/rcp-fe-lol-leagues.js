(() => {
    var e = [, e => {
            ...
            e.exports = s.Ember.Component.extend({
                ...
                shouldShowRankedModal: s.Ember.computed("accountLeaguesSettings.data", (function() {
                    return !1
                })),
