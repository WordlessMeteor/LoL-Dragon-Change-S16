            ...
            e.exports = s.Ember.Component.extend({
                ...
                challengerQueues: s.Ember.computed("challengerLaddersEnabled", "selectedState", "leagues", "overlayMode", (function() {
                    ...
                    const n = this.get("selectedState"),
                        ...
                        o = [];
                    return t.forEach((t => {
                        const l = a.find((e => e?.queueType === t && s.LeaguesConsts.APEX_TIERS.includes(e.tier)));
