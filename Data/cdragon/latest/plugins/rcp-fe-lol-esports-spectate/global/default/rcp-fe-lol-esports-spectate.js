(() => {
    var e = [, e => {
            ...
            var c = new class {
                ...
                preload() {
                    this.applicationDataPromise || (this.applicationDataPromise = new Promise((e => {
                ...
                unload() {
                    this.applicationDataPromise && this.applicationDataPromise.then(function(e) {
                        this.screenRoot.getElement().removeChild(e.domNode), Promise.all([e.componentPromise, e.renderPromise]).then(function(e) {
...
//# sourceMappingURL=rcp-fe-lol-esports-spectate.js.map