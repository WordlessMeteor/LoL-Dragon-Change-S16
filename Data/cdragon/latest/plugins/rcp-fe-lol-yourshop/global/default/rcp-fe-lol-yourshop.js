(() => {
    var e = [, e => {
            ...
            t.default = class {
                ...
                initializeTra() {
                    this.tra = (0, a.getProvider)().get("rcp-fe-lol-l10n").tra().overlay("/fe/lol-l10n/trans.json").overlay("/fe/ember-libs/trans-icon-rarity.json").overlay("/fe/lol-yourshop/trans.json").overlay("/fe/lol-shared-components/trans-digital-goods-disclaimer.json")
                }
                show() {
                    var e;
            ...
            n(13), e.exports = o.Ember.Component.extend({
                ...
                hasOfferRarityGemIcon: o.Ember.computed("offer.rarity", (function() {
                    const e = this.get("offer.rarity");
                    return e?.gemIcon
                })),
                revealingState: null,
            ...
            const a = (0, o.emberDataBinding)({
                ...
                boundProperties: {
                    ...
                    purchaseConfirmationEnabled: "/lol-client-config/v3/client-config/lol.client_settings.store.lcu.personalizedOffersConfirmationEnabled"
                }
            });
            e.exports = o.Ember.Component.extend(a, {
                ...
                hasRarityText: o.Ember.computed("offer.rarity.traKeySingular", (function() {
                    return this.get("offer.rarity.traKeySingular")
                })),
                ...
                multipleDetailsclass: o.Ember.computed("hasOfferRarity", (function() {
                    return this.get("hasOfferRarity") && this.get("hasRarityText") ? "contains-multiple-detail" : "contains-single-detail"
                })),
                ...
                enoughRp: o.Ember.computed.not("notEnoughRp"),
                ...
                purchaseButtonDisabled: o.Ember.computed("notEnoughRp", "needsConfirmation", "purchaseInProgress", (function() {
                    const e = this.get("notEnoughRp"),
                        t = this.get("needsConfirmation"),
                        n = this.get("purchaseInProgress");
                ...
                actions: {
                    ...
                    openRpPurchaseModal: function() {
                        !0 !== this.get("rpPurchaseInProgress") && (this.set("rpPurchaseInProgress", !0), o.Payments.openPayments({
                            action: "RP_PURCHASE",
                            openedFrom: "yourshop_offer_purchase"
                        }).catch((e => {
                            o.logger.error("Youshop RP Top-up Modal - Failure loading purchase options", e), this.element.dispatchEvent(new Event("closeButtonClick", {
                                bubbles: !0
...
//# sourceMappingURL=rcp-fe-lol-yourshop.js.map